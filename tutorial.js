(function () {
  ...
  var steps = [
    ...
    },
    {
      ...
      body: "Move your cursor to the bottom center to open the nav dock. Games, Hub, Entertainment, News, Tutorial, Updates, Chat, and more live there.",
    ...
    {
      title: "Tutorial tab",
      body: "The Tutorial tab is in the bottom nav. Open it anytime to replay this orbit tour.",
      target: "#nav-tutorial",
      pad: 10,
      dock: true,
    },
