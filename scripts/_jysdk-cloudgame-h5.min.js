...
$jscomp.polyfill('WeakMap',function(a){function b(){if(!a||!Object.seal)return!1;try{var b=Object.seal({}),e=Object.seal({}),c=new a([[b,2],[e,3]]);if(2!=c.get(b)||3!=c.get(e))return!1;c.delete(b);c.set(e,4);return!c.has(b)&&4==c.get(e)}catch(u){return!1}}function d(){}function c(a){var b=typeof a;return'object'===b&&null!==a||'function'===b}function e(a){if(!$jscomp.owns(a,m)){var b=new d;$jscomp.defineProperty(a,m,{value:b})}}function k(a){var b=Object[a];b&&(Object[a]=function(a){if(a instanceof
d)return a;e(a);return b(a)})}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var m='$jscomp_hidden_'+Math.random();k('freeze');k('preventExtensions');k('seal');var q=0,f=function(a){this.id_=(q+=Math.random()+1).toString();if(a){a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};f.prototype.set=function(a,b){if(!c(a))throw Error('Invalid WeakMap key');e(a);if(!$jscomp.owns(a,m))throw Error('WeakMap key fail: '+
a);a[m][this.id_]=b;return this};f.prototype.get=function(a){return c(a)&&$jscomp.owns(a,m)?a[m][this.id_]:void 0};f.prototype.has=function(a){return c(a)&&$jscomp.owns(a,m)&&$jscomp.owns(a[m],this.id_)};f.prototype.delete=function(a){return c(a)&&$jscomp.owns(a,m)&&$jscomp.owns(a[m],this.id_)?delete a[m][this.id_]:!1};return f},'es6','es3');$jscomp.MapEntry=function(){};
$jscomp.polyfill('Map',function(a){function b(){if($jscomp.ASSUME_NO_NATIVE_MAP||!a||'function'!=typeof a||!a.prototype.entries||'function'!=typeof Object.seal)return!1;try{var b=Object.seal({x:4}),e=new a($jscomp.makeIterator([[b,'s']]));if('s'!=e.get(b)||1!=e.size||e.get({x:4})||e.set({x:4},'t')!=e||2!=e.size)return!1;var c=e.entries(),d=c.next();if(d.done||d.value[0]!=b||'s'!=d.value[1])return!1;d=c.next();return d.done||4!=d.value[0].x||'t'!=d.value[1]||!c.next().done?!1:!0}catch(u){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;$jscomp.initSymbolIterator();var d=new WeakMap,c=function(a){this.data_={};this.head_=m();this.size=0;if(a){a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};c.prototype.set=function(a,b){a=0===a?0:a;var c=e(this,a);c.list||(c.list=this.data_[c.id]=[]);c.entry?c.entry.value=b:(c.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:a,
...
c.prototype.get=function(a){return(a=e(this,a).entry)&&a.value};c.prototype.entries=function(){return k(this,function(a){return[a.key,a.value]})};c.prototype.keys=function(){return k(this,function(a){return a.key})};c.prototype.values=function(){return k(this,function(a){return a.value})};c.prototype.forEach=function(a,b){for(var e=this.entries(),c;!(c=e.next()).done;)c=c.value,a.call(b,c[1],c[0],this)};c.prototype[Symbol.iterator]=c.prototype.entries;var e=function(a,b){var c=b&&typeof b;'object'==
c||'function'==c?d.has(b)?c=d.get(b):(c=''+ ++q,d.set(b,c)):c='p_'+b;var e=a.data_[c];if(e&&$jscomp.owns(a.data_,c))for(a=0;a<e.length;a++){var f=e[a];if(b!==b&&f.key!==f.key||b===f.key)return{id:c,list:e,index:a,entry:f}}return{id:c,list:e,index:-1,entry:void 0}},k=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},m=function(){var a={};return a.previous=
a.next=a.head=a},q=0;return c},'es6','es3');$jscomp.iteratorFromArray=function(a,b){$jscomp.initSymbolIterator();a instanceof String&&(a+='');var d=0,c={next:function(){if(d<a.length){var e=d++;return{value:b(e,a[e]),done:!1}}c.next=function(){return{done:!0,value:void 0}};return c.next()}};c[Symbol.iterator]=function(){return c};return c};$jscomp.polyfill('Array.prototype.keys',function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},'es6','es3');
...
this.onSettledCallbacks_=null}};var k=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(p){c.reject(p)}};e.prototype.then=function(a,b){function c(a,b){return'function'==typeof a?function(b){try{d(a(b))}catch(h){k(h)}}:b}var d,k,m=new e(function(a,b){d=a;k=b});this.callWhenSettled_(c(a,d),c(b,k));return m};
...
c)})};e.all=function(a){var b=$jscomp.makeIterator(a),c=b.next();return c.done?d([]):new e(function(a,e){function f(b){return function(c){k[b]=c;m--;0==m&&a(k)}}var k=[],m=0;do k.push(void 0),m++,d(c.value).callWhenSettled_(f(k.length-1),e),c=b.next();while(!c.done)})};return e},'es6','es3');$jscomp.polyfill('Object.is',function(a){return a?a:function(a,d){return a===d?0!==a||1/a===1/d:a!==a&&d!==d}},'es6','es3');
...
$jscomp.assign='function'==typeof Object.assign?Object.assign:function(a,b){for(var d=1;d<arguments.length;d++){var c=arguments[d];if(c)for(var e in c)$jscomp.owns(c,e)&&(a[e]=c[e])}return a};$jscomp.polyfill('Object.assign',function(a){return a||$jscomp.assign},'es6','es3');
$jscomp.polyfill('String.prototype.startsWith',function(a){return a?a:function(a,d){var b=$jscomp.checkStringArgs(this,a,'startsWith');a+='';var e=b.length,k=a.length;d=Math.max(0,Math.min(d|0,b.length));for(var m=0;m<k&&d<e;)if(b[d++]!=a[m++])return!1;return m>=k}},'es6','es3');
...
$jscomp.polyfill('String.prototype.endsWith',function(a){return a?a:function(a,d){var b=$jscomp.checkStringArgs(this,a,'endsWith');a+='';void 0===d&&(d=b.length);d=Math.max(0,Math.min(d|0,b.length));for(var e=a.length;0<e&&0<d;)if(b[--d]!=a[--e])return!1;return 0>=e}},'es6','es3');
(function(a){'object'===typeof exports&&'undefined'!==typeof module?module.exports=a():'function'===typeof define&&define.amd?define([],a):('undefined'!==typeof window?window:'undefined'!==typeof global?global:'undefined'!==typeof self?self:this).adapter=a()})(function(){return function(){function a(b,d,c){function e(m,f){if(!d[m]){if(!b[m]){var p='function'==typeof require&&require;if(!f&&p)return p(m,!0);if(k)return k(m,!0);f=Error("Cannot find module '"+m+"'");throw f.code='MODULE_NOT_FOUND',f;
}f=d[m]={exports:{}};b[m][0].call(f.exports,function(a){return e(b[m][1][a]||a)},f,f.exports,a,b,d,c)}return d[m].exports}for(var k='function'==typeof require&&require,m=0;m<c.length;m++)e(c[m]);return e}return a}()({1:[function(a,b,d){a=a('./adapter_factory.js');a=(0,a.adapterFactory)({window:window});b.exports=a},{'./adapter_factory.js':2}],2:[function(a,b,d){function c(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(b[c]=a[c]);b.default=
a;return b}Object.defineProperty(d,'__esModule',{value:!0});d.adapterFactory=function(){var a=(0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}).window,b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{shimChrome:!0,shimFirefox:!0,shimEdge:!0,shimSafari:!0},c=e.log,d=e.detectBrowser(a),l={browserDetails:d,commonShim:p,extractVersion:e.extractVersion,disableLog:e.disableLog,disableWarnings:e.disableWarnings};switch(d.browser){case 'chrome':if(!k||!k.shimPeerConnection||!b.shimChrome){c('Chrome shim is not included in this adapter release.');
break}c('adapter.js shimming chrome.');l.browserShim=k;k.shimGetUserMedia(a);k.shimMediaStream(a);k.shimPeerConnection(a);k.shimOnTrack(a);k.shimAddTrackRemoveTrack(a);k.shimGetSendersWithDtmf(a);k.shimGetStats(a);k.shimSenderReceiverGetStats(a);k.fixNegotiationNeeded(a);p.shimRTCIceCandidate(a);p.shimConnectionState(a);p.shimMaxMessageSize(a);p.shimSendThrowTypeError(a);p.removeAllowExtmapMixed(a);break;case 'firefox':if(!q||!q.shimPeerConnection||!b.shimFirefox){c('Firefox shim is not included in this adapter release.');
break}c('adapter.js shimming firefox.');l.browserShim=q;q.shimGetUserMedia(a);q.shimPeerConnection(a);q.shimOnTrack(a);q.shimRemoveStream(a);q.shimSenderGetStats(a);q.shimReceiverGetStats(a);q.shimRTCDataChannel(a);q.shimAddTransceiver(a);q.shimCreateOffer(a);q.shimCreateAnswer(a);p.shimRTCIceCandidate(a);p.shimConnectionState(a);p.shimMaxMessageSize(a);p.shimSendThrowTypeError(a);break;case 'edge':if(!m||!m.shimPeerConnection||!b.shimEdge){c('MS edge shim is not included in this adapter release.');
break}c('adapter.js shimming edge.');l.browserShim=m;m.shimGetUserMedia(a);m.shimGetDisplayMedia(a);m.shimPeerConnection(a);m.shimReplaceTrack(a);p.shimMaxMessageSize(a);p.shimSendThrowTypeError(a);break;case 'safari':if(!f||!b.shimSafari){c('Safari shim is not included in this adapter release.');break}c('adapter.js shimming safari.');l.browserShim=f;f.shimRTCIceServerUrls(a);f.shimCreateOfferLegacy(a);f.shimCallbacksAPI(a);f.shimLocalStreamsAPI(a);f.shimRemoteStreamsAPI(a);f.shimTrackEventTransceiver(a);
f.shimGetUserMedia(a);p.shimRTCIceCandidate(a);p.shimMaxMessageSize(a);p.shimSendThrowTypeError(a);p.removeAllowExtmapMixed(a);break;default:c('Unsupported browser!')}return l};b=a('./utils');var e=c(b);b=a('./chrome/chrome_shim');var k=c(b);b=a('./edge/edge_shim');var m=c(b);b=a('./firefox/firefox_shim');var q=c(b);b=a('./safari/safari_shim');var f=c(b);a=a('./common_shim');var p=c(a)},{'./chrome/chrome_shim':3,'./common_shim':6,'./edge/edge_shim':7,'./firefox/firefox_shim':11,'./safari/safari_shim':14,
'./utils':15}],3:[function(a,b,d){function c(a,b,c){b in a?Object.defineProperty(a,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[b]=c;return a}function e(a){a.RTCPeerConnection.prototype.getLocalStreams=function(){var a=this;this._shimmedLocalStreams=this._shimmedLocalStreams||{};return Object.keys(this._shimmedLocalStreams).map(function(b){return a._shimmedLocalStreams[b][0]})};var b=a.RTCPeerConnection.prototype.addTrack;a.RTCPeerConnection.prototype.addTrack=function(a,c){if(!c)return b.apply(this,
arguments);this._shimmedLocalStreams=this._shimmedLocalStreams||{};var e=b.apply(this,arguments);this._shimmedLocalStreams[c.id]?-1===this._shimmedLocalStreams[c.id].indexOf(e)&&this._shimmedLocalStreams[c.id].push(e):this._shimmedLocalStreams[c.id]=[c,e];return e};var c=a.RTCPeerConnection.prototype.addStream;a.RTCPeerConnection.prototype.addStream=function(a){var b=this;this._shimmedLocalStreams=this._shimmedLocalStreams||{};a.getTracks().forEach(function(a){if(b.getSenders().find(function(b){return b.track===
a}))throw new DOMException('Track already exists.','InvalidAccessError');});var e=this.getSenders();c.apply(this,arguments);var d=this.getSenders().filter(function(a){return-1===e.indexOf(a)});this._shimmedLocalStreams[a.id]=[a].concat(d)};var e=a.RTCPeerConnection.prototype.removeStream;a.RTCPeerConnection.prototype.removeStream=function(a){this._shimmedLocalStreams=this._shimmedLocalStreams||{};delete this._shimmedLocalStreams[a.id];return e.apply(this,arguments)};var d=a.RTCPeerConnection.prototype.removeTrack;
a.RTCPeerConnection.prototype.removeTrack=function(a){var b=this;this._shimmedLocalStreams=this._shimmedLocalStreams||{};a&&Object.keys(this._shimmedLocalStreams).forEach(function(c){var e=b._shimmedLocalStreams[c].indexOf(a);-1!==e&&b._shimmedLocalStreams[c].splice(e,1);1===b._shimmedLocalStreams[c].length&&delete b._shimmedLocalStreams[c]});return d.apply(this,arguments)}}Object.defineProperty(d,'__esModule',{value:!0});d.shimGetDisplayMedia=d.shimGetUserMedia=void 0;var k='function'===typeof Symbol&&
'symbol'===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&'function'===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?'symbol':typeof a},m=a('./getusermedia');Object.defineProperty(d,'shimGetUserMedia',{enumerable:!0,get:function(){return m.shimGetUserMedia}});var q=a('./getdisplaymedia');Object.defineProperty(d,'shimGetDisplayMedia',{enumerable:!0,get:function(){return q.shimGetDisplayMedia}});d.shimMediaStream=function(a){a.MediaStream=a.MediaStream||a.webkitMediaStream};
...
this._ontrack=a)},enumerable:!0,configurable:!0});var b=a.RTCPeerConnection.prototype.setRemoteDescription;a.RTCPeerConnection.prototype.setRemoteDescription=function(){var c=this;this._ontrackpoly||(this._ontrackpoly=function(b){b.stream.addEventListener('addtrack',function(e){var d=void 0;d=a.RTCPeerConnection.prototype.getReceivers?c.getReceivers().find(function(a){return a.track&&a.track.id===e.track.id}):{track:e.track};var f=new Event('track');f.track=e.track;f.receiver=d;f.transceiver={receiver:d};
f.streams=[b.stream];c.dispatchEvent(f)});b.stream.getTracks().forEach(function(e){var d=void 0;d=a.RTCPeerConnection.prototype.getReceivers?c.getReceivers().find(function(a){return a.track&&a.track.id===e.id}):{track:e};var f=new Event('track');f.track=e;f.receiver=d;f.transceiver={receiver:d};f.streams=[b.stream];c.dispatchEvent(f)})},this.addEventListener('addstream',this._ontrackpoly));return b.apply(this,arguments)}}};d.shimGetSendersWithDtmf=function(a){if('object'===('undefined'===typeof a?
...
a.RTCRtpSender.prototype)){var m=a.RTCPeerConnection.prototype.getSenders;a.RTCPeerConnection.prototype.getSenders=function(){var a=this,b=m.apply(this,[]);b.forEach(function(b){return b._pc=a});return b};Object.defineProperty(a.RTCRtpSender.prototype,'dtmf',{get:function(){void 0===this._dtmf&&(this._dtmf='audio'===this.track.kind?this._pc.createDTMFSender(this.track):null);return this._dtmf}})}};d.shimGetStats=function(a){if(a.RTCPeerConnection){var b=a.RTCPeerConnection.prototype.getStats;a.RTCPeerConnection.prototype.getStats=
function(){var a=this,c=Array.prototype.slice.call(arguments),e=c[0],d=c[1];c=c[2];if(0<arguments.length&&'function'===typeof e)return b.apply(this,arguments);if(0===b.length&&(0===arguments.length||'function'!==typeof e))return b.apply(this,[]);var f=function(a){var b={};a.result().forEach(function(a){var c={id:a.id,timestamp:a.timestamp,type:{localcandidate:'local-candidate',remotecandidate:'remote-candidate'}[a.type]||a.type};a.names().forEach(function(b){c[b]=a.stat(b)});b[c.id]=c});return b},
k=function(a){return new Map(Object.keys(a).map(function(b){return[b,a[b]]}))};return 2<=arguments.length?b.apply(this,[function(a){d(k(f(a)))},e]):(new Promise(function(c,e){b.apply(a,[function(a){c(k(f(a)))},e])})).then(d,c)}}};d.shimSenderReceiverGetStats=function(a){if('object'===('undefined'===typeof a?'undefined':k(a))&&a.RTCPeerConnection&&a.RTCRtpSender&&a.RTCRtpReceiver){if(!('getStats'in a.RTCRtpSender.prototype)){var b=a.RTCPeerConnection.prototype.getSenders;b&&(a.RTCPeerConnection.prototype.getSenders=
function(){var a=this,c=b.apply(this,[]);c.forEach(function(b){return b._pc=a});return c});var c=a.RTCPeerConnection.prototype.addTrack;c&&(a.RTCPeerConnection.prototype.addTrack=function(){var a=c.apply(this,arguments);a._pc=this;return a});a.RTCRtpSender.prototype.getStats=function(){var a=this;return this._pc.getStats().then(function(b){return f.filterStats(b,a.track,!0)})}}if(!('getStats'in a.RTCRtpReceiver.prototype)){var e=a.RTCPeerConnection.prototype.getReceivers;e&&(a.RTCPeerConnection.prototype.getReceivers=
function(){var a=this,b=e.apply(this,[]);b.forEach(function(b){return b._pc=a});return b});f.wrapPeerConnectionEvent(a,'track',function(a){a.receiver._pc=a.srcElement;return a});a.RTCRtpReceiver.prototype.getStats=function(){var a=this;return this._pc.getStats().then(function(b){return f.filterStats(b,a.track,!1)})}}if('getStats'in a.RTCRtpSender.prototype&&'getStats'in a.RTCRtpReceiver.prototype){var d=a.RTCPeerConnection.prototype.getStats;a.RTCPeerConnection.prototype.getStats=function(){if(0<
arguments.length&&arguments[0]instanceof a.MediaStreamTrack){var b=arguments[0],c=void 0,e=void 0,f=void 0;this.getSenders().forEach(function(a){a.track===b&&(c?f=!0:c=a)});this.getReceivers().forEach(function(a){a.track===b&&(e?f=!0:e=a);return a.track===b});return f||c&&e?Promise.reject(new DOMException('There are more than one sender or receiver for the track.','InvalidAccessError')):c?c.getStats():e?e.getStats():Promise.reject(new DOMException('There is no sender or receiver for the track.','InvalidAccessError'))}return d.apply(this,
arguments)}}}};d.shimAddTrackRemoveTrackWithNative=e;d.shimAddTrackRemoveTrack=function(a){function b(a,b){var c=b.sdp;Object.keys(a._reverseStreams||[]).forEach(function(b){b=a._reverseStreams[b];c=c.replace(new RegExp(a._streams[b.id].id,'g'),b.id)});return new RTCSessionDescription({type:b.type,sdp:c})}function d(a,b){var c=b.sdp;Object.keys(a._reverseStreams||[]).forEach(function(b){b=a._reverseStreams[b];c=c.replace(new RegExp(b.id,'g'),a._streams[b.id].id)});return new RTCSessionDescription({type:b.type,
sdp:c})}if(a.RTCPeerConnection){var k=f.detectBrowser(a);if(a.RTCPeerConnection.prototype.addTrack&&65<=k.version)return e(a);var m=a.RTCPeerConnection.prototype.getLocalStreams;a.RTCPeerConnection.prototype.getLocalStreams=function(){var a=this,b=m.apply(this);this._reverseStreams=this._reverseStreams||{};return b.map(function(b){return a._reverseStreams[b.id]})};var l=a.RTCPeerConnection.prototype.addStream;a.RTCPeerConnection.prototype.addStream=function(b){var c=this;this._streams=this._streams||
{};this._reverseStreams=this._reverseStreams||{};b.getTracks().forEach(function(a){if(c.getSenders().find(function(b){return b.track===a}))throw new DOMException('Track already exists.','InvalidAccessError');});if(!this._reverseStreams[b.id]){var e=new a.MediaStream(b.getTracks());this._streams[b.id]=e;this._reverseStreams[e.id]=b;b=e}l.apply(this,[b])};var h=a.RTCPeerConnection.prototype.removeStream;a.RTCPeerConnection.prototype.removeStream=function(a){this._streams=this._streams||{};this._reverseStreams=
this._reverseStreams||{};h.apply(this,[this._streams[a.id]||a]);delete this._reverseStreams[this._streams[a.id]?this._streams[a.id].id:a.id];delete this._streams[a.id]};a.RTCPeerConnection.prototype.addTrack=function(b,c){var e=this;if('closed'===this.signalingState)throw new DOMException("The RTCPeerConnection's signalingState is 'closed'.",'InvalidStateError');var d=[].slice.call(arguments,1);if(1!==d.length||!d[0].getTracks().find(function(a){return a===b}))throw new DOMException('The adapter.js addTrack polyfill only supports a single  stream which is associated with the specified track.',
...
b})};['createOffer','createAnswer'].forEach(function(e){var d=a.RTCPeerConnection.prototype[e],f=c({},e,function(){var a=this,c=arguments;return arguments.length&&'function'===typeof arguments[0]?d.apply(this,[function(e){e=b(a,e);c[0].apply(null,[e])},function(a){c[1]&&c[1].apply(null,a)},arguments[2]]):d.apply(this,arguments).then(function(c){return b(a,c)})});a.RTCPeerConnection.prototype[e]=f[e]});var n=a.RTCPeerConnection.prototype.setLocalDescription;a.RTCPeerConnection.prototype.setLocalDescription=
function(){if(!arguments.length||!arguments[0].type)return n.apply(this,arguments);arguments[0]=d(this,arguments[0]);return n.apply(this,arguments)};var g=Object.getOwnPropertyDescriptor(a.RTCPeerConnection.prototype,'localDescription');Object.defineProperty(a.RTCPeerConnection.prototype,'localDescription',{get:function(){var a=g.get.apply(this);return''===a.type?a:b(this,a)}});a.RTCPeerConnection.prototype.removeTrack=function(a){var b=this;if('closed'===this.signalingState)throw new DOMException("The RTCPeerConnection's signalingState is 'closed'.",
...
c.removeTrack(a.track),this.dispatchEvent(new Event('negotiationneeded')))}}};d.shimPeerConnection=function(a){var b=f.detectBrowser(a);!a.RTCPeerConnection&&a.webkitRTCPeerConnection&&(a.RTCPeerConnection=a.webkitRTCPeerConnection);if(a.RTCPeerConnection){var e=0===a.RTCPeerConnection.prototype.addIceCandidate.length;53>b.version&&['setLocalDescription','setRemoteDescription','addIceCandidate'].forEach(function(b){var e=a.RTCPeerConnection.prototype[b],d=c({},b,function(){arguments[0]=new ('addIceCandidate'===
b?a.RTCIceCandidate:a.RTCSessionDescription)(arguments[0]);return e.apply(this,arguments)});a.RTCPeerConnection.prototype[b]=d[b]});var d=a.RTCPeerConnection.prototype.addIceCandidate;a.RTCPeerConnection.prototype.addIceCandidate=function(){return e||arguments[0]?78>b.version&&arguments[0]&&''===arguments[0].candidate?Promise.resolve():d.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())}}};d.fixNegotiationNeeded=function(a){f.wrapPeerConnectionEvent(a,'negotiationneeded',
function(a){if('stable'===a.target.signalingState)return a})};var f=function(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(b[c]=a[c]);b.default=a;return b}(a('../utils.js'))},{'../utils.js':15,'./getdisplaymedia':4,'./getusermedia':5}],4:[function(a,b,d){Object.defineProperty(d,'__esModule',{value:!0});d.shimGetDisplayMedia=function(a,b){a.navigator.mediaDevices&&'getDisplayMedia'in a.navigator.mediaDevices||!a.navigator.mediaDevices||
('function'!==typeof b?console.error('shimGetDisplayMedia: getSourceId argument is not a function'):a.navigator.mediaDevices.getDisplayMedia=function(c){return b(c).then(function(b){var e=c.video&&c.video.width,d=c.video&&c.video.height;c.video={mandatory:{chromeMediaSource:'desktop',chromeMediaSourceId:b,maxFrameRate:c.video&&c.video.frameRate||3}};e&&(c.video.mandatory.maxWidth=e);d&&(c.video.mandatory.maxHeight=d);return a.navigator.mediaDevices.getUserMedia(c)})})}},{}],5:[function(a,b,d){Object.defineProperty(d,
'__esModule',{value:!0});var c='function'===typeof Symbol&&'symbol'===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&'function'===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?'symbol':typeof a};d.shimGetUserMedia=function(a){var b=a&&a.navigator;if(b.mediaDevices){var d=e.detectBrowser(a),m=function(a){if('object'!==('undefined'===typeof a?'undefined':c(a))||a.mandatory||a.optional)return a;var b={};Object.keys(a).forEach(function(e){if('require'!==e&&'advanced'!==
e&&'mediaSource'!==e){var d='object'===c(a[e])?a[e]:{ideal:a[e]};void 0!==d.exact&&'number'===typeof d.exact&&(d.min=d.max=d.exact);var f=function(a,b){return a?a+b.charAt(0).toUpperCase()+b.slice(1):'deviceId'===b?'sourceId':b};if(void 0!==d.ideal){b.optional=b.optional||[];var k={};'number'===typeof d.ideal?(k[f('min',e)]=d.ideal,b.optional.push(k),k={},k[f('max',e)]=d.ideal):k[f('',e)]=d.ideal;b.optional.push(k)}void 0!==d.exact&&'number'!==typeof d.exact?(b.mandatory=b.mandatory||{},b.mandatory[f('',
e)]=d.exact):['min','max'].forEach(function(a){void 0!==d[a]&&(b.mandatory=b.mandatory||{},b.mandatory[f(a,e)]=d[a])})}});a.advanced&&(b.optional=(b.optional||[]).concat(a.advanced));return b},t=function(a,e){if(61<=d.version)return e(a);if((a=JSON.parse(JSON.stringify(a)))&&'object'===c(a.audio)){var f=function(a,b,c){b in a&&!(c in a)&&(a[c]=a[b],delete a[b])};a=JSON.parse(JSON.stringify(a));f(a.audio,'autoGainControl','googAutoGainControl');f(a.audio,'noiseSuppression','googNoiseSuppression');
a.audio=m(a.audio)}if(a&&'object'===c(a.video)){var l=a.video.facingMode;l=l&&('object'===('undefined'===typeof l?'undefined':c(l))?l:{ideal:l});f=66>d.version;if(!(!l||'user'!==l.exact&&'environment'!==l.exact&&'user'!==l.ideal&&'environment'!==l.ideal||b.mediaDevices.getSupportedConstraints&&b.mediaDevices.getSupportedConstraints().facingMode&&!f)){delete a.video.facingMode;var g=void 0;if('environment'===l.exact||'environment'===l.ideal)g=['back','rear'];else if('user'===l.exact||'user'===l.ideal)g=
['front'];if(g)return b.mediaDevices.enumerateDevices().then(function(b){b=b.filter(function(a){return'videoinput'===a.kind});var c=b.find(function(a){return g.some(function(b){return a.label.toLowerCase().includes(b)})});!c&&b.length&&g.includes('back')&&(c=b[b.length-1]);c&&(a.video.deviceId=l.exact?{exact:c.deviceId}:{ideal:c.deviceId});a.video=m(a.video);k('chrome: '+JSON.stringify(a));return e(a)})}a.video=m(a.video)}k('chrome: '+JSON.stringify(a));return e(a)},v=function(a){return 64<=d.version?
...
toString:function(){return this.name+(this.message&&': ')+this.message}}};b.getUserMedia=function(a,c,e){t(a,function(a){b.webkitGetUserMedia(a,c,function(a){e&&e(v(a))})})}.bind(b);if(b.mediaDevices.getUserMedia){var u=b.mediaDevices.getUserMedia.bind(b.mediaDevices);b.mediaDevices.getUserMedia=function(a){return t(a,function(a){return u(a).then(function(b){if(a.audio&&!b.getAudioTracks().length||a.video&&!b.getVideoTracks().length)throw b.getTracks().forEach(function(a){a.stop()}),new DOMException('',
'NotFoundError');return b},function(a){return Promise.reject(v(a))})})}}}};var e=function(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(b[c]=a[c]);b.default=a;return b}(a('../utils.js')),k=e.log},{'../utils.js':15}],6:[function(a,b,d){Object.defineProperty(d,'__esModule',{value:!0});var c='function'===typeof Symbol&&'symbol'===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&'function'===typeof Symbol&&a.constructor===
Symbol&&a!==Symbol.prototype?'symbol':typeof a};d.shimRTCIceCandidate=function(a){if(a.RTCIceCandidate&&!(a.RTCIceCandidate&&'foundation'in a.RTCIceCandidate.prototype)){var b=a.RTCIceCandidate;a.RTCIceCandidate=function(a){'object'===('undefined'===typeof a?'undefined':c(a))&&a.candidate&&0===a.candidate.indexOf('a=')&&(a=JSON.parse(JSON.stringify(a)),a.candidate=a.candidate.substr(2));if(a.candidate&&a.candidate.length){var d=new b(a);a=e.default.parseCandidate(a.candidate);var f=Object.assign(d,
a);f.toJSON=function(){return{candidate:f.candidate,sdpMid:f.sdpMid,sdpMLineIndex:f.sdpMLineIndex,usernameFragment:f.usernameFragment}};return f}return new b(a)};a.RTCIceCandidate.prototype=b.prototype;k.wrapPeerConnectionEvent(a,'icecandidate',function(b){b.candidate&&Object.defineProperty(b,'candidate',{value:new a.RTCIceCandidate(b.candidate),writable:'false'});return b})}};d.shimMaxMessageSize=function(a){if(a.RTCPeerConnection){var b=k.detectBrowser(a);'sctp'in a.RTCPeerConnection.prototype||
Object.defineProperty(a.RTCPeerConnection.prototype,'sctp',{get:function(){return'undefined'===typeof this._sctp?null:this._sctp}});var c=function(a){if(!a||!a.sdp)return!1;a=e.default.splitSections(a.sdp);a.shift();return a.some(function(a){return(a=e.default.parseMLine(a))&&'application'===a.kind&&-1!==a.protocol.indexOf('SCTP')})},d=function(a){a=a.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);if(null===a||2>a.length)return-1;a=parseInt(a[1],10);return a!==a?-1:a},m=function(a){var c=65536;'firefox'===
...
'plan-b'===this.getConfiguration().sdpSemantics&&Object.defineProperty(this,'sctp',{get:function(){return'undefined'===typeof this._sctp?null:this._sctp},enumerable:!0,configurable:!0});if(c(arguments[0])){var a=d(arguments[0]),e=m(a);a=v(arguments[0],a);var f=void 0;f=0===e&&0===a?Number.POSITIVE_INFINITY:0===e||0===a?Math.max(e,a):Math.min(e,a);e={};Object.defineProperty(e,'maxMessageSize',{get:function(){return f}});this._sctp=e}return u.apply(this,arguments)}}};d.shimSendThrowTypeError=function(a){function b(a,
b){var c=a.send;a.send=function(){var e=arguments[0];e=e.length||e.size||e.byteLength;if('open'===a.readyState&&b.sctp&&e>b.sctp.maxMessageSize)throw new TypeError('Message too large (can send a maximum of '+b.sctp.maxMessageSize+' bytes)');return c.apply(a,arguments)}}if(a.RTCPeerConnection&&'createDataChannel'in a.RTCPeerConnection.prototype){var c=a.RTCPeerConnection.prototype.createDataChannel;a.RTCPeerConnection.prototype.createDataChannel=function(){var a=c.apply(this,arguments);b(a,this);return a};
k.wrapPeerConnectionEvent(a,'datachannel',function(a){b(a.channel,a.target);return a})}};d.shimConnectionState=function(a){if(a.RTCPeerConnection&&!('connectionState'in a.RTCPeerConnection.prototype)){var b=a.RTCPeerConnection.prototype;Object.defineProperty(b,'connectionState',{get:function(){return{completed:'connected',checking:'connecting'}[this.iceConnectionState]||this.iceConnectionState},enumerable:!0,configurable:!0});Object.defineProperty(b,'onconnectionstatechange',{get:function(){return this._onconnectionstatechange||
...
b.connectionState){b._lastConnectionState=b.connectionState;var c=new Event('connectionstatechange',a);b.dispatchEvent(c)}return a},this.addEventListener('iceconnectionstatechange',this._connectionstatechangepoly));return c.apply(this,arguments)}})}};d.removeAllowExtmapMixed=function(a){if(a.RTCPeerConnection){var b=k.detectBrowser(a);if(!('chrome'===b.browser&&71<=b.version)){var c=a.RTCPeerConnection.prototype.setRemoteDescription;a.RTCPeerConnection.prototype.setRemoteDescription=function(a){a&&
a.sdp&&-1!==a.sdp.indexOf('\na=extmap-allow-mixed')&&(a.sdp=a.sdp.split('\n').filter(function(a){return'a=extmap-allow-mixed'!==a.trim()}).join('\n'));return c.apply(this,arguments)}}}};var e=(b=a('sdp'))&&b.__esModule?b:{default:b},k=function(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(b[c]=a[c]);b.default=a;return b}(a('./utils'))},{'./utils':15,sdp:17}],7:[function(a,b,d){Object.defineProperty(d,'__esModule',{value:!0});d.shimGetDisplayMedia=
d.shimGetUserMedia=void 0;var c=a('./getusermedia');Object.defineProperty(d,'shimGetUserMedia',{enumerable:!0,get:function(){return c.shimGetUserMedia}});var e=a('./getdisplaymedia');Object.defineProperty(d,'shimGetDisplayMedia',{enumerable:!0,get:function(){return e.shimGetDisplayMedia}});d.shimPeerConnection=function(a){var b=k.detectBrowser(a);if(a.RTCIceGatherer&&(a.RTCIceCandidate||(a.RTCIceCandidate=function(a){return a}),a.RTCSessionDescription||(a.RTCSessionDescription=function(a){return a}),
...
null));return this._dtmf}});a.RTCDtmfSender&&!a.RTCDTMFSender&&(a.RTCDTMFSender=a.RTCDtmfSender);var e=(0,q.default)(a,b.version);a.RTCPeerConnection=function(a){a&&a.iceServers&&(a.iceServers=(0,m.filterIceServers)(a.iceServers,b.version),k.log('ICE servers after filtering:',a.iceServers));return new e(a)};a.RTCPeerConnection.prototype=e.prototype};d.shimReplaceTrack=function(a){!a.RTCRtpSender||'replaceTrack'in a.RTCRtpSender.prototype||(a.RTCRtpSender.prototype.replaceTrack=a.RTCRtpSender.prototype.setTrack)};
var k=function(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(b[c]=a[c]);b.default=a;return b}(a('../utils')),m=a('./filtericeservers'),q=(a=a('rtcpeerconnection-shim'))&&a.__esModule?a:{default:a}},{'../utils':15,'./filtericeservers':8,'./getdisplaymedia':9,'./getusermedia':10,'rtcpeerconnection-shim':16}],8:[function(a,b,d){Object.defineProperty(d,'__esModule',{value:!0});d.filterIceServers=function(a,b){var e=!1;a=JSON.parse(JSON.stringify(a));
return a.filter(function(a){if(a&&(a.urls||a.url)){var b=a.urls||a.url;a.url&&!a.urls&&c.deprecated('RTCIceServer.url','RTCIceServer.urls');var d='string'===typeof b;d&&(b=[b]);b=b.filter(function(a){return 0===a.indexOf('stun:')?!1:(a=a.startsWith('turn')&&!a.startsWith('turn:[')&&a.includes('transport=udp'))&&!e?e=!0:a&&!e});delete a.url;a.urls=d?b[0]:b;return!!b.length}})};var c=function(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&
(b[c]=a[c]);b.default=a;return b}(a('../utils'))},{'../utils':15}],9:[function(a,b,d){Object.defineProperty(d,'__esModule',{value:!0});d.shimGetDisplayMedia=function(a){'getDisplayMedia'in a.navigator&&a.navigator.mediaDevices&&!(a.navigator.mediaDevices&&'getDisplayMedia'in a.navigator.mediaDevices)&&(a.navigator.mediaDevices.getDisplayMedia=a.navigator.getDisplayMedia.bind(a.navigator))}},{}],10:[function(a,b,d){Object.defineProperty(d,'__esModule',{value:!0});d.shimGetUserMedia=function(a){a=a&&
a.navigator;var b=function(a){return{name:{PermissionDeniedError:'NotAllowedError'}[a.name]||a.name,message:a.message,constraint:a.constraint,toString:function(){return this.name}}},c=a.mediaDevices.getUserMedia.bind(a.mediaDevices);a.mediaDevices.getUserMedia=function(a){return c(a).catch(function(a){return Promise.reject(b(a))})}}},{}],11:[function(a,b,d){function c(a,b,c){b in a?Object.defineProperty(a,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[b]=c;return a}Object.defineProperty(d,
'__esModule',{value:!0});d.shimGetDisplayMedia=d.shimGetUserMedia=void 0;var e='function'===typeof Symbol&&'symbol'===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&'function'===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?'symbol':typeof a},k=a('./getusermedia');Object.defineProperty(d,'shimGetUserMedia',{enumerable:!0,get:function(){return k.shimGetUserMedia}});var m=a('./getdisplaymedia');Object.defineProperty(d,'shimGetDisplayMedia',{enumerable:!0,get:function(){return m.shimGetDisplayMedia}});
d.shimOnTrack=function(a){'object'===('undefined'===typeof a?'undefined':e(a))&&a.RTCTrackEvent&&'receiver'in a.RTCTrackEvent.prototype&&!('transceiver'in a.RTCTrackEvent.prototype)&&Object.defineProperty(a.RTCTrackEvent.prototype,'transceiver',{get:function(){return{receiver:this.receiver}}})};d.shimPeerConnection=function(a){var b=q.detectBrowser(a);if('object'===('undefined'===typeof a?'undefined':e(a))&&(a.RTCPeerConnection||a.mozRTCPeerConnection)){!a.RTCPeerConnection&&a.mozRTCPeerConnection&&
(a.RTCPeerConnection=a.mozRTCPeerConnection);53>b.version&&['setLocalDescription','setRemoteDescription','addIceCandidate'].forEach(function(b){var e=a.RTCPeerConnection.prototype[b],d=c({},b,function(){arguments[0]=new ('addIceCandidate'===b?a.RTCIceCandidate:a.RTCSessionDescription)(arguments[0]);return e.apply(this,arguments)});a.RTCPeerConnection.prototype[b]=d[b]});if(68>b.version){var d=a.RTCPeerConnection.prototype.addIceCandidate;a.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?
arguments[0]&&''===arguments[0].candidate?Promise.resolve():d.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())}}var f={inboundrtp:'inbound-rtp',outboundrtp:'outbound-rtp',candidatepair:'candidate-pair',localcandidate:'local-candidate',remotecandidate:'remote-candidate'},k=a.RTCPeerConnection.prototype.getStats;a.RTCPeerConnection.prototype.getStats=function(){var a=Array.prototype.slice.call(arguments),c=a[1],e=a[2];return k.apply(this,[a[0]||null]).then(function(a){if(53>
b.version&&!c)try{a.forEach(function(a){a.type=f[a.type]||a.type})}catch(g){if('TypeError'!==g.name)throw g;a.forEach(function(b,c){a.set(c,Object.assign({},b,{type:f[b.type]||b.type}))})}return a}).then(c,e)}}};d.shimSenderGetStats=function(a){if('object'===('undefined'===typeof a?'undefined':e(a))&&a.RTCPeerConnection&&a.RTCRtpSender&&!(a.RTCRtpSender&&'getStats'in a.RTCRtpSender.prototype)){var b=a.RTCPeerConnection.prototype.getSenders;b&&(a.RTCPeerConnection.prototype.getSenders=function(){var a=
this,c=b.apply(this,[]);c.forEach(function(b){return b._pc=a});return c});var c=a.RTCPeerConnection.prototype.addTrack;c&&(a.RTCPeerConnection.prototype.addTrack=function(){var a=c.apply(this,arguments);a._pc=this;return a});a.RTCRtpSender.prototype.getStats=function(){return this.track?this._pc.getStats(this.track):Promise.resolve(new Map)}}};d.shimReceiverGetStats=function(a){if('object'===('undefined'===typeof a?'undefined':e(a))&&a.RTCPeerConnection&&a.RTCRtpSender&&!(a.RTCRtpSender&&'getStats'in
...
function(a){var b=this;q.deprecated('removeStream','removeTrack');this.getSenders().forEach(function(c){c.track&&a.getTracks().includes(c.track)&&b.removeTrack(c)})})};d.shimRTCDataChannel=function(a){a.DataChannel&&!a.RTCDataChannel&&(a.RTCDataChannel=a.DataChannel)};d.shimAddTransceiver=function(a){if('object'===('undefined'===typeof a?'undefined':e(a))&&a.RTCPeerConnection){var b=a.RTCPeerConnection.prototype.addTransceiver;b&&(a.RTCPeerConnection.prototype.addTransceiver=function(){this.setParametersPromises=
[];var a=arguments[1],c=a&&'sendEncodings'in a;c&&a.sendEncodings.forEach(function(a){if('rid'in a&&!/^[a-z0-9]{0,16}$/i.test(a.rid))throw new TypeError('Invalid RID value provided.');if('scaleResolutionDownBy'in a&&!(1<=parseFloat(a.scaleResolutionDownBy)))throw new RangeError('scale_resolution_down_by must be >= 1.0');if('maxFramerate'in a&&!(0<=parseFloat(a.maxFramerate)))throw new RangeError('max_framerate must be >= 0.0');});var e=b.apply(this,arguments);if(c){c=e.sender;var d=c.getParameters();
'encodings'in d||(d.encodings=a.sendEncodings,this.setParametersPromises.push(c.setParameters(d).catch(function(){})))}return e})}};d.shimCreateOffer=function(a){if('object'===('undefined'===typeof a?'undefined':e(a))&&a.RTCPeerConnection){var b=a.RTCPeerConnection.prototype.createOffer;a.RTCPeerConnection.prototype.createOffer=function(){var a=this,c=arguments;return this.setParametersPromises&&this.setParametersPromises.length?Promise.all(this.setParametersPromises).then(function(){return b.apply(a,
c)}).finally(function(){a.setParametersPromises=[]}):b.apply(this,arguments)}}};d.shimCreateAnswer=function(a){if('object'===('undefined'===typeof a?'undefined':e(a))&&a.RTCPeerConnection){var b=a.RTCPeerConnection.prototype.createAnswer;a.RTCPeerConnection.prototype.createAnswer=function(){var a=this,c=arguments;return this.setParametersPromises&&this.setParametersPromises.length?Promise.all(this.setParametersPromises).then(function(){return b.apply(a,c)}).finally(function(){a.setParametersPromises=
[]}):b.apply(this,arguments)}}};var q=function(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(b[c]=a[c]);b.default=a;return b}(a('../utils'))},{'../utils':15,'./getdisplaymedia':12,'./getusermedia':13}],12:[function(a,b,d){Object.defineProperty(d,'__esModule',{value:!0});d.shimGetDisplayMedia=function(a,b){a.navigator.mediaDevices&&'getDisplayMedia'in a.navigator.mediaDevices||!a.navigator.mediaDevices||(a.navigator.mediaDevices.getDisplayMedia=
function(c){if(!c||!c.video)return c=new DOMException('getDisplayMedia without video constraints is undefined'),c.name='NotFoundError',c.code=8,Promise.reject(c);!0===c.video?c.video={mediaSource:b}:c.video.mediaSource=b;return a.navigator.mediaDevices.getUserMedia(c)})}},{}],13:[function(a,b,d){Object.defineProperty(d,'__esModule',{value:!0});var c='function'===typeof Symbol&&'symbol'===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&'function'===typeof Symbol&&a.constructor===
Symbol&&a!==Symbol.prototype?'symbol':typeof a};d.shimGetUserMedia=function(a){var b=e.detectBrowser(a),d=a&&a.navigator;a=a&&a.MediaStreamTrack;d.getUserMedia=function(a,b,c){e.deprecated('navigator.getUserMedia','navigator.mediaDevices.getUserMedia');d.mediaDevices.getUserMedia(a).then(b,c)};if(!(55<b.version&&'autoGainControl'in d.mediaDevices.getSupportedConstraints())){var f=function(a,b,c){b in a&&!(c in a)&&(a[c]=a[b],delete a[b])},k=d.mediaDevices.getUserMedia.bind(d.mediaDevices);d.mediaDevices.getUserMedia=
function(a){'object'===('undefined'===typeof a?'undefined':c(a))&&'object'===c(a.audio)&&(a=JSON.parse(JSON.stringify(a)),f(a.audio,'autoGainControl','mozAutoGainControl'),f(a.audio,'noiseSuppression','mozNoiseSuppression'));return k(a)};if(a&&a.prototype.getSettings){var t=a.prototype.getSettings;a.prototype.getSettings=function(){var a=t.apply(this,arguments);f(a,'mozAutoGainControl','autoGainControl');f(a,'mozNoiseSuppression','noiseSuppression');return a}}if(a&&a.prototype.applyConstraints){var v=
a.prototype.applyConstraints;a.prototype.applyConstraints=function(a){'audio'===this.kind&&'object'===('undefined'===typeof a?'undefined':c(a))&&(a=JSON.parse(JSON.stringify(a)),f(a,'autoGainControl','mozAutoGainControl'),f(a,'noiseSuppression','mozNoiseSuppression'));return v.apply(this,[a])}}}};var e=function(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(b[c]=a[c]);b.default=a;return b}(a('../utils'))},{'../utils':15}],14:[function(a,
b,d){function c(a){return a&&void 0!==a.video?Object.assign({},a,{video:k.compactObject(a.video)}):a}Object.defineProperty(d,'__esModule',{value:!0});var e='function'===typeof Symbol&&'symbol'===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&'function'===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?'symbol':typeof a};d.shimLocalStreamsAPI=function(a){if('object'===('undefined'===typeof a?'undefined':e(a))&&a.RTCPeerConnection){'getLocalStreams'in a.RTCPeerConnection.prototype||
(a.RTCPeerConnection.prototype.getLocalStreams=function(){this._localStreams||(this._localStreams=[]);return this._localStreams});if(!('addStream'in a.RTCPeerConnection.prototype)){var b=a.RTCPeerConnection.prototype.addTrack;a.RTCPeerConnection.prototype.addStream=function(a){var c=this;this._localStreams||(this._localStreams=[]);this._localStreams.includes(a)||this._localStreams.push(a);a.getAudioTracks().forEach(function(e){return b.call(c,e,a)});a.getVideoTracks().forEach(function(e){return b.call(c,
e,a)})};a.RTCPeerConnection.prototype.addTrack=function(a){for(var c=this,e=arguments.length,d=Array(1<e?e-1:0),f=1;f<e;f++)d[f-1]=arguments[f];d&&d.forEach(function(a){c._localStreams?c._localStreams.includes(a)||c._localStreams.push(a):c._localStreams=[a]});return b.apply(this,arguments)}}'removeStream'in a.RTCPeerConnection.prototype||(a.RTCPeerConnection.prototype.removeStream=function(a){var b=this;this._localStreams||(this._localStreams=[]);var c=this._localStreams.indexOf(a);if(-1!==c){this._localStreams.splice(c,
1);var e=a.getTracks();this.getSenders().forEach(function(a){e.includes(a.track)&&b.removeTrack(a)})}})}};d.shimRemoteStreamsAPI=function(a){if('object'===('undefined'===typeof a?'undefined':e(a))&&a.RTCPeerConnection&&('getRemoteStreams'in a.RTCPeerConnection.prototype||(a.RTCPeerConnection.prototype.getRemoteStreams=function(){return this._remoteStreams?this._remoteStreams:[]}),!('onaddstream'in a.RTCPeerConnection.prototype))){Object.defineProperty(a.RTCPeerConnection.prototype,'onaddstream',{get:function(){return this._onaddstream},
...
a.RTCPeerConnection.prototype.setRemoteDescription=function(){var a=this;this._onaddstreampoly||this.addEventListener('track',this._onaddstreampoly=function(b){b.streams.forEach(function(b){a._remoteStreams||(a._remoteStreams=[]);if(!(0<=a._remoteStreams.indexOf(b))){a._remoteStreams.push(b);var c=new Event('addstream');c.stream=b;a.dispatchEvent(c)}})});return b.apply(a,arguments)}}};d.shimCallbacksAPI=function(a){if('object'===('undefined'===typeof a?'undefined':e(a))&&a.RTCPeerConnection){a=a.RTCPeerConnection.prototype;
var b=a.createOffer,c=a.createAnswer,d=a.setLocalDescription,k=a.setRemoteDescription,m=a.addIceCandidate;a.createOffer=function(a,c){var e=b.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!c)return e;e.then(a,c);return Promise.resolve()};a.createAnswer=function(a,b){var e=c.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!b)return e;e.then(a,b);return Promise.resolve()};var u=function(a,b,c){a=d.apply(this,[a]);if(!c)return a;a.then(b,c);return Promise.resolve()};a.setLocalDescription=
u;u=function(a,b,c){a=k.apply(this,[a]);if(!c)return a;a.then(b,c);return Promise.resolve()};a.setRemoteDescription=u;u=function(a,b,c){a=m.apply(this,[a]);if(!c)return a;a.then(b,c);return Promise.resolve()};a.addIceCandidate=u}};d.shimGetUserMedia=function(a){var b=a&&a.navigator;if(b.mediaDevices&&b.mediaDevices.getUserMedia){a=b.mediaDevices;var e=a.getUserMedia.bind(a);b.mediaDevices.getUserMedia=function(a){return e(c(a))}}!b.getUserMedia&&b.mediaDevices&&b.mediaDevices.getUserMedia&&(b.getUserMedia=
function(a,c,e){b.mediaDevices.getUserMedia(a).then(c,e)}.bind(b))};d.shimConstraints=c;d.shimRTCIceServerUrls=function(a){var b=a.RTCPeerConnection;a.RTCPeerConnection=function(a,c){if(a&&a.iceServers){for(var e=[],d=0;d<a.iceServers.length;d++){var f=a.iceServers[d];!f.hasOwnProperty('urls')&&f.hasOwnProperty('url')?(k.deprecated('RTCIceServer.url','RTCIceServer.urls'),f=JSON.parse(JSON.stringify(f)),f.urls=f.url,delete f.url,e.push(f)):e.push(a.iceServers[d])}a.iceServers=e}return new b(a,c)};
...
this.addTransceiver('video')}return b.apply(this,arguments)}};var k=function(a){if(a&&a.__esModule)return a;var b={};if(null!=a)for(var c in a)Object.prototype.hasOwnProperty.call(a,c)&&(b[c]=a[c]);b.default=a;return b}(a('../utils'))},{'../utils':15}],15:[function(a,b,d){function c(a,b,c){b in a?Object.defineProperty(a,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[b]=c;return a}function e(a,b,c){return(a=a.match(b))&&a.length>=c&&parseInt(a[c],10)}function k(a){return'[object Object]'!==
Object.prototype.toString.call(a)?a:Object.keys(a).reduce(function(b,e){var d='[object Object]'===Object.prototype.toString.call(a[e]),f=d?k(a[e]):a[e];d=d&&!Object.keys(f).length;return void 0===f||d?b:Object.assign(b,c({},e,f))},{})}function m(a,b,c){b&&!c.has(b.id)&&(c.set(b.id,b),Object.keys(b).forEach(function(e){e.endsWith('Id')?m(a,a.get(b[e]),c):e.endsWith('Ids')&&b[e].forEach(function(b){m(a,a.get(b),c)})}))}Object.defineProperty(d,'__esModule',{value:!0});var q='function'===typeof Symbol&&
'symbol'===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&'function'===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?'symbol':typeof a};d.extractVersion=e;d.wrapPeerConnectionEvent=function(a,b,c){if(a.RTCPeerConnection){a=a.RTCPeerConnection.prototype;var e=a.addEventListener;a.addEventListener=function(a,d){if(a!==b)return e.apply(this,arguments);var g=function(a){(a=c(a))&&d(a)};this._eventMap=this._eventMap||{};this._eventMap[d]=g;return e.apply(this,[a,
g])};var d=a.removeEventListener;a.removeEventListener=function(a,c){if(a!==b||!this._eventMap||!this._eventMap[c])return d.apply(this,arguments);var e=this._eventMap[c];delete this._eventMap[c];return d.apply(this,[a,e])};Object.defineProperty(a,'on'+b,{get:function(){return this['_on'+b]},set:function(a){this['_on'+b]&&(this.removeEventListener(b,this['_on'+b]),delete this['_on'+b]);a&&this.addEventListener(b,this['_on'+b]=a)},enumerable:!0,configurable:!0})}};d.disableLog=function(a){return'boolean'!==
typeof a?Error('Argument type: '+('undefined'===typeof a?'undefined':q(a))+'. Please use a boolean.'):(f=a)?'adapter.js logging disabled':'adapter.js logging enabled'};d.disableWarnings=function(a){if('boolean'!==typeof a)return Error('Argument type: '+('undefined'===typeof a?'undefined':q(a))+'. Please use a boolean.');p=!a;return'adapter.js deprecation warnings '+(a?'disabled':'enabled')};d.log=function(){'object'!==('undefined'===typeof window?'undefined':q(window))||f||'undefined'!==typeof console&&
'function'===typeof console.log&&console.log.apply(console,arguments)};d.deprecated=function(a,b){p&&console.warn(a+' is deprecated, please use '+b+' instead.')};d.detectBrowser=function(a){var b=a.navigator,c={browser:null,version:null};if('undefined'===typeof a||!a.navigator)return c.browser='Not a browser.',c;b.mozGetUserMedia?(c.browser='firefox',c.version=e(b.userAgent,/Firefox\/(\d+)\./,1)):b.webkitGetUserMedia||!1===a.isSecureContext&&a.webkitRTCPeerConnection&&!a.RTCIceGatherer?(c.browser=
'chrome',c.version=e(b.userAgent,/Chrom(e|ium)\/(\d+)\./,2)):b.mediaDevices&&b.userAgent.match(/Edge\/(\d+).(\d+)$/)?(c.browser='edge',c.version=e(b.userAgent,/Edge\/(\d+).(\d+)$/,2)):a.RTCPeerConnection&&b.userAgent.match(/AppleWebKit\/(\d+)\./)?(c.browser='safari',c.version=e(b.userAgent,/AppleWebKit\/(\d+)\./,1),c.supportsUnifiedPlan=a.RTCRtpTransceiver&&'currentDirection'in a.RTCRtpTransceiver.prototype):c.browser='Not a supported browser.';return c};d.compactObject=k;d.walkStats=m;d.filterStats=
function(a,b,c){var e=c?'outbound-rtp':'inbound-rtp',d=new Map;if(null===b)return d;var k=[];a.forEach(function(a){'track'===a.type&&a.trackIdentifier===b.id&&k.push(a)});k.forEach(function(b){a.forEach(function(c){c.type===e&&c.trackId===b.id&&m(a,c,d)})});return d};var f=!0,p=!0},{}],16:[function(a,b,d){function c(a,b,c,e,d){b=p.writeRtpDescription(a.kind,b);b+=p.writeIceParameters(a.iceGatherer.getLocalParameters());b+=p.writeDtlsParameters(a.dtlsTransport.getLocalParameters(),'offer'===c?'actpass':
d||'active');b+='a=mid:'+a.mid+'\r\n';b=a.rtpSender&&a.rtpReceiver?b+'a=sendrecv\r\n':a.rtpSender?b+'a=sendonly\r\n':a.rtpReceiver?b+'a=recvonly\r\n':b+'a=inactive\r\n';a.rtpSender&&(c=a.rtpSender._initialTrackId||a.rtpSender.track.id,a.rtpSender._initialTrackId=c,e='msid:'+(e?e.id:'-')+' '+c+'\r\n',b=b+('a='+e)+('a=ssrc:'+a.sendEncodingParameters[0].ssrc+' '+e),a.sendEncodingParameters[0].rtx&&(b+='a=ssrc:'+a.sendEncodingParameters[0].rtx.ssrc+' '+e,b+='a=ssrc-group:FID '+a.sendEncodingParameters[0].ssrc+
' '+a.sendEncodingParameters[0].rtx.ssrc+'\r\n'));b+='a=ssrc:'+a.sendEncodingParameters[0].ssrc+' cname:'+p.localCName+'\r\n';a.rtpSender&&a.sendEncodingParameters[0].rtx&&(b+='a=ssrc:'+a.sendEncodingParameters[0].rtx.ssrc+' cname:'+p.localCName+'\r\n');return b}function e(a,b){var c=!1;a=JSON.parse(JSON.stringify(a));return a.filter(function(a){if(a&&(a.urls||a.url)){var e=a.urls||a.url;a.url&&!a.urls&&console.warn('RTCIceServer.url is deprecated! Use urls instead.');var d='string'===typeof e;d&&
(e=[e]);e=e.filter(function(a){return 0!==a.indexOf('turn:')||-1===a.indexOf('transport=udp')||-1!==a.indexOf('turn:[')||c?0===a.indexOf('stun:')&&14393<=b&&-1===a.indexOf('?transport=udp'):c=!0});delete a.url;a.urls=d?e[0]:e;return!!e.length}})}function k(a,b){var c={codecs:[],headerExtensions:[],fecMechanisms:[]},e=function(a,b){a=parseInt(a,10);for(var c=0;c<b.length;c++)if(b[c].payloadType===a||b[c].preferredPayloadType===a)return b[c]},d=function(a,b,c,d){a=e(a.parameters.apt,c);b=e(b.parameters.apt,
d);return a&&b&&a.name.toLowerCase()===b.name.toLowerCase()};a.codecs.forEach(function(e){for(var k=0;k<b.codecs.length;k++){var g=b.codecs[k];if(e.name.toLowerCase()===g.name.toLowerCase()&&e.clockRate===g.clockRate&&('rtx'!==e.name.toLowerCase()||!e.parameters||!g.parameters.apt||d(e,g,a.codecs,b.codecs))){g=JSON.parse(JSON.stringify(g));g.numChannels=Math.min(e.numChannels,g.numChannels);c.codecs.push(g);g.rtcpFeedback=g.rtcpFeedback.filter(function(a){for(var b=0;b<e.rtcpFeedback.length;b++)if(e.rtcpFeedback[b].type===
a.type&&e.rtcpFeedback[b].parameter===a.parameter)return!0;return!1});break}}});a.headerExtensions.forEach(function(a){for(var e=0;e<b.headerExtensions.length;e++){var d=b.headerExtensions[e];if(a.uri===d.uri){c.headerExtensions.push(d);break}}});return c}function m(a,b,c){return-1!=={offer:{setLocalDescription:['stable','have-local-offer'],setRemoteDescription:['stable','have-remote-offer']},answer:{setLocalDescription:['have-remote-offer','have-local-pranswer'],setRemoteDescription:['have-local-offer',
'have-remote-pranswer']}}[b][a].indexOf(c)}function q(a,b){var c=a.getRemoteCandidates().find(function(a){return b.foundation===a.foundation&&b.ip===a.ip&&b.port===a.port&&b.priority===a.priority&&b.protocol===a.protocol&&b.type===a.type});c||a.addRemoteCandidate(b);return!c}function f(a,b){b=Error(b);b.name=a;b.code={NotSupportedError:9,InvalidStateError:11,InvalidAccessError:15,TypeError:void 0,OperationError:void 0}[a];return b}var p=a('sdp');b.exports=function(a,b){function d(b,c){c.addTrack(b);
c.dispatchEvent(new a.MediaStreamTrackEvent('addtrack',{track:b}))}function w(b,c){c.removeTrack(b);c.dispatchEvent(new a.MediaStreamTrackEvent('removetrack',{track:b}))}function l(b,c,e,d){var g=new Event('track');g.track=c;g.receiver=e;g.transceiver={receiver:e};g.streams=d;a.setTimeout(function(){b._dispatchEvent('track',g)})}var h=function(c){var d=this,g=document.createDocumentFragment();['addEventListener','removeEventListener','dispatchEvent'].forEach(function(a){d[a]=g[a].bind(g)});this.canTrickleIceCandidates=
...
default:c.iceTransportPolicy='all'}switch(c.bundlePolicy){case 'balanced':case 'max-compat':case 'max-bundle':break;default:c.bundlePolicy='balanced'}c.iceServers=e(c.iceServers||[],b);this._iceGatherers=[];if(c.iceCandidatePoolSize)for(var k=c.iceCandidatePoolSize;0<k;k--)this._iceGatherers.push(new a.RTCIceGatherer({iceServers:c.iceServers,gatherPolicy:c.iceTransportPolicy}));else c.iceCandidatePoolSize=0;this._config=c;this.transceivers=[];this._sdpSessionId=p.generateSessionId();this._sdpSessionVersion=
...
this.transceivers[0].dtlsTransport):(c=this._createIceAndDtlsTransports(),a.iceTransport=c.iceTransport,a.dtlsTransport=c.dtlsTransport);b||this.transceivers.push(a);return a};h.prototype.addTrack=function(b,c){if(this._isClosed)throw f('InvalidStateError','Attempted to call addTrack on a closed peerconnection.');if(this.transceivers.find(function(a){return a.track===b}))throw f('InvalidAccessError','Track already exists.');for(var e,d=0;d<this.transceivers.length;d++)this.transceivers[d].track||
this.transceivers[d].kind!==b.kind||(e=this.transceivers[d]);e||(e=this._createTransceiver(b.kind));this._maybeFireNegotiationNeeded();-1===this.localStreams.indexOf(c)&&this.localStreams.push(c);e.track=b;e.stream=c;e.rtpSender=new a.RTCRtpSender(b,e.dtlsTransport);return e.rtpSender};h.prototype.addStream=function(a){var c=this;if(15025<=b)a.getTracks().forEach(function(b){c.addTrack(b,a)});else{var e=a.clone();a.getTracks().forEach(function(a,b){var c=e.getTracks()[b];a.addEventListener('enabled',
function(a){c.enabled=a.enabled})});e.getTracks().forEach(function(a){c.addTrack(a,e)})}};h.prototype.removeTrack=function(b){if(this._isClosed)throw f('InvalidStateError','Attempted to call removeTrack on a closed peerconnection.');if(!(b instanceof a.RTCRtpSender))throw new TypeError('Argument 1 of RTCPeerConnection.removeTrack does not implement interface RTCRtpSender.');var c=this.transceivers.find(function(a){return a.rtpSender===b});if(!c)throw f('InvalidAccessError','Sender was not created by this connection.');
var e=c.stream;c.rtpSender.stop();c.rtpSender=null;c.track=null;c.stream=null;-1===this.transceivers.map(function(a){return a.stream}).indexOf(e)&&-1<this.localStreams.indexOf(e)&&this.localStreams.splice(this.localStreams.indexOf(e),1);this._maybeFireNegotiationNeeded()};h.prototype.removeStream=function(a){var b=this;a.getTracks().forEach(function(a){var c=b.getSenders().find(function(b){return b.track===a});c&&b.removeTrack(c)})};h.prototype.getSenders=function(){return this.transceivers.filter(function(a){return!!a.rtpSender}).map(function(a){return a.rtpSender})};
h.prototype.getReceivers=function(){return this.transceivers.filter(function(a){return!!a.rtpReceiver}).map(function(a){return a.rtpReceiver})};h.prototype._createIceGatherer=function(b,c){var e=this;if(c&&0<b)return this.transceivers[0].iceGatherer;if(this._iceGatherers.length)return this._iceGatherers.shift();var d=new a.RTCIceGatherer({iceServers:this._config.iceServers,gatherPolicy:this._config.iceTransportPolicy});Object.defineProperty(d,'state',{value:'new',writable:!0});this.transceivers[b].bufferedCandidateEvents=
[];this.transceivers[b].bufferCandidates=function(a){var c=!a.candidate||0===Object.keys(a.candidate).length;d.state=c?'completed':'gathering';null!==e.transceivers[b].bufferedCandidateEvents&&e.transceivers[b].bufferedCandidateEvents.push(a)};d.addEventListener('localcandidate',this.transceivers[b].bufferCandidates);return d};h.prototype._gather=function(b,c){var e=this,d=this.transceivers[c].iceGatherer;if(!d.onlocalcandidate){var k=this.transceivers[c].bufferedCandidateEvents;this.transceivers[c].bufferedCandidateEvents=
null;d.removeEventListener('localcandidate',this.transceivers[c].bufferCandidates);d.onlocalcandidate=function(a){if(!(e.usingBundle&&0<c)){var k=new Event('icecandidate');k.candidate={sdpMid:b,sdpMLineIndex:c};var g=a.candidate;if(a=!g||0===Object.keys(g).length){if('new'===d.state||'gathering'===d.state)d.state='completed'}else'new'===d.state&&(d.state='gathering'),g.component=1,g.ufrag=d.getLocalParameters().usernameFragment,g=p.writeCandidate(g),k.candidate=Object.assign(k.candidate,p.parseCandidate(g)),
k.candidate.candidate=g,k.candidate.toJSON=function(){return{candidate:k.candidate.candidate,sdpMid:k.candidate.sdpMid,sdpMLineIndex:k.candidate.sdpMLineIndex,usernameFragment:k.candidate.usernameFragment}};g=p.getMediaSections(e._localDescription.sdp);g[k.candidate.sdpMLineIndex]=a?g[k.candidate.sdpMLineIndex]+'a=end-of-candidates\r\n':g[k.candidate.sdpMLineIndex]+('a='+k.candidate.candidate+'\r\n');e._localDescription.sdp=p.getDescription(e._localDescription.sdp)+g.join('');g=e.transceivers.every(function(a){return a.iceGatherer&&
'completed'===a.iceGatherer.state});'gathering'!==e.iceGatheringState&&(e.iceGatheringState='gathering',e._emitGatheringStateChange());a||e._dispatchEvent('icecandidate',k);g&&(e._dispatchEvent('icecandidate',new Event('icecandidate')),e.iceGatheringState='complete',e._emitGatheringStateChange())}};a.setTimeout(function(){k.forEach(function(a){d.onlocalcandidate(a)})},0)}};h.prototype._createIceAndDtlsTransports=function(){var b=this,c=new a.RTCIceTransport(null);c.onicestatechange=function(){b._updateIceConnectionState();
b._updateConnectionState()};var e=new a.RTCDtlsTransport(c);e.ondtlsstatechange=function(){b._updateConnectionState()};e.onerror=function(){Object.defineProperty(e,'state',{value:'failed',writable:!0});b._updateConnectionState()};return{iceTransport:c,dtlsTransport:e}};h.prototype._disposeIceAndDtlsTransports=function(a){var b=this.transceivers[a].iceGatherer;b&&(delete b.onlocalcandidate,delete this.transceivers[a].iceGatherer);if(b=this.transceivers[a].iceTransport)delete b.onicestatechange,delete this.transceivers[a].iceTransport;
if(b=this.transceivers[a].dtlsTransport)delete b.ondtlsstatechange,delete b.onerror,delete this.transceivers[a].dtlsTransport};h.prototype._transceive=function(a,c,e){var d=k(a.localCapabilities,a.remoteCapabilities);c&&a.rtpSender&&(d.encodings=a.sendEncodingParameters,d.rtcp={cname:p.localCName,compound:a.rtcpParameters.compound},a.recvEncodingParameters.length&&(d.rtcp.ssrc=a.recvEncodingParameters[0].ssrc),a.rtpSender.send(d));e&&a.rtpReceiver&&0<d.codecs.length&&('video'===a.kind&&a.recvEncodingParameters&&
15019>b&&a.recvEncodingParameters.forEach(function(a){delete a.rtx}),d.encodings=a.recvEncodingParameters.length?a.recvEncodingParameters:[{}],d.rtcp={compound:a.rtcpParameters.compound},a.rtcpParameters.cname&&(d.rtcp.cname=a.rtcpParameters.cname),a.sendEncodingParameters.length&&(d.rtcp.ssrc=a.sendEncodingParameters[0].ssrc),a.rtpReceiver.receive(d))};h.prototype.setLocalDescription=function(a){var b=this;if(-1===['offer','answer'].indexOf(a.type))return Promise.reject(f('TypeError','Unsupported type "'+
a.type+'"'));if(!m('setLocalDescription',a.type,b.signalingState)||b._isClosed)return Promise.reject(f('InvalidStateError','Can not set local '+a.type+' in state '+b.signalingState));if('offer'===a.type){var c=p.splitSections(a.sdp);var e=c.shift();c.forEach(function(a,c){a=p.parseRtpParameters(a);b.transceivers[c].localCapabilities=a});b.transceivers.forEach(function(a,c){b._gather(a.mid,c)})}else if('answer'===a.type){c=p.splitSections(b._remoteDescription.sdp);e=c.shift();var d=0<p.matchPrefix(e,
'a=ice-lite').length;c.forEach(function(a,c){var f=b.transceivers[c],g=f.iceGatherer,x=f.iceTransport,h=f.dtlsTransport,l=f.localCapabilities,m=f.remoteCapabilities;if(!(p.isRejected(a)&&0===p.matchPrefix(a,'a=bundle-only').length||f.rejected)){var n=p.getIceParameters(a,e);a=p.getDtlsParameters(a,e);d&&(a.role='server');b.usingBundle&&0!==c||(b._gather(f.mid,c),'new'===x.state&&x.start(g,n,d?'controlling':'controlled'),'new'===h.state&&h.start(a));c=k(l,m);b._transceive(f,0<c.codecs.length,!1)}})}b._localDescription=
{type:a.type,sdp:a.sdp};'offer'===a.type?b._updateSignalingState('have-local-offer'):b._updateSignalingState('stable');return Promise.resolve()};h.prototype.setRemoteDescription=function(c){var e=this;if(-1===['offer','answer'].indexOf(c.type))return Promise.reject(f('TypeError','Unsupported type "'+c.type+'"'));if(!m('setRemoteDescription',c.type,e.signalingState)||e._isClosed)return Promise.reject(f('InvalidStateError','Can not set remote '+c.type+' in state '+e.signalingState));var g={};e.remoteStreams.forEach(function(a){g[a.id]=
a});var h=[],n=p.splitSections(c.sdp),E=n.shift(),t=0<p.matchPrefix(E,'a=ice-lite').length,u=0<p.matchPrefix(E,'a=group:BUNDLE ').length;e.usingBundle=u;var v=p.matchPrefix(E,'a=ice-options:')[0];e.canTrickleIceCandidates=v?0<=v.substr(14).split(' ').indexOf('trickle'):!1;n.forEach(function(f,l){var x=p.splitLines(f),m=p.getKind(f),n=p.isRejected(f)&&0===p.matchPrefix(f,'a=bundle-only').length,D=x[0].substr(2).split(' ')[2];x=p.getDirection(f,E);var z=p.parseMsid(f),G=p.getMid(f)||p.generateIdentifier();
if(n||'application'===m&&('DTLS/SCTP'===D||'UDP/DTLS/SCTP'===D))e.transceivers[l]={mid:G,kind:m,protocol:D,rejected:!0};else{!n&&e.transceivers[l]&&e.transceivers[l].rejected&&(e.transceivers[l]=e._createTransceiver(m,!0));var H=p.parseRtpParameters(f);if(!n){var v=p.getIceParameters(f,E);var J=p.getDtlsParameters(f,E);J.role='client'}D=p.parseRtpEncodingParameters(f);var K=p.parseRtcpParameters(f),I=0<p.matchPrefix(f,'a=end-of-candidates',E).length,C=p.matchPrefix(f,'a=candidate:').map(function(a){return p.parseCandidate(a)}).filter(function(a){return 1===
a.component});('offer'===c.type||'answer'===c.type)&&!n&&u&&0<l&&e.transceivers[l]&&(e._disposeIceAndDtlsTransports(l),e.transceivers[l].iceGatherer=e.transceivers[0].iceGatherer,e.transceivers[l].iceTransport=e.transceivers[0].iceTransport,e.transceivers[l].dtlsTransport=e.transceivers[0].dtlsTransport,e.transceivers[l].rtpSender&&e.transceivers[l].rtpSender.setTransport(e.transceivers[0].dtlsTransport),e.transceivers[l].rtpReceiver&&e.transceivers[l].rtpReceiver.setTransport(e.transceivers[0].dtlsTransport));
if('offer'!==c.type||n)'answer'!==c.type||n||(r=e.transceivers[l],B=r.iceGatherer,m=r.iceTransport,G=r.dtlsTransport,y=r.rtpReceiver,n=r.sendEncodingParameters,f=r.localCapabilities,e.transceivers[l].recvEncodingParameters=D,e.transceivers[l].remoteCapabilities=H,e.transceivers[l].rtcpParameters=K,C.length&&'new'===m.state&&(!t&&!I||u&&0!==l?C.forEach(function(a){q(r.iceTransport,a)}):m.setRemoteCandidates(C)),u&&0!==l||('new'===m.state&&m.start(B,v,'controlling'),'new'===G.state&&G.start(J)),!k(r.localCapabilities,
r.remoteCapabilities).codecs.filter(function(a){return'rtx'===a.name.toLowerCase()}).length&&r.sendEncodingParameters[0].rtx&&delete r.sendEncodingParameters[0].rtx,e._transceive(r,'sendrecv'===x||'recvonly'===x,'sendrecv'===x||'sendonly'===x),!y||'sendrecv'!==x&&'sendonly'!==x?delete r.rtpReceiver:(x=y.track,z?(g[z.stream]||(g[z.stream]=new a.MediaStream),d(x,g[z.stream]),h.push([x,y,g[z.stream]])):(g.default||(g.default=new a.MediaStream),d(x,g.default),h.push([x,y,g.default]))));else{var r=e.transceivers[l]||
e._createTransceiver(m);r.mid=G;r.iceGatherer||(r.iceGatherer=e._createIceGatherer(l,u));C.length&&'new'===r.iceTransport.state&&(!I||u&&0!==l?C.forEach(function(a){q(r.iceTransport,a)}):r.iceTransport.setRemoteCandidates(C));f=a.RTCRtpReceiver.getCapabilities(m);15019>b&&(f.codecs=f.codecs.filter(function(a){return'rtx'!==a.name}));n=r.sendEncodingParameters||[{ssrc:1001*(2*l+2)}];v=!1;if('sendrecv'===x||'sendonly'===x){v=!r.rtpReceiver;var y=r.rtpReceiver||new a.RTCRtpReceiver(r.dtlsTransport,m);
if(v){x=y.track;if(!z||'-'!==z.stream)if(z){g[z.stream]||(g[z.stream]=new a.MediaStream,Object.defineProperty(g[z.stream],'id',{get:function(){return z.stream}}));Object.defineProperty(x,'id',{get:function(){return z.track}});var B=g[z.stream]}else g.default||(g.default=new a.MediaStream),B=g.default;B&&(d(x,B),r.associatedRemoteMediaStreams.push(B));h.push([x,y,B])}}else r.rtpReceiver&&r.rtpReceiver.track&&(r.associatedRemoteMediaStreams.forEach(function(a){var b=a.getTracks().find(function(a){return a.id===
r.rtpReceiver.track.id});b&&w(b,a)}),r.associatedRemoteMediaStreams=[]);r.localCapabilities=f;r.remoteCapabilities=H;r.rtpReceiver=y;r.rtcpParameters=K;r.sendEncodingParameters=n;r.recvEncodingParameters=D;e._transceive(e.transceivers[l],!1,v)}}});void 0===e._dtlsRole&&(e._dtlsRole='offer'===c.type?'active':'passive');e._remoteDescription={type:c.type,sdp:c.sdp};'offer'===c.type?e._updateSignalingState('have-remote-offer'):e._updateSignalingState('stable');Object.keys(g).forEach(function(b){var c=
g[b];if(c.getTracks().length){if(-1===e.remoteStreams.indexOf(c)){e.remoteStreams.push(c);var d=new Event('addstream');d.stream=c;a.setTimeout(function(){e._dispatchEvent('addstream',d)})}h.forEach(function(a){c.id===a[2].id&&l(e,a[0],a[1],[c])})}});h.forEach(function(a){a[2]||l(e,a[0],a[1],[])});a.setTimeout(function(){e&&e.transceivers&&e.transceivers.forEach(function(a){a.iceTransport&&'new'===a.iceTransport.state&&0<a.iceTransport.getRemoteCandidates().length&&(console.warn('Timeout for addRemoteCandidate. Consider sending an end-of-candidates notification'),
...
(a[b.iceTransport.state]++,a[b.dtlsTransport.state]++)});a.connected+=a.completed;var b='new';0<a.failed?b='failed':0<a.connecting?b='connecting':0<a.disconnected?b='disconnected':0<a.new?b='new':0<a.connected&&(b='connected');b!==this.connectionState&&(this.connectionState=b,b=new Event('connectionstatechange'),this._dispatchEvent('connectionstatechange',b))};h.prototype.createOffer=function(e){var d=this;if(d._isClosed)return Promise.reject(f('InvalidStateError','Can not call createOffer after close'));
var k=d.transceivers.filter(function(a){return'audio'===a.kind}).length,g=d.transceivers.filter(function(a){return'video'===a.kind}).length;if(e){if(e.mandatory||e.optional)throw new TypeError('Legacy mandatory/optional constraints not supported.');void 0!==e.offerToReceiveAudio&&(k=!0===e.offerToReceiveAudio?1:!1===e.offerToReceiveAudio?0:e.offerToReceiveAudio);void 0!==e.offerToReceiveVideo&&(g=!0===e.offerToReceiveVideo?1:!1===e.offerToReceiveVideo?0:e.offerToReceiveVideo)}for(d.transceivers.forEach(function(a){'audio'===
a.kind?(k--,0>k&&(a.wantReceive=!1)):'video'===a.kind&&(g--,0>g&&(a.wantReceive=!1))});0<k||0<g;)0<k&&(d._createTransceiver('audio'),k--),0<g&&(d._createTransceiver('video'),g--);var h=p.writeSessionBoilerplate(d._sdpSessionId,d._sdpSessionVersion++);d.transceivers.forEach(function(c,e){var k=c.track,f=c.kind,g=c.mid||p.generateIdentifier();c.mid=g;c.iceGatherer||(c.iceGatherer=d._createIceGatherer(e,d.usingBundle));g=a.RTCRtpSender.getCapabilities(f);15019>b&&(g.codecs=g.codecs.filter(function(a){return'rtx'!==
a.name}));g.codecs.forEach(function(a){'H264'===a.name&&void 0===a.parameters['level-asymmetry-allowed']&&(a.parameters['level-asymmetry-allowed']='1');c.remoteCapabilities&&c.remoteCapabilities.codecs&&c.remoteCapabilities.codecs.forEach(function(b){a.name.toLowerCase()===b.name.toLowerCase()&&a.clockRate===b.clockRate&&(a.preferredPayloadType=b.payloadType)})});g.headerExtensions.forEach(function(a){(c.remoteCapabilities&&c.remoteCapabilities.headerExtensions||[]).forEach(function(b){a.uri===b.uri&&
(a.id=b.id)})});e=c.sendEncodingParameters||[{ssrc:1001*(2*e+1)}];k&&15019<=b&&'video'===f&&!e[0].rtx&&(e[0].rtx={ssrc:e[0].ssrc+1});c.wantReceive&&(c.rtpReceiver=new a.RTCRtpReceiver(c.dtlsTransport,f));c.localCapabilities=g;c.sendEncodingParameters=e});'max-compat'!==d._config.bundlePolicy&&(h+='a=group:BUNDLE '+d.transceivers.map(function(a){return a.mid}).join(' ')+'\r\n');h+='a=ice-options:trickle\r\n';d.transceivers.forEach(function(a,b){h+=c(a,a.localCapabilities,'offer',a.stream,d._dtlsRole);
h+='a=rtcp-rsize\r\n';!a.iceGatherer||'new'===d.iceGatheringState||0!==b&&d.usingBundle||(a.iceGatherer.getLocalCandidates().forEach(function(a){a.component=1;h+='a='+p.writeCandidate(a)+'\r\n'}),'completed'===a.iceGatherer.state&&(h+='a=end-of-candidates\r\n'))});e=new a.RTCSessionDescription({type:'offer',sdp:h});return Promise.resolve(e)};h.prototype.createAnswer=function(){var e=this;if(e._isClosed)return Promise.reject(f('InvalidStateError','Can not call createAnswer after close'));if('have-remote-offer'!==
e.signalingState&&'have-local-pranswer'!==e.signalingState)return Promise.reject(f('InvalidStateError','Can not call createAnswer in signalingState '+e.signalingState));var d=p.writeSessionBoilerplate(e._sdpSessionId,e._sdpSessionVersion++);e.usingBundle&&(d+='a=group:BUNDLE '+e.transceivers.map(function(a){return a.mid}).join(' ')+'\r\n');d+='a=ice-options:trickle\r\n';var h=p.getMediaSections(e._remoteDescription.sdp).length;e.transceivers.forEach(function(a,f){if(!(f+1>h))if(a.rejected)'application'===
a.kind?d='DTLS/SCTP'===a.protocol?d+'m=application 0 DTLS/SCTP 5000\r\n':d+('m=application 0 '+a.protocol+' webrtc-datachannel\r\n'):'audio'===a.kind?d+='m=audio 0 UDP/TLS/RTP/SAVPF 0\r\na=rtpmap:0 PCMU/8000\r\n':'video'===a.kind&&(d+='m=video 0 UDP/TLS/RTP/SAVPF 120\r\na=rtpmap:120 VP8/90000\r\n'),d+='c=IN IP4 0.0.0.0\r\na=inactive\r\na=mid:'+a.mid+'\r\n';else{if(a.stream){var g;'audio'===a.kind?g=a.stream.getAudioTracks()[0]:'video'===a.kind&&(g=a.stream.getVideoTracks()[0]);g&&15019<=b&&'video'===
a.kind&&!a.sendEncodingParameters[0].rtx&&(a.sendEncodingParameters[0].rtx={ssrc:a.sendEncodingParameters[0].ssrc+1})}f=k(a.localCapabilities,a.remoteCapabilities);!f.codecs.filter(function(a){return'rtx'===a.name.toLowerCase()}).length&&a.sendEncodingParameters[0].rtx&&delete a.sendEncodingParameters[0].rtx;d+=c(a,f,'answer',a.stream,e._dtlsRole);a.rtcpParameters&&a.rtcpParameters.reducedSize&&(d+='a=rtcp-rsize\r\n')}});var l=new a.RTCSessionDescription({type:'answer',sdp:d});return Promise.resolve(l)};
h.prototype.addIceCandidate=function(a){var b=this,c;return a&&void 0===a.sdpMLineIndex&&!a.sdpMid?Promise.reject(new TypeError('sdpMLineIndex or sdpMid required')):new Promise(function(e,d){if(b._remoteDescription)if(a&&''!==a.candidate){var k=a.sdpMLineIndex;if(a.sdpMid)for(var h=0;h<b.transceivers.length;h++)if(b.transceivers[h].mid===a.sdpMid){k=h;break}var g=b.transceivers[k];if(g){if(g.rejected)return e();h=0<Object.keys(a.candidate).length?p.parseCandidate(a.candidate):{};if('tcp'===h.protocol&&
(0===h.port||9===h.port)||h.component&&1!==h.component)return e();if((0===k||0<k&&g.iceTransport!==b.transceivers[0].iceTransport)&&!q(g.iceTransport,h))return d(f('OperationError','Can not add ICE candidate'));d=a.candidate.trim();0===d.indexOf('a=')&&(d=d.substr(2));c=p.getMediaSections(b._remoteDescription.sdp);c[k]+='a='+(h.type?d:'end-of-candidates')+'\r\n';b._remoteDescription.sdp=p.getDescription(b._remoteDescription.sdp)+c.join('')}else return d(f('OperationError','Can not add ICE candidate'))}else for(k=
0;k<b.transceivers.length&&(b.transceivers[k].rejected||(b.transceivers[k].iceTransport.addRemoteCandidate({}),c=p.getMediaSections(b._remoteDescription.sdp),c[k]+='a=end-of-candidates\r\n',b._remoteDescription.sdp=p.getDescription(b._remoteDescription.sdp)+c.join(''),!b.usingBundle));k++);else return d(f('InvalidStateError','Can not add ICE candidate without a remote description'));e()})};h.prototype.getStats=function(b){if(b&&b instanceof a.MediaStreamTrack){var c=null;this.transceivers.forEach(function(a){a.rtpSender&&
a.rtpSender.track===b?c=a.rtpSender:a.rtpReceiver&&a.rtpReceiver.track===b&&(c=a.rtpReceiver)});if(!c)throw f('InvalidAccessError','Invalid selector.');return c.getStats()}var e=[];this.transceivers.forEach(function(a){['rtpSender','rtpReceiver','iceGatherer','iceTransport','dtlsTransport'].forEach(function(b){a[b]&&e.push(a[b].getStats())})});return Promise.all(e).then(function(a){var b=new Map;a.forEach(function(a){a.forEach(function(a){b.set(a.id,a)})});return b})};['RTCRtpSender','RTCRtpReceiver',
'RTCIceGatherer','RTCIceTransport','RTCDtlsTransport'].forEach(function(b){if((b=a[b])&&b.prototype&&b.prototype.getStats){var c=b.prototype.getStats;b.prototype.getStats=function(){return c.apply(this).then(function(a){var b=new Map;Object.keys(a).forEach(function(c){var e=a[c];a[c].type={inboundrtp:'inbound-rtp',outboundrtp:'outbound-rtp',candidatepair:'candidate-pair',localcandidate:'local-candidate',remotecandidate:'remote-candidate'}[e.type]||e.type;b.set(c,a[c])});return b})}}});var n=['createOffer',
'createAnswer'];n.forEach(function(a){var b=h.prototype[a];h.prototype[a]=function(){var a=arguments;return'function'===typeof a[0]||'function'===typeof a[1]?b.apply(this,[arguments[2]]).then(function(b){'function'===typeof a[0]&&a[0].apply(null,[b])},function(b){'function'===typeof a[1]&&a[1].apply(null,[b])}):b.apply(this,arguments)}});n=['setLocalDescription','setRemoteDescription','addIceCandidate'];n.forEach(function(a){var b=h.prototype[a];h.prototype[a]=function(){var a=arguments;return'function'===
typeof a[1]||'function'===typeof a[2]?b.apply(this,arguments).then(function(){'function'===typeof a[1]&&a[1].apply(null)},function(b){'function'===typeof a[2]&&a[2].apply(null,[b])}):b.apply(this,arguments)}});['getStats'].forEach(function(a){var b=h.prototype[a];h.prototype[a]=function(){var a=arguments;return'function'===typeof a[1]?b.apply(this,arguments).then(function(){'function'===typeof a[1]&&a[1].apply(null)}):b.apply(this,arguments)}});return h}},{sdp:17}],17:[function(a,b,d){var c={generateIdentifier:function(){return Math.random().toString(36).substr(2,
10)}};c.localCName=c.generateIdentifier();c.splitLines=function(a){return a.trim().split('\n').map(function(a){return a.trim()})};c.splitSections=function(a){return a.split('\nm=').map(function(a,b){return(0<b?'m='+a:a).trim()+'\r\n'})};c.getDescription=function(a){return(a=c.splitSections(a))&&a[0]};c.getMediaSections=function(a){a=c.splitSections(a);a.shift();return a};c.matchPrefix=function(a,b){return c.splitLines(a).filter(function(a){return 0===a.indexOf(b)})};c.parseCandidate=function(a){a=
...
c.writeCandidate=function(a){var b=[];b.push(a.foundation);b.push(a.component);b.push(a.protocol.toUpperCase());b.push(a.priority);b.push(a.address||a.ip);b.push(a.port);var c=a.type;b.push('typ');b.push(c);'host'!==c&&a.relatedAddress&&a.relatedPort&&(b.push('raddr'),b.push(a.relatedAddress),b.push('rport'),b.push(a.relatedPort));a.tcpType&&'tcp'===a.protocol.toLowerCase()&&(b.push('tcptype'),b.push(a.tcpType));if(a.usernameFragment||a.ufrag)b.push('ufrag'),b.push(a.usernameFragment||a.ufrag);return'candidate:'+
b.join(' ')};c.parseIceOptions=function(a){return a.substr(14).split(' ')};c.parseRtpMap=function(a){a=a.substr(9).split(' ');var b={payloadType:parseInt(a.shift(),10)};a=a[0].split('/');b.name=a[0];b.clockRate=parseInt(a[1],10);b.channels=3===a.length?parseInt(a[2],10):1;b.numChannels=b.channels;return b};c.writeRtpMap=function(a){var b=a.payloadType;void 0!==a.preferredPayloadType&&(b=a.preferredPayloadType);var c=a.channels||a.numChannels||1;return'a=rtpmap:'+b+' '+a.name+'/'+a.clockRate+(1!==
c?'/'+c:'')+'\r\n'};c.parseExtmap=function(a){a=a.substr(9).split(' ');return{id:parseInt(a[0],10),direction:0<a[0].indexOf('/')?a[0].split('/')[1]:'sendrecv',uri:a[1]}};c.writeExtmap=function(a){return'a=extmap:'+(a.id||a.preferredId)+(a.direction&&'sendrecv'!==a.direction?'/'+a.direction:'')+' '+a.uri+'\r\n'};c.parseFmtp=function(a){for(var b={},c=a.substr(a.indexOf(' ')+1).split(';'),e=0;e<c.length;e++)a=c[e].trim().split('='),b[a[0].trim()]=a[1];return b};c.writeFmtp=function(a){var b='',c=a.payloadType;
void 0!==a.preferredPayloadType&&(c=a.preferredPayloadType);if(a.parameters&&Object.keys(a.parameters).length){var e=[];Object.keys(a.parameters).forEach(function(b){a.parameters[b]?e.push(b+'='+a.parameters[b]):e.push(b)});b+='a=fmtp:'+c+' '+e.join(';')+'\r\n'}return b};c.parseRtcpFb=function(a){a=a.substr(a.indexOf(' ')+1).split(' ');return{type:a.shift(),parameter:a.join(' ')}};c.writeRtcpFb=function(a){var b='',c=a.payloadType;void 0!==a.preferredPayloadType&&(c=a.preferredPayloadType);a.rtcpFeedback&&
a.rtcpFeedback.length&&a.rtcpFeedback.forEach(function(a){b+='a=rtcp-fb:'+c+' '+a.type+(a.parameter&&a.parameter.length?' '+a.parameter:'')+'\r\n'});return b};c.parseSsrcMedia=function(a){var b=a.indexOf(' '),c={ssrc:parseInt(a.substr(7,b-7),10)},e=a.indexOf(':',b);-1<e?(c.attribute=a.substr(b+1,e-b-1),c.value=a.substr(e+1)):c.attribute=a.substr(b+1);return c};c.parseSsrcGroup=function(a){a=a.substr(13).split(' ');return{semantics:a.shift(),ssrcs:a.map(function(a){return parseInt(a,10)})}};c.getMid=
function(a){if(a=c.matchPrefix(a,'a=mid:')[0])return a.substr(6)};c.parseFingerprint=function(a){a=a.substr(14).split(' ');return{algorithm:a[0].toLowerCase(),value:a[1]}};c.getDtlsParameters=function(a,b){return{role:'auto',fingerprints:c.matchPrefix(a+b,'a=fingerprint:').map(c.parseFingerprint)}};c.writeDtlsParameters=function(a,b){var c='a=setup:'+b+'\r\n';a.fingerprints.forEach(function(a){c+='a=fingerprint:'+a.algorithm+' '+a.value+'\r\n'});return c};c.parseCryptoLine=function(a){a=a.substr(9).split(' ');
return{tag:parseInt(a[0],10),cryptoSuite:a[1],keyParams:a[2],sessionParams:a.slice(3)}};c.writeCryptoLine=function(a){return'a=crypto:'+a.tag+' '+a.cryptoSuite+' '+('object'===typeof a.keyParams?c.writeCryptoKeyParams(a.keyParams):a.keyParams)+(a.sessionParams?' '+a.sessionParams.join(' '):'')+'\r\n'};c.parseCryptoKeyParams=function(a){if(0!==a.indexOf('inline:'))return null;a=a.substr(7).split('|');return{keyMethod:'inline',keySalt:a[0],lifeTime:a[1],mkiValue:a[2]?a[2].split(':')[0]:void 0,mkiLength:a[2]?
a[2].split(':')[1]:void 0}};c.writeCryptoKeyParams=function(a){return a.keyMethod+':'+a.keySalt+(a.lifeTime?'|'+a.lifeTime:'')+(a.mkiValue&&a.mkiLength?'|'+a.mkiValue+':'+a.mkiLength:'')};c.getCryptoParameters=function(a,b){return c.matchPrefix(a+b,'a=crypto:').map(c.parseCryptoLine)};c.getIceParameters=function(a,b){var d=c.matchPrefix(a+b,'a=ice-ufrag:')[0];a=c.matchPrefix(a+b,'a=ice-pwd:')[0];return d&&a?{usernameFragment:d.substr(12),password:a.substr(10)}:null};c.writeIceParameters=function(a){return'a=ice-ufrag:'+
a.usernameFragment+'\r\na=ice-pwd:'+a.password+'\r\n'};c.parseRtpParameters=function(a){for(var b={codecs:[],headerExtensions:[],fecMechanisms:[],rtcp:[]},d=c.splitLines(a)[0].split(' '),e=3;e<d.length;e++){var f=d[e],p=c.matchPrefix(a,'a=rtpmap:'+f+' ')[0];if(p){p=c.parseRtpMap(p);var t=c.matchPrefix(a,'a=fmtp:'+f+' ');p.parameters=t.length?c.parseFmtp(t[0]):{};p.rtcpFeedback=c.matchPrefix(a,'a=rtcp-fb:'+f+' ').map(c.parseRtcpFb);b.codecs.push(p);switch(p.name.toUpperCase()){case 'RED':case 'ULPFEC':b.fecMechanisms.push(p.name.toUpperCase())}}}c.matchPrefix(a,
'a=extmap:').forEach(function(a){b.headerExtensions.push(c.parseExtmap(a))});return b};c.writeRtpDescription=function(a,b){var d='';d+='m='+a+' ';d+=0<b.codecs.length?'9':'0';d+=' UDP/TLS/RTP/SAVPF ';d+=b.codecs.map(function(a){return void 0!==a.preferredPayloadType?a.preferredPayloadType:a.payloadType}).join(' ')+'\r\n';d+='c=IN IP4 0.0.0.0\r\n';d+='a=rtcp:9 IN IP4 0.0.0.0\r\n';b.codecs.forEach(function(a){d+=c.writeRtpMap(a);d+=c.writeFmtp(a);d+=c.writeRtcpFb(a)});var e=0;b.codecs.forEach(function(a){a.maxptime>
e&&(e=a.maxptime)});0<e&&(d+='a=maxptime:'+e+'\r\n');d+='a=rtcp-mux\r\n';b.headerExtensions&&b.headerExtensions.forEach(function(a){d+=c.writeExtmap(a)});return d};c.parseRtpEncodingParameters=function(a){var b=[],d=c.parseRtpParameters(a),e=-1!==d.fecMechanisms.indexOf('RED'),f=-1!==d.fecMechanisms.indexOf('ULPFEC'),p=c.matchPrefix(a,'a=ssrc:').map(function(a){return c.parseSsrcMedia(a)}).filter(function(a){return'cname'===a.attribute}),t=0<p.length&&p[0].ssrc,v;p=c.matchPrefix(a,'a=ssrc-group:FID').map(function(a){return a.substr(17).split(' ').map(function(a){return parseInt(a,
10)})});0<p.length&&1<p[0].length&&p[0][0]===t&&(v=p[0][1]);d.codecs.forEach(function(a){'RTX'===a.name.toUpperCase()&&a.parameters.apt&&(a={ssrc:t,codecPayloadType:parseInt(a.parameters.apt,10)},t&&v&&(a.rtx={ssrc:v}),b.push(a),e&&(a=JSON.parse(JSON.stringify(a)),a.fec={ssrc:t,mechanism:f?'red+ulpfec':'red'},b.push(a)))});0===b.length&&t&&b.push({ssrc:t});var u=c.matchPrefix(a,'b=');u.length&&(u=0===u[0].indexOf('b=TIAS:')?parseInt(u[0].substr(7),10):0===u[0].indexOf('b=AS:')?950*parseInt(u[0].substr(5),
10)-16E3:void 0,b.forEach(function(a){a.maxBitrate=u}));return b};c.parseRtcpParameters=function(a){var b={},d=c.matchPrefix(a,'a=ssrc:').map(function(a){return c.parseSsrcMedia(a)}).filter(function(a){return'cname'===a.attribute})[0];d&&(b.cname=d.value,b.ssrc=d.ssrc);d=c.matchPrefix(a,'a=rtcp-rsize');b.reducedSize=0<d.length;b.compound=0===d.length;a=c.matchPrefix(a,'a=rtcp-mux');b.mux=0<a.length;return b};c.parseMsid=function(a){var b=c.matchPrefix(a,'a=msid:');if(1===b.length)return a=b[0].substr(7).split(' '),
{stream:a[0],track:a[1]};a=c.matchPrefix(a,'a=ssrc:').map(function(a){return c.parseSsrcMedia(a)}).filter(function(a){return'msid'===a.attribute});if(0<a.length)return a=a[0].value.split(' '),{stream:a[0],track:a[1]}};c.parseSctpDescription=function(a){var b=c.parseMLine(a),d=c.matchPrefix(a,'a=max-message-size:'),e;0<d.length&&(e=parseInt(d[0].substr(19),10));isNaN(e)&&(e=65536);d=c.matchPrefix(a,'a=sctp-port:');if(0<d.length)return{port:parseInt(d[0].substr(12),10),protocol:b.fmt,maxMessageSize:e};
if(0<c.matchPrefix(a,'a=sctpmap:').length)return a=c.matchPrefix(a,'a=sctpmap:')[0].substr(10).split(' '),{port:parseInt(a[0],10),protocol:a[1],maxMessageSize:e}};c.writeSctpDescription=function(a,b){a='DTLS/SCTP'!==a.protocol?['m='+a.kind+' 9 '+a.protocol+' '+b.protocol+'\r\n','c=IN IP4 0.0.0.0\r\n','a=sctp-port:'+b.port+'\r\n']:['m='+a.kind+' 9 '+a.protocol+' '+b.port+'\r\n','c=IN IP4 0.0.0.0\r\n','a=sctpmap:'+b.port+' '+b.protocol+' 65535\r\n'];void 0!==b.maxMessageSize&&a.push('a=max-message-size:'+
b.maxMessageSize+'\r\n');return a.join('')};c.generateSessionId=function(){return Math.random().toString().substr(2,21)};c.writeSessionBoilerplate=function(a,b,d){b=void 0!==b?b:2;a=a?a:c.generateSessionId();return'v=0\r\no='+(d||'thisisadapterortc')+' '+a+' '+b+' IN IP4 127.0.0.1\r\ns=-\r\nt=0 0\r\n'};c.writeMediaSection=function(a,b,d,q){b=c.writeRtpDescription(a.kind,b);b+=c.writeIceParameters(a.iceGatherer.getLocalParameters());b+=c.writeDtlsParameters(a.dtlsTransport.getLocalParameters(),'offer'===
d?'actpass':'active');b+='a=mid:'+a.mid+'\r\n';b=a.direction?b+('a='+a.direction+'\r\n'):a.rtpSender&&a.rtpReceiver?b+'a=sendrecv\r\n':a.rtpSender?b+'a=sendonly\r\n':a.rtpReceiver?b+'a=recvonly\r\n':b+'a=inactive\r\n';a.rtpSender&&(d='msid:'+q.id+' '+a.rtpSender.track.id+'\r\n',b=b+('a='+d)+('a=ssrc:'+a.sendEncodingParameters[0].ssrc+' '+d),a.sendEncodingParameters[0].rtx&&(b+='a=ssrc:'+a.sendEncodingParameters[0].rtx.ssrc+' '+d,b+='a=ssrc-group:FID '+a.sendEncodingParameters[0].ssrc+' '+a.sendEncodingParameters[0].rtx.ssrc+
'\r\n'));b+='a=ssrc:'+a.sendEncodingParameters[0].ssrc+' cname:'+c.localCName+'\r\n';a.rtpSender&&a.sendEncodingParameters[0].rtx&&(b+='a=ssrc:'+a.sendEncodingParameters[0].rtx.ssrc+' cname:'+c.localCName+'\r\n');return b};c.getDirection=function(a,b){a=c.splitLines(a);for(var d=0;d<a.length;d++)switch(a[d]){case 'a=sendrecv':case 'a=sendonly':case 'a=recvonly':case 'a=inactive':return a[d].substr(2)}return b?c.getDirection(b):'sendrecv'};c.getKind=function(a){return c.splitLines(a)[0].split(' ')[0].substr(2)};
c.isRejected=function(a){return'0'===a.split(' ',2)[1]};c.parseMLine=function(a){a=c.splitLines(a)[0].substr(2).split(' ');return{kind:a[0],port:parseInt(a[1],10),protocol:a[2],fmt:a.slice(3).join(' ')}};c.parseOLine=function(a){a=c.matchPrefix(a,'o=')[0].substr(2).split(' ');return{username:a[0],sessionId:a[1],sessionVersion:parseInt(a[2],10),netType:a[3],addressType:a[4],address:a[5]}};c.isValidSDP=function(a){if('string'!==typeof a||0===a.length)return!1;a=c.splitLines(a);for(var b=0;b<a.length;b++)if(2>
a[b].length||'='!==a[b].charAt(1))return!1;return!0};'object'===typeof b&&(b.exports=c)},{}]},{},[1])(1)});(function(a){function b(a,b){var c=(a&65535)+(b&65535);return(a>>16)+(b>>16)+(c>>16)<<16|c&65535}function d(a,c,d,e,f,k){a=b(b(c,a),b(e,k));return b(a<<f|a>>>32-f,d)}function c(a,b,c,e,f,k,m){return d(b&c|~b&e,a,b,f,k,m)}function e(a,b,c,e,f,k,m){return d(b&e|c&~e,a,b,f,k,m)}function k(a,b,c,e,f,k,m){return d(c^(b|~e),a,b,f,k,m)}function m(a,f){a[f>>5]|=128<<f%32;a[(f+64>>>9<<4)+14]=f;var h=1732584193,n=-271733879,g=-1732584194,l=271733878;for(f=0;f<a.length;f+=16){var m=h;var p=n;var q=g;var w=l;
h=c(h,n,g,l,a[f],7,-680876936);l=c(l,h,n,g,a[f+1],12,-389564586);g=c(g,l,h,n,a[f+2],17,606105819);n=c(n,g,l,h,a[f+3],22,-1044525330);h=c(h,n,g,l,a[f+4],7,-176418897);l=c(l,h,n,g,a[f+5],12,1200080426);g=c(g,l,h,n,a[f+6],17,-1473231341);n=c(n,g,l,h,a[f+7],22,-45705983);h=c(h,n,g,l,a[f+8],7,1770035416);l=c(l,h,n,g,a[f+9],12,-1958414417);g=c(g,l,h,n,a[f+10],17,-42063);n=c(n,g,l,h,a[f+11],22,-1990404162);h=c(h,n,g,l,a[f+12],7,1804603682);l=c(l,h,n,g,a[f+13],12,-40341101);g=c(g,l,h,n,a[f+14],17,-1502002290);
n=c(n,g,l,h,a[f+15],22,1236535329);h=e(h,n,g,l,a[f+1],5,-165796510);l=e(l,h,n,g,a[f+6],9,-1069501632);g=e(g,l,h,n,a[f+11],14,643717713);n=e(n,g,l,h,a[f],20,-373897302);h=e(h,n,g,l,a[f+5],5,-701558691);l=e(l,h,n,g,a[f+10],9,38016083);g=e(g,l,h,n,a[f+15],14,-660478335);n=e(n,g,l,h,a[f+4],20,-405537848);h=e(h,n,g,l,a[f+9],5,568446438);l=e(l,h,n,g,a[f+14],9,-1019803690);g=e(g,l,h,n,a[f+3],14,-187363961);n=e(n,g,l,h,a[f+8],20,1163531501);h=e(h,n,g,l,a[f+13],5,-1444681467);l=e(l,h,n,g,a[f+2],9,-51403784);
g=e(g,l,h,n,a[f+7],14,1735328473);n=e(n,g,l,h,a[f+12],20,-1926607734);h=d(n^g^l,h,n,a[f+5],4,-378558);l=d(h^n^g,l,h,a[f+8],11,-2022574463);g=d(l^h^n,g,l,a[f+11],16,1839030562);n=d(g^l^h,n,g,a[f+14],23,-35309556);h=d(n^g^l,h,n,a[f+1],4,-1530992060);l=d(h^n^g,l,h,a[f+4],11,1272893353);g=d(l^h^n,g,l,a[f+7],16,-155497632);n=d(g^l^h,n,g,a[f+10],23,-1094730640);h=d(n^g^l,h,n,a[f+13],4,681279174);l=d(h^n^g,l,h,a[f],11,-358537222);g=d(l^h^n,g,l,a[f+3],16,-722521979);n=d(g^l^h,n,g,a[f+6],23,76029189);h=d(n^
g^l,h,n,a[f+9],4,-640364487);l=d(h^n^g,l,h,a[f+12],11,-421815835);g=d(l^h^n,g,l,a[f+15],16,530742520);n=d(g^l^h,n,g,a[f+2],23,-995338651);h=k(h,n,g,l,a[f],6,-198630844);l=k(l,h,n,g,a[f+7],10,1126891415);g=k(g,l,h,n,a[f+14],15,-1416354905);n=k(n,g,l,h,a[f+5],21,-57434055);h=k(h,n,g,l,a[f+12],6,1700485571);l=k(l,h,n,g,a[f+3],10,-1894986606);g=k(g,l,h,n,a[f+10],15,-1051523);n=k(n,g,l,h,a[f+1],21,-2054922799);h=k(h,n,g,l,a[f+8],6,1873313359);l=k(l,h,n,g,a[f+15],10,-30611744);g=k(g,l,h,n,a[f+6],15,-1560198380);
n=k(n,g,l,h,a[f+13],21,1309151649);h=k(h,n,g,l,a[f+4],6,-145523070);l=k(l,h,n,g,a[f+11],10,-1120210379);g=k(g,l,h,n,a[f+2],15,718787259);n=k(n,g,l,h,a[f+9],21,-343485551);h=b(h,m);n=b(n,p);g=b(g,q);l=b(l,w)}return[h,n,g,l]}function q(a){var b,c='',d=32*a.length;for(b=0;b<d;b+=8)c+=String.fromCharCode(a[b>>5]>>>b%32&255);return c}function f(a){var b,c=[];c[(a.length>>2)-1]=void 0;for(b=0;b<c.length;b+=1)c[b]=0;var d=8*a.length;for(b=0;b<d;b+=8)c[b>>5]|=(a.charCodeAt(b/8)&255)<<b%32;return c}function p(a){return q(m(f(a),
8*a.length))}function t(a,b){var c=f(a),d=[],e=[];d[15]=e[15]=void 0;16<c.length&&(c=m(c,8*a.length));for(a=0;16>a;a+=1)d[a]=c[a]^909522486,e[a]=c[a]^1549556828;b=m(d.concat(f(b)),512+8*b.length);return q(m(e.concat(b),640))}function v(a){var b='',c;for(c=0;c<a.length;c+=1){var d=a.charCodeAt(c);b+='0123456789abcdef'.charAt(d>>>4&15)+'0123456789abcdef'.charAt(d&15)}return b}function u(a,b,c){b?c?a=t(unescape(encodeURIComponent(b)),unescape(encodeURIComponent(a))):(a=t(unescape(encodeURIComponent(b)),
unescape(encodeURIComponent(a))),a=v(a)):a=c?p(unescape(encodeURIComponent(a))):v(p(unescape(encodeURIComponent(a))));return a}'function'===typeof define&&define.amd?define(function(){return u}):'object'===typeof module&&module.exports?module.exports=u:a.md5=u})(this);(function(a){'undefined'!==typeof module&&module.exports&&(module.exports=a);a['encoding-indexes']={big5:[null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,
...
(function(a){function b(a,b,c){return b<=a&&a<=c}function d(a){if(void 0===a)return{};if(a===Object(a))return a;throw TypeError('Could not convert argument to dictionary');}function c(a){return 0<=a&&127>=a}function e(a){this.tokens=[].slice.call(a);this.tokens.reverse()}function k(a,b){if(a)throw TypeError('Decoder error');return b||65533}function m(a){throw TypeError('The code point '+a+' could not be encoded.');}function q(a){a=String(a).trim().toLowerCase();return Object.prototype.hasOwnProperty.call(C,
a)?C[a]:null}function f(a,b){return b?b[a]||null:null}function p(a,b){a=b.indexOf(a);return-1===a?null:a}function t(b){if(!('encoding-indexes'in a))throw Error('Indexes missing. Did you forget to include encoding-indexes.js first?');return a['encoding-indexes'][b]}function v(a){B=B||t('jis0208').map(function(a,c){return b(c,8272,8835)?null:a});return B.indexOf(a)}function u(a){var b=S=S||t('big5').map(function(a,b){return 5024>b?null:a});return 9552===a||9566===a||9569===a||9578===a||21313===a||21317===
a?b.lastIndexOf(a):p(a,b)}function w(a,b){if(!(this instanceof w))throw TypeError("Called as a function. Did you forget 'new'?");a=void 0!==a?String(a):'utf-8';b=d(b);this._decoder=this._encoding=null;this._BOMseen=this._ignoreBOM=!1;this._error_mode='replacement';this._do_not_flush=!1;var c=q(a);if(null===c||'replacement'===c.name)throw RangeError('Unknown encoding: '+a);if(!y[c.name])throw Error('Decoder not present. Did you forget to include encoding-indexes.js first?');this._encoding=c;b.fatal&&
(this._error_mode='fatal');b.ignoreBOM&&(this._ignoreBOM=!0);Object.defineProperty||(this.encoding=this._encoding.name.toLowerCase(),this.fatal='fatal'===this._error_mode,this.ignoreBOM=this._ignoreBOM);return this}function l(b,c){if(!(this instanceof l))throw TypeError("Called as a function. Did you forget 'new'?");c=d(c);this._encoder=this._encoding=null;this._do_not_flush=!1;this._fatal=c.fatal?'fatal':'replacement';if(c.NONSTANDARD_allowLegacyEncoding){b=void 0!==b?String(b):'utf-8';c=q(b);if(null===
c||'replacement'===c.name)throw RangeError('Unknown encoding: '+b);if(!r[c.name])throw Error('Encoder not present. Did you forget to include encoding-indexes.js first?');this._encoding=c}else this._encoding=q('utf-8'),void 0!==b&&'console'in a&&console.warn('TextEncoder constructor called with encoding label, which is ignored.');Object.defineProperty||(this.encoding=this._encoding.name.toLowerCase());return this}function h(a){var c=a.fatal,d=0,e=0,f=0,h=128,g=191;this.handler=function(a,l){if(-1===
l&&0!==f)return f=0,k(c);if(-1===l)return-1;if(0===f){if(b(l,0,127))return l;if(b(l,194,223))f=1,d=l&31;else if(b(l,224,239))224===l&&(h=160),237===l&&(g=159),f=2,d=l&15;else if(b(l,240,244))240===l&&(h=144),244===l&&(g=143),f=3,d=l&7;else return k(c);return null}if(!b(l,h,g))return d=f=e=0,h=128,g=191,a.prepend(l),k(c);h=128;g=191;d=d<<6|l&63;e+=1;if(e!==f)return null;a=d;d=f=e=0;return a}}function n(a){this.handler=function(a,c){if(-1===c)return-1;if(A(c))return c;if(b(c,128,2047)){var d=1;var e=
192}else b(c,2048,65535)?(d=2,e=224):b(c,65536,1114111)&&(d=3,e=240);for(a=[(c>>6*d)+e];0<d;)a.push(128|c>>6*(d-1)&63),--d;return a}}function g(a,b){var d=b.fatal;this.handler=function(b,e){if(-1===e)return-1;if(c(e))return e;b=a[e-128];return null===b?k(d):b}}function x(a,b){this.handler=function(b,c){if(-1===c)return-1;if(A(c))return c;b=p(c,a);null===b&&m(c);return b+128}}function D(a){var d=a.fatal,e=0,h=0,l=0;this.handler=function(a,g){if(-1===g&&0===e&&0===h&&0===l)return-1;-1!==g||0===e&&0===
h&&0===l||(l=h=e=0,k(d));if(0!==l){var n=null;if(b(g,48,57))if(n=10*(126*(10*(e-129)+h-48)+l-129)+g-48,39419<n&&189E3>n||1237575<n)n=null;else if(7457===n)n=59335;else{var m=0,N=0,p=t('gb18030-ranges'),M;for(M=0;M<p.length;++M){var O=p[M];if(O[0]<=n)m=O[0],N=O[1];else break}n=N+n-m}g=[h,l,g];l=h=e=0;return null===n?(a.prepend(g),k(d)):n}if(0!==h){if(b(g,129,254))return l=g,null;a.prepend([h,g]);h=e=0;return k(d)}if(0!==e){if(b(g,48,57))return h=g,null;n=e;m=null;e=0;N=127>g?64:65;if(b(g,64,126)||
b(g,128,254))m=190*(n-129)+(g-N);n=null===m?null:f(m,t('gb18030'));null===n&&c(g)&&a.prepend(g);return null===n?k(d):n}return c(g)?g:128===g?8364:b(g,129,254)?(e=g,null):k(d)}}function G(a,b){this.handler=function(a,c){if(-1===c)return-1;if(A(c))return c;if(58853===c)return m(c);if(b&&8364===c)return 128;a=p(c,t('gb18030'));if(null!==a)return c=F(a/190)+129,a%=190,[c,a+(63>a?64:65)];if(b)return m(c);if(59335===c)a=7457;else{var d=a=0,e=t('gb18030-ranges'),f;for(f=0;f<e.length;++f){var h=e[f];if(h[1]<=
c)a=h[1],d=h[0];else break}a=d+c-a}c=F(a/10/126/10);a-=12600*c;d=F(a/10/126);a-=1260*d;e=F(a/10);return[c+129,d+48,e+129,a-10*e+48]}}function z(a){var d=a.fatal,e=0;this.handler=function(a,h){if(-1===h&&0!==e)return e=0,k(d);if(-1===h&&0===e)return-1;if(0!==e){var g=e,l=null;e=0;var n=127>h?64:98;if(b(h,64,126)||b(h,161,254))l=157*(g-129)+(h-n);switch(l){case 1133:return[202,772];case 1135:return[202,780];case 1164:return[234,772];case 1166:return[234,780]}g=null===l?null:f(l,t('big5'));null===g&&
c(h)&&a.prepend(h);return null===g?k(d):g}return c(h)?h:b(h,129,254)?(e=h,null):k(d)}}function E(a){this.handler=function(a,b){if(-1===b)return-1;if(A(b))return b;var c=u(b);if(null===c)return m(b);a=F(c/157)+129;if(161>a)return m(b);b=c%157;return[a,b+(63>b?64:98)]}}function H(a){var d=a.fatal,e=!1,h=0;this.handler=function(a,g){if(-1===g&&0!==h)return h=0,k(d);if(-1===g&&0===h)return-1;if(142===h&&b(g,161,223))return h=0,65216+g;if(143===h&&b(g,161,254))return e=!0,h=g,null;if(0!==h){var l=h;h=
0;var n=null;b(l,161,254)&&b(g,161,254)&&(n=f(94*(l-161)+(g-161),t(e?'jis0212':'jis0208')));e=!1;b(g,161,254)||a.prepend(g);return null===n?k(d):n}return c(g)?g:142===g||143===g||b(g,161,254)?(h=g,null):k(d)}}function I(a){this.handler=function(a,c){if(-1===c)return-1;if(A(c))return c;if(165===c)return 92;if(8254===c)return 126;if(b(c,65377,65439))return[142,c-65377+161];8722===c&&(c=65293);a=p(c,t('jis0208'));return null===a?m(c):[F(a/94)+161,a%94+161]}}function T(a){var c=a.fatal,d=0,e=0,h=!1;this.handler=
...
!1,e=g,d=4,null;if(-1===g)return-1;h=!1;return k(c);case 4:if(27===g)return d=5,k(c);if(b(g,33,126))return d=3,a=f(94*(e-33)+g-33,t('jis0208')),null===a?k(c):a;if(-1===g)return d=3,a.prepend(g),k(c);d=3;return k(c);case 5:if(36===g||40===g)return e=g,d=6,null;a.prepend(g);h=!1;d=0;return k(c);case 6:var l=e;e=0;var n=null;40===l&&66===g&&(n=0);40===l&&74===g&&(n=1);40===l&&73===g&&(n=2);36!==l||64!==g&&66!==g||(n=3);if(null!==n)return d=d=n,a=h,h=!0,a?k(c):null;a.prepend([l,g]);h=!1;d=0;return k(c)}}}
function J(a){var b=0;this.handler=function(a,c){if(-1===c&&0!==b)return a.prepend(c),b=0,[27,40,66];if(-1===c&&0===b)return-1;if(!(0!==b&&1!==b||14!==c&&15!==c&&27!==c))return m(65533);if(0===b&&A(c))return c;if(1===b&&(A(c)&&92!==c&&126!==c||165==c||8254==c)){if(A(c))return c;if(165===c)return 92;if(8254===c)return 126}if(A(c)&&0!==b)return a.prepend(c),b=0,[27,40,66];if((165===c||8254===c)&&1!==b)return a.prepend(c),b=1,[27,40,74];8722===c&&(c=65293);var d=p(c,t('jis0208'));return null===d?m(c):
2!==b?(a.prepend(c),b=2,[27,36,66]):[F(d/94)+33,d%94+33]}}function K(a){var d=a.fatal,e=0;this.handler=function(a,g){if(-1===g&&0!==e)return e=0,k(d);if(-1===g&&0===e)return-1;if(0!==e){var h=e,l=null;e=0;var n=127>g?64:65,m=160>h?129:193;if(b(g,64,126)||b(g,128,252))l=188*(h-m)+g-n;if(b(l,8836,10715))return 48508+l;h=null===l?null:f(l,t('jis0208'));null===h&&c(g)&&a.prepend(g);return null===h?k(d):h}return c(g)||128===g?g:b(g,161,223)?65216+g:b(g,129,159)||b(g,224,252)?(e=g,null):k(d)}}function U(a){this.handler=
function(a,c){if(-1===c)return-1;if(A(c)||128===c)return c;if(165===c)return 92;if(8254===c)return 126;if(b(c,65377,65439))return c-65377+161;8722===c&&(c=65293);a=v(c);if(null===a)return m(c);c=F(a/188);a%=188;return[c+(31>c?129:193),a+(63>a?64:65)]}}function V(a){var d=a.fatal,e=0;this.handler=function(a,g){if(-1===g&&0!==e)return e=0,k(d);if(-1===g&&0===e)return-1;if(0!==e){var h=e,l=null;e=0;b(g,65,254)&&(l=190*(h-129)+(g-65));h=null===l?null:f(l,t('euc-kr'));null===l&&c(g)&&a.prepend(g);return null===
h?k(d):h}return c(g)?g:b(g,129,254)?(e=g,null):k(d)}}function W(a){this.handler=function(a,b){if(-1===b)return-1;if(A(b))return b;a=p(b,t('euc-kr'));return null===a?m(b):[F(a/190)+129,a%190+65]}}function L(a,b){var c=a>>8;a&=255;return b?[c,a]:[a,c]}function P(a,c){var d=c.fatal,e=null,f=null;this.handler=function(c,g){if(-1===g&&(null!==e||null!==f))return k(d);if(-1===g&&null===e&&null===f)return-1;if(null===e)return e=g,null;g=a?(e<<8)+g:(g<<8)+e;e=null;if(null!==f){var h=f;f=null;if(b(g,56320,
57343))return 65536+1024*(h-55296)+(g-56320);c.prepend(L(g,a));return k(d)}return b(g,55296,56319)?(f=g,null):b(g,56320,57343)?k(d):g}}function Q(a,c){this.handler=function(c,d){if(-1===d)return-1;if(b(d,0,65535))return L(d,a);c=L((d-65536>>10)+55296,a);d=L((d-65536&1023)+56320,a);return c.concat(d)}}function X(a){this.handler=function(a,b){return-1===b?-1:c(b)?b:63360+b-128}}function Y(a){this.handler=function(a,c){return-1===c?-1:A(c)?c:b(c,63360,63487)?c-63360+128:m(c)}}'undefined'!==typeof module&&
module.exports&&!a['encoding-indexes']&&(a['encoding-indexes']=require('./encoding-indexes.js')['encoding-indexes']);var F=Math.floor,A=c;e.prototype={endOfStream:function(){return!this.tokens.length},read:function(){return this.tokens.length?this.tokens.pop():-1},prepend:function(a){if(Array.isArray(a))for(;a.length;)this.tokens.push(a.pop());else this.tokens.push(a)},push:function(a){if(Array.isArray(a))for(;a.length;)this.tokens.unshift(a.shift());else this.tokens.unshift(a)}};var R=[{encodings:[{labels:['unicode-1-1-utf-8',
...
'iso-2022-cn','iso-2022-cn-ext','iso-2022-kr'],name:'replacement'},{labels:['utf-16be'],name:'UTF-16BE'},{labels:['utf-16','utf-16le'],name:'UTF-16LE'},{labels:['x-user-defined'],name:'x-user-defined'}],heading:'Legacy miscellaneous encodings'}],C={};R.forEach(function(a){a.encodings.forEach(function(a){a.labels.forEach(function(b){C[b]=a})})});var r={},y={},B,S;Object.defineProperty&&(Object.defineProperty(w.prototype,'encoding',{get:function(){return this._encoding.name.toLowerCase()}}),Object.defineProperty(w.prototype,
'fatal',{get:function(){return'fatal'===this._error_mode}}),Object.defineProperty(w.prototype,'ignoreBOM',{get:function(){return this._ignoreBOM}}));w.prototype.decode=function(a,b){a='object'===typeof a&&a instanceof ArrayBuffer?new Uint8Array(a):'object'===typeof a&&'buffer'in a&&a.buffer instanceof ArrayBuffer?new Uint8Array(a.buffer,a.byteOffset,a.byteLength):new Uint8Array(0);b=d(b);this._do_not_flush||(this._decoder=y[this._encoding.name]({fatal:'fatal'===this._error_mode}),this._BOMseen=!1);
this._do_not_flush=!!b.stream;a=new e(a);b=[];for(var c;;){c=a.read();if(-1===c)break;c=this._decoder.handler(a,c);if(-1===c)break;null!==c&&(Array.isArray(c)?b.push.apply(b,c):b.push(c))}if(!this._do_not_flush){do{c=this._decoder.handler(a,a.read());if(-1===c)break;null!==c&&(Array.isArray(c)?b.push.apply(b,c):b.push(c))}while(!a.endOfStream());this._decoder=null}-1===['UTF-8','UTF-16LE','UTF-16BE'].indexOf(this._encoding.name)||this._ignoreBOM||this._BOMseen||(0<b.length&&65279===b[0]?(this._BOMseen=
!0,b.shift()):0<b.length&&(this._BOMseen=!0));a='';for(c=0;c<b.length;++c){var f=b[c];65535>=f?a+=String.fromCharCode(f):(f-=65536,a+=String.fromCharCode((f>>10)+55296,(f&1023)+56320))}return a};Object.defineProperty&&Object.defineProperty(l.prototype,'encoding',{get:function(){return this._encoding.name.toLowerCase()}});l.prototype.encode=function(a,b){a=void 0===a?'':String(a);b=d(b);this._do_not_flush||(this._encoder=r[this._encoding.name]({fatal:'fatal'===this._fatal}));this._do_not_flush=!!b.stream;
a=String(a);b=a.length;for(var c=0,f=[];c<b;){var g=a.charCodeAt(c);if(55296>g||57343<g)f.push(g);else if(56320<=g&&57343>=g)f.push(65533);else if(55296<=g&&56319>=g)if(c===b-1)f.push(65533);else{var h=a.charCodeAt(c+1);56320<=h&&57343>=h?(f.push(65536+((g&1023)<<10)+(h&1023)),c+=1):f.push(65533)}c+=1}a=new e(f);for(b=[];;){c=a.read();if(-1===c)break;c=this._encoder.handler(a,c);if(-1===c)break;Array.isArray(c)?b.push.apply(b,c):b.push(c)}if(!this._do_not_flush){for(;;){c=this._encoder.handler(a,
a.read());if(-1===c)break;Array.isArray(c)?b.push.apply(b,c):b.push(c)}this._encoder=null}return new Uint8Array(b)};r['UTF-8']=function(a){return new n(a)};y['UTF-8']=function(a){return new h(a)};(function(){'encoding-indexes'in a&&R.forEach(function(a){'Legacy single-byte encodings'===a.heading&&a.encodings.forEach(function(a){a=a.name;var b=t(a.toLowerCase());y[a]=function(a){return new g(b,a)};r[a]=function(a){return new x(b,a)}})})})();y.GBK=function(a){return new D(a)};r.GBK=function(a){return new G(a,
!0)};r.gb18030=function(a){return new G(a)};y.gb18030=function(a){return new D(a)};r.Big5=function(a){return new E(a)};y.Big5=function(a){return new z(a)};r['EUC-JP']=function(a){return new I(a)};y['EUC-JP']=function(a){return new H(a)};r['ISO-2022-JP']=function(a){return new J(a)};y['ISO-2022-JP']=function(a){return new T(a)};r.Shift_JIS=function(a){return new U(a)};y.Shift_JIS=function(a){return new K(a)};r['EUC-KR']=function(a){return new W(a)};y['EUC-KR']=function(a){return new V(a)};r['UTF-16BE']=
function(a){return new Q(!0,a)};y['UTF-16BE']=function(a){return new P(!0,a)};r['UTF-16LE']=function(a){return new Q(!1,a)};y['UTF-16LE']=function(a){return new P(!1,a)};r['x-user-defined']=function(a){return new Y(a)};y['x-user-defined']=function(a){return new X(a)};a.TextEncoder||(a.TextEncoder=l);a.TextDecoder||(a.TextDecoder=w);'undefined'!==typeof module&&module.exports&&(module.exports={TextEncoder:a.TextEncoder,TextDecoder:a.TextDecoder,EncodingIndexes:a['encoding-indexes']})})(this||{});'use strict';
...
GamepadController.prototype.getGamepadList=function(){var a=[],b=0,d=null,c=null;if(0<this.gamepadList_.length){d=new ArrayBuffer(this.gamepadList_.length+4);c=new DataView(d);c.setUint8(0,1);c.setUint8(1,this.gamepadList_.length+3);c.setUint8(2,3);c.setUint8(3,9);for(var e=0;e<this.gamepadList_.length;e++)if(this.gamepadList_[e]){c.setUint8(4+e,1);var k={};k.id=this.gamepadList_[e].index;k.name=this.gamepadList_[e].id;k.order=b++;k.isVirtual=0;a.push(k);this.orderIndex_[k.id]=k.order}else c.setUint8(4+
e,0)}if(0<this.virtualGamepadList_.length)for(d||(d=new ArrayBuffer(5),c=new DataView(d),c.setUint8(0,1),c.setUint8(1,4),c.setUint8(2,3),c.setUint8(3,9),c.setUint8(4,0)),e=0;e<this.virtualGamepadList_.length;e++)this.virtualGamepadList_[e]&&(c.setUint8(4,1),k={},k.id=e+this.baseVirtualGamepadIndex_,k.name=this.virtualGamepadList_[e],k.order=b++,k.isVirtual=1,a.push(k),this.orderIndex_[k.id]=k.order);if(this.onoperate&&d)this.onoperate(d,d.byteLength);return a};
GamepadController.prototype.sendGamepadStatus=function(a,b){return a&&b&&this.virtualGamepadList_[a-this.baseVirtualGamepadIndex_]?this.encodeGamepadStatus_(0,b):!1};
GamepadController.prototype.gamepadVibration=function(a){if(!this.vibration_)return!0;if(a instanceof ArrayBuffer){var b=new DataView(a);if(11==b.byteLength&&163==b.getUint8(0)){a=b.getUint8(2);var d=b.getUint16(3),c=b.getUint16(5),e=b.getUint16(7);b=b.getUint16(9);0==d?d=500:5E3<d&&(d=5E3);e/=65535;b/=65535;var k=this.scanGamepad_();if(!k)return;for(var m=0;m<k.length;m++){var q=k[m];q&&this.orderIndex_[m]==a&&q.vibrationActuator&&q.vibrationActuator.playEffect(q.vibrationActuator.type,{duration:d,
startDelay:c,strongMagnitude:e,weakMagnitude:b})}}else return!1}else return!1;return!0};GamepadController.prototype.addGamepad_=function(a){this.gamepadList_[a.index]={};this.gamepadList_[a.index].timestamp=a.timestamp;this.gamepadList_[a.index].id=a.id;this.gamepadList_[a.index].index=a.index;this.getGamepadList()};GamepadController.prototype.removeGamepad_=function(a){delete this.gamepadList_[a.index];this.getGamepadList()};
...
GamepadController.prototype.updateGamepadStatus_=function(){if(!(3<this.processQueue_.length)){this.processQueue_.push(1);var a=this.scanGamepad_();if(a)for(var b=0;b<a.length;b++)if(a[b]){if(this.gamepadList_[a[b].index]){var d=window.performance.now();this.gamepadList_[a[b].index].timestamp<a[b].timestamp&&(this.gamepadList_[a[b].index].timestamp=a[b].timestamp);if(this.gamepadList_[a[b].index].timestamp+3*this.pollingInterval_<d)continue}else this.addGamepad_(a[b]);this.encodeGamepadStatus_(a[b].index,
a[b])}this.processQueue_.pop()}};
GamepadController.prototype.encodeGamepadStatus_=function(a,b){var d=0,c=0,e=0,k=0,m=0,q=[];try{for(var f=17<b.buttons.length?17:b.buttons.length,p=0;p<f;p++){var t=b.buttons[p];'object'==typeof t&&(k=t.pressed,m=t.value,k&&(p==GamepadController.BTN_LT?c=Math.round(255*m):p==GamepadController.BTN_RT?e=Math.round(255*m):d|=GamepadController.gamepadMapping[p]))}f=4<b.axes.length?4:b.axes.length;for(k=0;k<f;k++){var v=b.axes[k];m=k==GamepadController.AXES_LEFT_Y||k==GamepadController.AXES_RIGHT_Y?Math.round(-32767*
v):Math.round(32767*v);q[k]=m}var u=new ArrayBuffer(17),w=new DataView(u);w.setUint8(0,1);w.setUint8(1,16);w.setUint8(2,3);w.setUint8(3,2);w.setUint8(4,parseInt(a));w.setUint16(5,d);w.setUint8(7,c);w.setUint8(8,e);w.setUint16(9,q[GamepadController.AXES_LEFT_X]);w.setUint16(11,q[GamepadController.AXES_LEFT_Y]);w.setUint16(13,q[GamepadController.AXES_RIGHT_X]);w.setUint16(15,q[GamepadController.AXES_RIGHT_Y]);if(this.onoperate)this.onoperate(u,17);return!0}catch(l){return this.onError_(500),!1}};
...
GamepadController.prototype.gamepadDisconnectedHandler_=function(a){this.removeGamepad_(a.gamepad)};GamepadController.prototype.onError_=function(a){if(this.onerror)this.onerror(a)};'use strict';var JY=function(a){this.core_=this.coreVersion=null};JY.prototype.sdkLoading=function(a,b,d,c,e){if(!(a&&b&&d&&e))return!1;this.core_&&1!=this.coreVersion||(this.coreVersion=2,this.core_=new JYCore2);this.core_.sdkLoading(a,b,d,c,e)};JY.prototype.isInitialized=function(){return this.core_.isInitialized()};
JY.prototype.isPlaying=function(){return this.core_.isStarting_};JY.prototype.initEngine=function(a,b,d,c){if(!(a&&b&&d&&c))return!1;this.core_&&2!=this.coreVersion||(this.coreVersion=1,this.core_=new JYCore);this.core_.sdkLoading(a,b,d,c);return!0};JY.prototype.quit=function(){this.core_.isStarting_&&this.core_.stopGame('SDK quit by caller');return this.core_=null};JY.prototype.registerUser=function(a){return this.core_.registerUser(a)};
JY.prototype.setServiceLevel=function(a){return this.isInitialized()&&this.core_?this.core_.setServiceLevel(a):!1};JY.prototype.startGame=function(a,b,d,c,e,k,m,q){d=void 0===d?1:d;c=void 0===c?'':c;e=void 0===e?'':e;k=void 0===k?0:k;q=void 0===q?'':q;return a&&b&&d&&c&&e&&k&&q&&this.isInitialized()&&this.core_?this.core_.startGame(a,b,d,c,e,k,m,q):!1};JY.prototype.start=function(a,b,d){return a&&b&&d&&this.isInitialized()&&this.core_?this.core_.startGame(a,b,d):!1};
JY.prototype.stopGame=function(){if(!this.isInitialized()||!this.core_)return!1;CURRENTSTAGE='stopGame';return this.core_.stopGame()};JY.prototype.stop=function(){if(!this.isInitialized()||!this.core_)return!1;CURRENTSTAGE='stopGame';return this.core_.stopGame()};JY.prototype.cancleGameQueue=function(){return this.isInitialized()&&this.core_?this.core_.cancelQueue():!1};JY.prototype.hasGameLink=function(a){return a&&this.isInitialized()&&this.core_?this.core_.hasGameLink(a):!1};
JY.prototype.getGamepadList=function(){return this.isInitialized()&&this.core_?this.core_.getGamepad().getGamepadList():!1};JY.prototype.addVirtualGamepad=function(a){return this.isInitialized()&&this.core_?this.core_.getGamepad().addVirtualGamepad(a):!1};JY.prototype.removeVirtualGamepad=function(a){return this.isInitialized()&&this.core_?this.core_.getGamepad().removeVirtualGamepad(a):!1};
JY.prototype.switchGamepadOn=function(a){if(!this.isInitialized()||!this.core_)return!1;var b=this.core_.getGamepad();return a?b.enableGamepad():b.disableGamepad()};JY.prototype.switchGamepadVibration=function(a){return this.isInitialized()&&this.core_?this.core_.getGamepad().switchGamepadVibration(a):!1};JY.prototype.sendGamepadStatus=function(a,b){return this.isInitialized()&&this.core_?this.core_.getGamepad().sendGamepadStatus(a,b):!1};
...
JY.prototype.setMouseTarget=function(a,b){return this.isInitialized()&&this.core_?this.core_.getKeyMouse().updateMouseTarget(a,b):!1};JY.prototype.showVMouse=function(a){return this.isInitialized()&&this.core_?this.core_.getKeyMouse().showVMouse(a):!1};JY.prototype.keyMousePause=function(){return this.isInitialized()&&this.core_?this.core_.getKeyMouse().pause():!1};JY.prototype.keyMouseResume=function(){return this.isInitialized()&&this.core_?this.core_.getKeyMouse().resume():!1};
JY.prototype.getMouseMode=function(){return this.isInitialized()&&this.core_?this.core_.getKeyMouse().mouseMode:!1};JY.prototype.sendKeyMouseStatus=function(a,b){return this.isInitialized()&&this.core_?this.core_.getKeyMouse().sendKeyMouseStatus(a,b):!1};JY.prototype.sendTouchStatus=function(a){return this.isInitialized()&&this.core_?this.core_.getKeyMouse().sendKeyMouseStatus('TouchEvent',a):!1};
JY.prototype.setMouseWheelSpeed=function(a){return this.isInitialized()&&this.core_?this.core_.getKeyMouse().setMouseWheelSpeed(a):!1};JY.prototype.setMouseMoveSpeed=function(a){return this.isInitialized()&&this.core_?this.core_.getKeyMouse().setMouseMoveSpeed(a):!1};JY.prototype.setIdleTimeLimit=function(a){return this.isInitialized()&&this.core_?this.core_.setIdleTimeLimit(a):!1};JY.prototype.getIdleTime=function(){return this.isInitialized()&&this.core_?this.core_.getIdleTime():!1};
JY.prototype.bindingGameServer=function(a){return this.core_.bindingGameServer(a)};JY.prototype.takePlayGame=function(a,b,d){return a&&b&&d&&this.isInitialized()&&this.core_?this.core_.startGame(a,b,d,'takePlayGame'):!1};JY.prototype.reconPlayGame=function(a,b,d){return a&&b&&d&&this.isInitialized()&&this.core_?this.core_.startGame(a,b,d,'replayGame'):!1};JY.prototype.setHangUpTime=function(a){return this.isInitialized()&&this.core_?this.core_.setHangUpTime(a):!1};
JY.prototype.hangUp=function(a){return this.isInitialized()&&this.core_?this.core_.hangUp(a):!1};JY.prototype.setHandle=function(a){return this.isInitialized()&&this.core_?this.core_.setHandle(a):!1};JY.prototype.changeHandle=function(a,b){return this.isInitialized()&&this.core_?this.core_.changeHandle(a,b):!1};JY.prototype.restartGame=function(a,b){a=void 0===a?'':a;b=void 0===b?'':b;return this.isInitialized()&&this.core_?this.core_.restartGame(a,b):!1};
JY.prototype.getMonitorNumber=function(){return this.isInitialized()&&this.core_?this.core_.getMonitorNumber():!1};JY.prototype.changeMonitor=function(a){return this.isInitialized()&&this.core_?this.core_.changeMonitor(a):!1};JY.prototype.uploadSave=function(a){return this.isInitialized()&&this.core_?this.core_.uploadSave(a):!1};JY.prototype.sendCopyData=function(){return this.isInitialized()&&this.core_?this.core_.jp_.onLocalCopy_():!1};
JY.prototype.setDragMode=function(a){a=void 0===a?0:a;return this.isInitialized()&&this.core_?this.core_.setDragMode(a):!1};JY.prototype.sendRunAS=function(a,b){b=void 0===b?'':b;return a&&this.isInitialized()&&this.core_?this.core_.sendRunAS(a,b):!1};JY.prototype.shareLocalStream=function(a,b){a=void 0===a?0:a;b=void 0===b?0:b;return this.isInitialized()&&this.core_?this.core_.shareLocalStream(a,b):!1};
JY.prototype.startSimpleHandler=function(a,b,d){return a&&b&&d&&this.isInitialized()&&this.core_?this.core_.startGame(a,b,d,'startSimpleHandle'):!1};JY.prototype.stopSimpleHandler=function(){if(!this.isInitialized()||!this.core_)return!1;CURRENTSTAGE='stopGame';return this.core_.stopGame('stopSimpleHandler')};'use strict';
...
JYCore.prototype.isInitialized=function(){return this.isInitialized_};JYCore.prototype.sdkLoading=function(a,b,d,c){var e=this;if(!(a&&b&&d&&c))return!1;this.channelToken_=a;this.bsUrl_=b;this.key_=d;this.sendJYApiRequest_('api/sdkLoading',{}).then(function(a){if(e.isFetchSuccess_(a))return a.json()}).then(function(a){200==a.status?(e.isInitialized_=!0,c&&c(SDKLoadedEvent)):(e.isInitialized_=!1,c&&c(SDKLoadingErrorEvent))}).catch(function(a){e.isInitialized_=!1;c&&c(SDKConnectionErrorEvent)});return!0};
...
JYCore.prototype.startGame=function(a,b,d,c,e,k,m,q){var f=this;d=void 0===d?1:d;c=void 0===c?'':c;e=void 0===e?'':e;k=void 0===k?0:k;m=void 0===m?'':m;q=void 0===q?'':q;if(!this.isInitialized_||this.isStarting_||!(a&&b&&d&&c&&e&&k&&q))return!1;this.isStarting_=!0;this.tagID_=a;this.gameName_=b;this.gameArgs_=c;this.callback=q;0<parseInt(d)&&(this.serviceLevel_=parseInt(d));0<parseInt(k)&&(this.queueGrade_=parseInt(k));if(this.gameQueueID_&&this.queuePollerID_)return!0;this.gc_.start();this.km_.start(this.tagID_);
var p={};p.game_key=this.gameName_;p.display_grade=this.serviceLevel_;p.queue_grade=this.queueGrade_;p.able_queue=0<parseInt(k)?1:0;m&&(p.save_time=m);e||(e='0');p.room_name=e;this.gameServer_&&(p.gs_name=this.gameServer_);this.sendJYApiRequest_('api/playGame',p).then(function(a){if(f.isFetchSuccess_(a))return a.json()}).then(function(a){if(200==a.status)f.parsePlayGameOptions_(a.data)?(f.isBSReady_=!0,BSReadyEvent.body=f.qosInfoStructure_,f.callback(BSReadyEvent),f.startPlayer_()):(f.onNotify_('Start game error:200:'+
...
f.bsFailNumber_++)f.onError_(SDKConnectionErrorEvent);else f.startGame(a,b,d=1,c,k,q)});return!0};
...
JYCore.prototype.sendJYApiRequest_=function(a,b,d){d=void 0===d?1E4:d;var c=this.initDefaultParams_();c=mergeObject(c,b);b=this.signRequestData_(c);a=this.bsUrl_+a;c=this.initFetchOptions_();c.method='POST';c.body=b;return Promise.race([fetch(a+'?'+b,c),promiseHTTPTimeout(d)])};JYCore.prototype.signRequestData_=function(a){a=formatQueryStr(a);var b=a+'&key='+this.key_;b=md5(b);return a=a+'&sign='+b.toUpperCase()};
...
JYCore.prototype.report_=function(a,b){var d=this;if(!this.gameSessionID_)return!1;var c={};c.sc_id=this.gameSessionID_;c.code=void 0===a?'client_desktop':a;b&&(c.body=b);this.sendJYApiRequest_('api/report',c).then(function(a){if(d.isFetchSuccess_(a))return a.json()}).then(function(a){}).catch(function(a){});return!0};JYCore.prototype.queuePoller_=function(){if(!this.gameQueueID_)return!1;if(this.queuePollerID_)return!0;this.queuePollerID_=setInterval(this.playQueue_.bind(this),this.queuePollerInterval_)};
...
JYCore.prototype.serviceQuality_=function(){var a=this;if(!this.gameSessionID_)return!1;var b={sc_id:this.gameSessionID_,CPU:'-1',Packetlost:'-1',RTT:'-1',jitterBufferMs:'-1',renderDelayMs:'-1',decodeMs:'-1',CurDelayMs:'-1',ESBW:'-1',RBW:'-1',ReceiveFPS:'-1',DecodeFPS:'-1',OutputFPS:'-1'};if(this.curStatReport_){var d=this.curStatReport_.connection,c=this.curStatReport_.video.remote;b.Packetlost=(c.packetsLost/c.packetsReceived*100).toFixed(2);b.RTT=1E3*d.currentRoundTripTime;b.ESBW=(d.availableOutgoingBitrate/
1E3/8).toFixed(2);b.jitterBufferMs=Math.round(c.jitterBufferDelay/c.jitterBufferEmittedCount*1E3);this.qosInfoStructure_.Rtt=b.RTT;this.qosInfoStructure_.packetsLost=b.packetsLost;this.qosInfoStructure_.ESBW_kBps=b.ESBW;if(this.preStatReport_){var e=this.preStatReport_.connection,k=this.preStatReport_.video.remote;b.ReceiveFPS=Math.round(computeRate(c,k,'framesReceived'));b.DecodeFPS=Math.round(computeRate(c,k,'framesDecoded'));b.RBW=(computeRate(d,e,'bytesReceived')/1E3).toFixed(2);this.qosInfoStructure_.RBW_kBps=
...
JYCore.prototype.serviceInfo_=function(){var a=this;if(!this.gameSessionID_)return!1;var b={sc_id:this.gameSessionID_,connect_time:'-1',turn:'-1',local:'-1',remote:'-1',video_decoder:'-1',model:'-1',android_version:'-1',video_pixel:'-1'};if(this.curStatReport_){var d=this.curStatReport_.connection,c=this.curStatReport_.video.remote;b.local=d.localIp+':'+d.localPort+' '+d.localType;b.remote=d.remoteIp+':'+d.remotePort+' '+d.remoteType;b.video_pixel=c.frameHeight;this.qosInfoStructure_.FrameHeightReceived=
c.frameHeight;this.qosInfoStructure_.FrameWidthReceived=c.frameWidth}this.sendJYApiRequest_('api/serviceInfo',b).then(function(b){if(a.isFetchSuccess_(b))return b.json()}).then(function(a){}).catch(function(a){})};JYCore.prototype.qosInfoCallback_=function(){SDKQosInfoEvent.body=this.qosInfoStructure_;this.callback(SDKQosInfoEvent)};
JYCore.prototype.parsePlayGameOptions_=function(a){try{this.gameSessionID_=a.sc_id;this.gameLinkName_=a.gl_key;this.gameLinkIP_=a.gl_ip;this.wssUrl_=a.message_server.url;this.wssToken_=a.message_server.token;this.playConfig_=a.play_config;this.roomID_=a.room_id;this.iceServers_=[];for(var b in a.turns){var d={};d.urls=a.turns[b].turn_url;d.username=a.turns[b].turn_user;d.credential=a.turns[b].turn_password;this.iceServers_.push(d)}this.qosInfoStructure_.sc_id=this.gameSessionID_;this.qosInfoStructure_.GS=
this.gameLinkName_;this.qosInfoStructure_.GS_IP=this.gameLinkIP_;this.qosInfoStructure_.localIP=a.ip;this.qosInfoStructure_.location=a.location;return!0}catch(c){return!1}};
...
var JYCore2=function(){this.version='1.0.2';this.monitorID_=null;this.monitorInterval_=1E3;this.reportInterval_=30;this.lastReportTime_=0;this.onStreamingTime_=this.RTCReadyTime_=this.startGameTime_=null;this.gameStartTimeout_=12E4;this.bsFailNumber_=0;this.isStreaming_=this.isRTCReady_=this.isGameReady_=this.isMSReady_=this.isBSReady_=this.isStarting_=this.isInitialized_=!1;this.defaultParams_=null;this.messageQueue_=[];this.basicOptions=this.key_=this.bsUrl_=this.channelId_=null;this.sdkUserID_=
'999999999';this.serviceLevel_='1';this.gameServer_=null;this.idleTimeLimit_=120;this.gameName_=this.gameID_=this.gameQueueID_=null;this.gameArgs_='';this.queueGrade_=1;this.pixel_=this.os_=this.manufacturer_=this.modelName_=this.sn_='';this.tagID_='remoteVideo';this.wssToken_=this.wssUrl_=this.gameLinkIP_=this.gameLinkName_=this.gameSessionID_=null;this.iceServers_=[];this.lastCode_=this.token_=this.roomID_=this.playConfig_=null;this.restartEnable_=0;this.simpleHandler_=null;this.copyMode_=0;this.preStatReport_=
this.curStatReport_=null;this.localTrackIds_={video:'',audio:''};this.remoteTrackIds_={video:'',audio:''};this.qosInfoStructure_={sc_id:null,GS:null,GS_IP:null,localIP:null,location:null,FrameWidthReceived:null,FrameHeightReceived:null,FrameRateOutput:null,Rtt:null,packetsLost:null,decoder:null,DecodeMs:null,ESBW_kBps:null,RBW_kBps:null,sdkVer:this.version};this.localVideo_=this.localAudio_=0;this.queuePollerID_=null;this.queuePollerInterval_=1E4;this.jp_=new JYPlayer2;this.jp_.onerror=this.onPlayerError_.bind(this);
this.jp_.onnotify=this.onNotify_.bind(this);this.jp_.ongameready=this.onGameReady_.bind(this);this.jp_.onmsready=this.onMSReady_.bind(this);this.jp_.onstopgame=this.onStopGame_.bind(this);this.jp_.onmsclose=this.onMSClose_.bind(this);this.jp_.onrtcready=this.onRTCReady_.bind(this);this.jp_.onremotestreamadded=this.onStream_.bind(this);this.jp_.onmessage=this.onDCMessage_.bind(this);this.jp_.oncallback=this.onJPCallback_.bind(this);this.gcPollingInterval_=10;this.gc_=new GamepadController('TIMING',
this.gcPollingInterval_);this.gc_.onoperate=this.onGamepadOperate_.bind(this);this.gc_.onerror=this.onGamepadError_.bind(this);this.km_=new KeyMouseController(this.gcPollingInterval_);this.km_.onoperate=this.onKeyMouseOperate_.bind(this);this.km_.onerror=this.onKeyMouseError_.bind(this);this.km_.oncallback=this.onKeyMouseCallback_.bind(this);this.sh_=null;this.lastOperateTime_=0;this.callback=null};JYCore2.prototype.isInitialized=function(){return this.isInitialized_};
JYCore2.prototype.sdkLoading=function(a,b,d,c,e){var k=this;if(!(a&&b&&d&&e))return!1;this.channelId_=a;this.bsUrl_=b;this.token_=d;this.sn_=this.sdkUserID_=c;this.defaultParams_&&this.initDefaultParams_(!0);this.sendJYApiRequest_('api/handle/sdkLoading',{decoder:'[]'}).catch(function(a){k.isInitialized_=!1;e&&e(SDKConnectionErrorEvent)}).then(function(a){200==a.status?(k.isInitialized_=!0,e&&e(SDKLoadedEvent)):(k.isInitialized_=!1,e&&e(SDKLoadingErrorEvent))}).catch(function(a){});return!0};
...
JYCore2.prototype.setDragMode=function(a){return this.isStreaming_&&this.jp_?this.jp_.setDragMode(void 0===a?0:a):!1};JYCore2.prototype.sendRunAS=function(a,b){return this.isStreaming_&&this.jp_?this.jp_.sendRunAS(a,void 0===b?'':b):!1};JYCore2.prototype.sendMsg2GS=function(a){return this.isStreaming_&&this.jp_?this.jp_.sendMsg2GS(a):!1};JYCore2.prototype.shareLocalStream=function(a,b){return this.isStreaming_&&this.jp_?this.jp_.shareLocalStream(void 0===a?0:a,void 0===b?0:b):!1};
JYCore2.prototype.restartGame=function(a,b){return this.isStreaming_&&this.jp_?this.jp_.restartGame(void 0===a?'':a,void 0===b?'':b):!1};JYCore2.prototype.getGamepad=function(){return this.gc_};JYCore2.prototype.getKeyMouse=function(){return this.km_};JYCore2.prototype.setIdleTimeLimit=function(a){a=parseInt(a);if(isNaN(a)||0>=a)return!1;this.idleTimeLimit_=a;return!0};
JYCore2.prototype.getIdleTime=function(){var a=0;this.isStreaming_&&(a=parseInt((window.performance.now()-this.lastOperateTime_)/1E3));return 0<a?a:0};
JYCore2.prototype.startGame=function(a,b,d,c,e){d=void 0===d?'':d;c=void 0===c?'startGame':c;e=void 0===e?{}:e;if(!this.isInitialized_||this.isStarting_||!a||!b||!d)return!1;this.isStarting_=!0;this.tagID_=a;this.callback=d;this.gc_.start();this.km_.start(this.tagID_);if(this.parsePlayGameOptions_(b))return this.isBSReady_=!0,BSReadyEvent.body=this.qosInfoStructure_,this.callback(BSReadyEvent),this.startPlayer_(c,e),!0;this.onNotify_('Start game error:200:'+b);this.onError_(SDKUnkownErrorEvent)};
JYCore2.prototype.stopGame=function(a,b){b=void 0===b?0:b;if(!this.isStarting_)return!0;if(this.gameSessionID_)if(a||(a='OK'),b)this.report_('game_exception','SDK exit:'+a);else if('hangUp'==CURRENTSTAGE||'takenAway'==CURRENTSTAGE)this.report_('game_event','SDK exit:'+a);else if('stopGame'==CURRENTSTAGE)this.report_('game_quit','SDK exit:'+a);else if('gameExit'==CURRENTSTAGE){if(this.restartEnable_)return!0;this.report_('game_event','game exit'+a)}else this.report_('game_exception','SDK exit:'+a);
this.gameSessionID_=null;for(var d in this.qosInfoStructure_)this.qosInfoStructure_[d]=null;this.qosInfoStructure_.sdkVer=this.version;this.gc_.stop();this.km_.stop();(this.gameQueueID_||this.queuePollerID_)&&this.cancelQueue();this.isStreaming_=this.isRTCReady_=this.isGameReady_=this.isMSReady_=this.isBSReady_=this.isStarting_=!1;this.stopPlayer_();this.stopMonitor_();return!0};
...
JYCore2.prototype.sendJYApiRequest_=function(a,b,d){var c=this.initDefaultParams_();c=mergeObject(c,b);var e=this.bsUrl_+a;return new Promise(function(a,b){$.ajax({url:e,type:'POST',dataType:'json',data:c,success:function(b){a(b)},error:function(a){b(a)}})})};JYCore2.prototype.signRequestData_=function(a){return formatQueryStr(a)};
...
JYCore2.prototype.report_=function(a,b){a=void 0===a?'client_desktop':a;if(!this.gameSessionID_)return!1;var d={};d.sc_id=this.gameSessionID_;d.code=a;b&&(d.body=b);this.jp_.sc_.setStatus(this.gameSessionID_,a);if(this.jp_.sc_.registered_&&'gaming'==a&&this.lastCode_==a)return!1;this.lastCode_=a;this.sendJYApiRequest_('api/handle/report',d).then(function(a){}).catch(function(a){});return!0};
...
0,this.localVideo_=a.local_stream.video?a.local_stream.video:0);this.restartEnable_=a.enable_restart?a.enable_restart:0;this.gameLinkName_=a.gl_key;this.gameLinkIP_=a.gl_ip;this.wssUrl_=a.message_server.url;this.wssToken_=a.message_server.token;this.playConfig_=a.play_config;this.roomID_=a.room_id;this.iceServers_=[];for(var d in a.turns)b={},b.urls=a.turns[d].turn_url,b.username=a.turns[d].turn_user,b.credential=a.turns[d].turn_password,this.iceServers_.push(b);this.qosInfoStructure_.sc_id=this.gameSessionID_;
this.qosInfoStructure_.GS=this.gameLinkName_;this.qosInfoStructure_.GS_IP=this.gameLinkIP_;this.qosInfoStructure_.localIP=a.ip;this.qosInfoStructure_.location=a.location;return!0}catch(c){return!1}};
JYCore2.prototype.startPlayer_=function(a,b){b=void 0===b?{}:b;this.startGameTime_=window.performance.now();var d=this.gc_.gamepadList_.length;0==d&&(d=this.gc_.virtualGamepadList_.length);this.jp_.play({userID:this.sdkUserID_,gameSessionID:this.gameSessionID_,gameLinkName:this.gameLinkName_,wssUrl:this.wssUrl_,wssToken:this.wssToken_,iceServers:this.iceServers_,gameName:this.gameName_,gp_num:d,gameArgs:this.gameArgs_,playConfig:this.playConfig_,simpleHandler:this.simpleHandler_,copyMode:this.copyMode_,
startAction:a,localAudio:this.localAudio_,localVideo:this.localVideo_,restartEnable:this.restartEnable_},b);this.startMonitor_()};JYCore2.prototype.stopPlayer_=function(){this.jp_.stop()};JYCore2.prototype.startMonitor_=function(){this.monitorID_&&clearInterval(this.monitorID_);this.onStreamingTime_=this.RTCReadyTime_=null;this.monitorID_=setInterval(this.MonitorThread_.bind(this),this.monitorInterval_)};
JYCore2.prototype.MonitorThread_=function(){this.isRTCReady_&&(this.jp_.isPeerAlive()||(this.callback&&this.callback(RTCLostEvent),this.stopGame('Connection lost',1)),this.jp_.pc_.getPeerConnectionStats(this.refreshRTCStats_.bind(this)));var a=window.performance.now();if(this.startGameTime_){this.gc_||(this.onNotify_('GC:0:not found'),this.gc_=new GamepadController('TIMING',this.gcPollingInterval_),this.gc_.onoperate=this.onGamepadOperate_().bind(this),this.gc_.onerror=this.onGamepadError_().bind(this),
this.gc_.start());if(!this.RTCReadyTime_){if(a-this.startGameTime_>this.gameStartTimeout_){this.onError_(RTCErrorEvent);return}}else if('startSimpleHandle'!=CURRENTSTAGE&&!this.onStreamingTime_&&a-this.startGameTime_>this.gameStartTimeout_){this.onError_(StreamingErrorEvent);return}this.isStreaming_&&1<=this.idleTimeLimit_&&a-this.lastOperateTime_>1E3*this.idleTimeLimit_&&this.callback(NoOperateEvent);0<this.messageQueue_.length&&(this.report_('game_event',JSON.stringify(this.messageQueue_)),this.messageQueue_=
...
JYCore2.prototype.onError_=function(a){var b=JSON.stringify(a);if(this.isStarting_)this.stopGame(b,1),this.callback&&this.callback(a);else this.onNotify_(b)};JYCore2.prototype.onNotify_=function(a){var b=Date.now();this.messageQueue_.push(b+':'+a)};JYCore2.prototype.changeStatus_=function(a){};JYCore2.prototype.onMSReady_=function(a){this.isMSReady_=!0;this.callback&&this.callback(MSReadyEvent)};JYCore2.prototype.onMSClose_=function(a){};
JYCore2.prototype.onGameReady_=function(a){this.isGameReady_=!0;this.callback&&this.callback(GameReadyEvent)};JYCore2.prototype.onStopGame_=function(a){a=void 0===a?'':a;'taken_away'==a?(this.stopGame('taken away'),this.callback&&this.callback(TakenAwayEvent)):'scHangUp'==a?(this.stopGame('hang up'),this.callback&&this.callback(HangupEvent)):(this.stopGame('Game exited'),this.callback&&this.callback(GameExitEvent))};
JYCore2.prototype.onRTCReady_=function(a){this.RTCReadyTime_=window.performance.now();this.isRTCReady_=!0;this.callback&&this.callback(RTCReadyEvent);this.report_('gaming')};JYCore2.prototype.onPlayerError_=function(a){this.onError_(a)};
JYCore2.prototype.onStream_=function(a){if(!this.isStreaming_){var b=document.getElementById(this.tagID_);b.srcObject=a;this.onStreamingTime_=window.performance.now();this.isStreaming_=!0;this.lastOperateTime_=this.onStreamingTime_;b.onloadeddata=function(a){this.callback&&this.isRTCReady_&&this.callback(StreamingEvent)}.bind(this);a.getTracks().forEach(function(a){'audio'===a.kind?this.remoteTrackIds_.audio=a.id:'video'===a.kind&&(this.remoteTrackIds_.video=a.id)}.bind(this));this.jp_.pc_.getPeerConnectionStats(this.refreshRTCStats_.bind(this))}};
JYCore2.prototype.onDCMessage_=function(a){if('string'!=typeof a){var b=new DataView(a);if(2<b.byteLength&&163==b.getUint8(0))switch(b.getUint8(1)){case 4:this.gc_.gamepadVibration(a);break;case 6:this.km_.receiveMouseMessage(a);break;case 7:this.km_.receiveMouseMessage(a);break;case 11:10>b.byteLength||(a=a.slice(4),a=String.fromCharCode.apply(String,new Uint8Array(a)),this.callback&&(URLOpenedEvent.body=a,this.callback(URLOpenedEvent)))}}};
JYCore2.prototype.onJPCallback_=function(a){this.callback&&this.callback(a)};JYCore2.prototype.onGamepadOperate_=function(a,b){this.jp_.isRunning&&this.jp_.sendData(a,b);this.sh_&&this.sh_.send(a,b);this.lastOperateTime_=window.performance.now();this.callback&&this.callback(OperateEvent)};JYCore2.prototype.onGamepadError_=function(a){switch(a){case 403:this.callback&&this.callback(GamepadErrorEvent)}};
JYCore2.prototype.onKeyMouseOperate_=function(a,b){this.jp_.isRunning&&this.jp_.sendData(a,b);this.sh_&&this.sh_.send(a,b);this.lastOperateTime_=window.performance.now();this.callback&&this.callback(OperateEvent)};JYCore2.prototype.onKeyMouseError_=function(a){};JYCore2.prototype.onKeyMouseCallback_=function(a){this.callback&&this.callback(a)};'use strict';
...
5E3);else b.onError_(RegisterErrorEvent)}).catch(function(d){if(1>b.scErrorNumber_++)b.play(a);else b.onError_(MSFailedEvent)})};JYPlayer.prototype.stop=function(){if(this.isRunning)return this.startTime_=null,this.isRunning=!1,this.sc_&&(this.sc_.sendTo(this.gameLinkName_,'stop_game',''),this.sc_.close()),this.pc_&&(this.pc_.isDataChannelReady&&this.pc_.dc_.close(),this.pc_.close(),this.pc_=null),!0};JYPlayer.prototype.sendData=function(a,b){this.startTime_&&this.isRunning&&this.pc_.sendData(a,b)};
...
var JYPlayer2=function(){this.isRunning=!1;this.gameName_=this.iceServers_=this.wssToken_=this.wssUrl_=this.gameLinkName_=this.gameSessionID_=this.sdkUserID_=this.startTime_=null;this.gp_num_=0;this.playConfig_=this.gameArgs_=null;this.copyMode_=0;this.localStream_=null;this.localVideo_=this.localAudio_=0;this.advancedParams_={};this.additinalDataChannel1_=this.pc_=this.sc_=this.oncallback=this.onmessage=this.ondatachannelstatechange=this.onnewicecandidate=this.oniceconnectionstatechange=this.onsignalingstatechange=
this.onstopgame=this.onremovestream=this.onremotestreamadded=this.onremotesdpset=this.onrtcready=this.ongameready=this.onmsready=this.onnotify=this.onerror=null;this.additinalDataChannel1Ready_=!1;this.pcErrorNumber_=this.scErrorNumber_=0;this.pcReady_=this.scReady_=!1;this.timeoutID_=null;this.onLocalCopy_=function(a){var b=this;navigator.clipboard.readText().then(function(a){if(a&&b.additinalDataChannel1Ready_&&'open'==b.additinalDataChannel1_.readyState){a=new ArrayBuffer(6);var c=new DataView(a);
c.setUint8(0,163);c.setUint8(1,9);c.setUint8(2,149);var d=parseInt(window.performance.now())%32767;c.setUint16(3,d);c.setUint8(5,0);b.additinalDataChannel1_.send(a,a.byteLength)}}).catch(function(a){})}.bind(this);this.onLocalPaste_=function(a){}.bind(this)};
JYPlayer2.prototype.play=function(a,b){b=void 0===b?{}:b;if(this.isRunning)return!1;this.sdkUserID_=a.userID;this.gameSessionID_=a.gameSessionID;this.gameLinkName_=a.gameLinkName;this.wssUrl_=a.wssUrl;this.wssToken_=a.wssToken;this.iceServers_=a.iceServers;this.gameName_=a.gameName;this.gp_num_=a.gp_num;this.gameArgs_=a.gameArgs;this.playConfig_=a.playConfig;this.simpleHandler_=a.simpleHandler;this.copyMode_=a.copyMode;this.localAudio_=a.localAudio?a.localAudio:0;this.localVideo_=a.localVideo?a.localVideo:
0;this.advancedParams_=b;0<this.copyMode_&&(document.removeEventListener('copy',this.onLocalCopy_),document.removeEventListener('cut',this.onLocalCopy_),document.removeEventListener('paste',this.onLocalPaste_),document.addEventListener('copy',this.onLocalCopy_),document.addEventListener('cut',this.onLocalCopy_),document.addEventListener('paste',this.onLocalPaste_));CURRENTSTAGE=a.startAction?a.startAction:'startGame';this.startTime_=window.performance.now();this.sc_&&this.sc_.close();this.sc_=new SignalingChannel2(this.wssUrl_);
this.sc_.onmessage=this.onSignalingChannelMessage_.bind(this);this.sc_.onready=this.onSignalingChannelReady_.bind(this);this.sc_.onerror=this.onSignalingChannelError_.bind(this);this.sc_.onclose=this.onSignalingChannelClose_.bind(this);this.sc_.onfail=this.onSignalingChannelFail_.bind(this);this.sc_.scId=a.gameSessionID;this.sc_.setStatus(a.gameSessionID_,'gaming');var d=0;Promise.race([this.maybeGetMedia_(),promiseTimeout(1E4)]).finally(function(){var b=this;console.log('End');d=Promise.race([this.sc_.open(),
promiseTimeout(5E3)]);d.then(function(){b.scErrorNumber_=0;if(b.sc_.register2(b.sdkUserID_,b.wssToken_))b.timeoutID_=setTimeout(function(){if(!this.scReady_)if(1>this.scErrorNumber_++)this.sc_.register2(this.sdkUserID_,this.wssToken_);else this.onError_(RegisterErrorEvent)}.bind(b),5E3);else b.onError_(RegisterErrorEvent)}).catch(function(c){if(1>b.scErrorNumber_++)b.play(a);else b.onError_(MSFailedEvent)})}.bind(this))};
JYPlayer2.prototype.stop=function(){this.startTime_=null;this.isRunning=!1;this.localStream_&&('undefined'===typeof this.localStream_.getTracks?this.localStream_.stop():this.localStream_.getTracks().forEach(function(a){a.stop()}),this.localStream_=null);this.sc_&&('stopGame'==CURRENTSTAGE&&this.sc_.sendTo(this.gameLinkName_,'stop_game',''),this.sc_.close());this.pc_&&(this.pc_.isDataChannelReady&&this.pc_.dc_.close(),this.pc_.close(),this.pc_=null);0<this.copyMode_&&(document.removeEventListener('copy',
this.onLocalCopy_),document.removeEventListener('cut',this.onLocalCopy_),document.removeEventListener('paste',this.onLocalPaste_));return!0};JYPlayer2.prototype.sendData=function(a,b){if('undefined'!=typeof DEBUG&&DEBUG)for(var d=new DataView(a),c=0;c<b;c++)d.getUint8(c);this.startTime_&&this.isRunning&&this.pc_.sendData(a,b)};
...
JYPlayer2.prototype.setDragMode=function(a){a=void 0===a?0:a;if(this.isPeerAlive()){var b={};b.mode=parseInt(a);b.sc_id=this.gameSessionID_.toString();this.sc_.sendTo(this.gameLinkName_,'mousemode',b);return!0}return!1};JYPlayer2.prototype.sendRunAS=function(a,b){b=void 0===b?'':b;if(this.isPeerAlive()){var d={};d.run_path=a;d.run_args=b;this.sc_.sendTo(this.gameLinkName_,'runas',d);return!0}return!1};
JYPlayer2.prototype.sendMsg2GS=function(a){if(this.isPeerAlive()){var b={};b.session=this.gameSessionID_;b.data=a;b.flow=1;this.sc_.sendTo(this.gameLinkName_,'forward',b);return!0}return!1};
JYPlayer2.prototype.shareLocalStream=function(a,b){a=void 0===a?0:a;b=void 0===b?0:b;if(!this.localStream_)return!1;var d=this.localStream_.getVideoTracks();if(0===d.length)return!1;for(var c=0;c<d.length;++c)d[c].enabled=b;b=this.localStream_.getAudioTracks();if(0===b.length)return!1;for(c=0;c<b.length;++c)b[c].enabled=a;return!0};
...
JYPlayer2.prototype.restartGame=function(a,b){a=void 0===a?'':a;b=void 0===b?'':b;if(this.isPeerAlive()){var d={};d.save_time=a;b&&(d.save_enable=b);this.sc_.sendTo(this.gameLinkName_,'restart_game',d);return!0}return!1};
...
JYPlayer2.prototype.createPeerConnection_=function(){var a={},b={};b.iceServers=this.iceServers_;a.peerConnectionConfig=b;a.peerConnectionConstraints=[];this.pc_=new PeerConnectionClient(a,this.startTime_);this.localStream_&&this.pc_.addStream(this.localStream_);this.pc_.onsignalingmessage=this.sendSignalingMessage_.bind(this);this.pc_.onremotesdpset=this.onremotesdpset;this.pc_.onremotestreamadded=this.onremotestreamadded;this.pc_.onremovestream=this.onremovestream;this.pc_.onsignalingstatechange=
this.onsignalingstatechange;this.pc_.oniceconnectionstatechange=this.onIceConnectionStateChange_.bind(this);this.pc_.onnewicecandidate=this.onnewicecandidate;this.pc_.onerror=this.onPeerConnectionError_.bind(this);this.pc_.ondatachannelstatechange=this.ondatachannelstatechange;this.pc_.onmessage=this.onmessage;0<this.copyMode_&&(this.additinalDataChannel1_=this.pc_.createAdditionalDC('file',{ordered:!0,negotiated:!0,maxRetransmits:2,id:100}),this.additinalDataChannel1_.onopen=function(){this.additinalDataChannel1Ready_=
!0}.bind(this),this.additinalDataChannel1_.onerror=function(){}.bind(this),this.additinalDataChannel1_.onclose=function(){this.additinalDataChannel1Ready_=!1}.bind(this),this.additinalDataChannel1_.onmessage=this.onAdditionalChannel1Message_.bind(this));a={};'startSimpleHandle'==CURRENTSTAGE&&(a={offerToReceiveAudio:0,offerToReceiveVideo:0});this.pc_.startAsCaller(a)};
...
break;case 'runas':if(200==b.code){if(this.oncallback)this.oncallback(RunASEvent)}else if(this.oncallback)this.oncallback(RunASFailedEvent);break;case 'forward':if(a.session==this.gameSessionID_&&(MsgFromGSEvent.data=a.data,this.oncallback))this.oncallback(MsgFromGSEvent)}};JYPlayer2.prototype.onSignalingChannelReady_=function(){this.scReady_=!0;this.scErrorNumber_=0;if(!this.isRunning){if(this.onmsready)this.onmsready();this.sendStartGame_()}};
JYPlayer2.prototype.onSignalingChannelError_=function(a){this.onNotify_('MS:'+a.code+':'+a.message)};
...
JYPlayer2.prototype.onSignalingChannelFail_=function(a){this.onError_(RegisterErrorEvent)};JYPlayer2.prototype.sendSignalingMessage_=function(a){var b=null,d={},c=a.type;if('candidate'==c||'offer'==c||'answer'==c)b='rtc_sdp';d.body=a;this.sc_.sendTo(this.gameLinkName_,b,d)};JYPlayer2.prototype.onIceConnectionStateChange_=function(a){if('connected'===a&&(this.isRunning=!0,this.pcErrorNumber_=0,this.onrtcready))this.onrtcready();'completed'===a&&(this.isRunning=!0,this.pcErrorNumber_=0);if(this.oniceconnectionstatechange)this.oniceconnectionstatechange(a)};
JYPlayer2.prototype.onPeerConnectionError_=function(a){this.onNotify_('RTC:0:'+a);this.onError_(RTCErrorEvent)};JYPlayer2.prototype.onError_=function(a){clearTimeout(this.timeoutID_);this.stop();if('hangUp'!=CURRENTSTAGE&&'takenAway'!=CURRENTSTAGE&&'stopGame'!=CURRENTSTAGE&&this.onerror)this.onerror(a)};JYPlayer2.prototype.onNotify_=function(a){if(this.onnotify)this.onnotify(a)};
JYPlayer2.prototype.onRemoteCopy_=function(a){var b=new DataView(a);if(200==b.getUint16(5)){var d=b.getUint8(7);b.getUint32(8)+12==a.byteLength&&2==d&&(a=a.slice(12),(a=string=(new TextDecoder).decode(a))&&navigator.clipboard.writeText(a).then(function(){console.log('\u5199\u5165\u526a\u8d34\u677f\u6210\u529f')}).catch(function(a){}))}};
JYPlayer2.prototype.onRemotePaste_=function(a){var b=this,d=new DataView(a);0==d.getUint8(5)&&navigator.clipboard.readText().then(function(a){if(a&&b.additinalDataChannel1Ready_&&'open'==b.additinalDataChannel1_.readyState){a=(new TextEncoder).encode(a);var c=a.byteLength;var k=new ArrayBuffer(12+c);var m=new DataView(k);m.setUint8(0,163);m.setUint8(1,9);m.setUint8(2,152);m.setUint16(3,d.getUint8(3));m.setUint16(5,200);m.setUint8(7,2);m.setUint32(8,c);(new Uint8Array(k)).set(new Uint8Array(a),12);
b.additinalDataChannel1_.send(k,k.byteLength)}}).catch(function(a){a=new ArrayBuffer(7);var c=new DataView(a);c.setUint8(0,163);c.setUint8(1,9);c.setUint8(2,152);c.setUint16(3,d.getUint8(3));c.setUint16(5,201);b.additinalDataChannel1_.send(a,a.byteLength)})};
JYPlayer2.prototype.onAdditionalChannel1Message_=function(a){var b=a.data;if('string'!=typeof b&&(a=new DataView(b),2<a.byteLength&&163==a.getUint8(0)))switch(a.getUint8(1)){case 9:switch(a.getUint8(2)){case 149:if(0==a.getUint8(5)){b=new ArrayBuffer(7);var d=new DataView(b);d.setUint8(0,163);d.setUint8(1,9);d.setUint8(2,150);d.setUint16(3,a.getUint8(3));d.setUint16(5,200);this.additinalDataChannel1_.send(b,b.byteLength);b=new ArrayBuffer(6);d=new DataView(b);d.setUint8(0,163);d.setUint8(1,9);d.setUint8(2,
151);a=parseInt(window.performance.now())%32767;d.setUint16(3,a);d.setUint8(5,0);this.additinalDataChannel1_.send(b,b.byteLength)}break;case 151:this.onRemotePaste_(b);break;case 152:this.onRemoteCopy_(b)}}};
JYPlayer2.prototype.maybeGetMedia_=function(){var a=null;return a=0!=this.localAudio_||0!=this.localVideo_?navigator.mediaDevices.getUserMedia({video:this.localVideo_,audio:this.localAudio_}).catch(function(a){return navigator.mediaDevices.enumerateDevices().then(function(a){var b=a.find(function(a){return'videoinput'===a.kind});a=a.find(function(a){return'audioinput'===a.kind});return navigator.mediaDevices.getUserMedia({video:b&&this.localVideo_,audio:a&&this.localAudio_})})}.bind(this)).then(function(a){this.onUserMediaSuccess_(a)}.bind(this)).catch(function(a){this.onError_('Error getting user media: '+
a.message);this.onUserMediaError_(a)}.bind(this)):Promise.resolve()};JYPlayer2.prototype.onUserMediaSuccess_=function(a){this.localStream_=a;if(this.onlocalstreamadded)this.onlocalstreamadded(a)};JYPlayer2.prototype.onUserMediaError_=function(a){this.onError_('getUserMedia error: Failed to get access to local media. Error name was '+(a.name+'. Continuing without sending a stream.'))};'use strict';
var KeyMouseController=function(a){a=void 0===a?16:a;this.isPaused=this.isRunning=!1;this.statusHolder_={mode:-1,hotX:-1,hotY:-1,cursor:null};this.videoContainerTag_=this.videoTag_=null;this.isPollingMode_=!0;this.workingMode_=2;this.pollingInterval_=0<parseInt(a)?parseInt(a):16;this.mouseMode=this.lastMousePollingTime_=this.lastKeyPollingTime_=this.intervalID_=0;this.processQueue_=[];this.windowBlurHandler_=this.keyBoardHandler_=this.mouseWheelHandler_=this.mouseHandler_=null;this.keyBoardMap_=[];
for(a=0;255>a;a++)this.keyBoardMap_[a]={pressed:!1,timestamp:0};this.keyBoardMap2_={};this.keyBoardTimstamp_=0;this.mouseMap_={x:0,y:0,originX:0,originY:0,movementX:0,movementY:0,buttons:0,scroll:0,timestamp:0};this.MIMEMAP_={0:'image/x-icon',1:'image/jpeg',2:'image/png',3:'image/gif'};this.vMouse_=this.oncallback=this.onerror=this.onoperate=null;this.wheelSpeed_=1;this.wheelLastTouch_=this.wheelCounter_=0;this.mouseSpeed_=1;this.mouseBufferLength_=12;this.mouseByteBuffer_=new ArrayBuffer(this.mouseBufferLength_);
this.mouseBufferView_=new DataView(this.mouseByteBuffer_);this.mouseBufferView_.setUint8(0,1);this.mouseBufferView_.setUint8(1,11);this.mouseBufferView_.setUint8(2,2);this.mouseBufferView_.setUint8(3,8);this.keyboardByteBuffer_=new ArrayBuffer(24);this.keyboardBufferView_=new DataView(this.keyboardByteBuffer_);this.keyboardBufferLength_=0;this.keyboardBufferView_.setUint8(0,1);this.keyboardBufferView_.setUint8(1,6);this.keyboardBufferView_.setUint8(2,1);this.keyboardBufferView_.setUint8(3,1);this.touchByteBuffer_=
new ArrayBuffer(21);this.touchBufferView_=new DataView(this.touchByteBuffer_);this.touchBufferLength_=0;this.touchBufferView_.setUint8(0,1);this.touchBufferView_.setUint8(1,20);this.touchBufferView_.setUint8(2,0);this.touchBufferView_.setUint8(3,0)};
KeyMouseController.prototype.start=function(a){if(this.isRunning)return!0;if(a)if(a=document.getElementById(a))this.videoTag_=a,this.videoContainerTag_=a.parentNode;else return!1;else if(!this.videoTag_)return!1;this.isRunning=!0;this.processQueue_=[];this.attachEvent_();this.vMouse_&&this.vMouse_.clear();this.vMouse_=new VirtualMouse(this.videoTag_);this.vMouse_.changeMode(this.mouseMode);return!0};
KeyMouseController.prototype.stop=function(){this.isRunning=!1;this.detachEvent_();this.cleanKeyBoardMap_();0<this.intervalID_&&(clearInterval(this.intervalID_),this.intervalID_=0);this.vMouse_&&(this.vMouse_.clear(),this.vMouse_=null);this.mouseMode=0;return!0};
KeyMouseController.prototype.pause=function(){this.isRunning&&!this.isPaused&&(this.isPaused=!0,this.detachEvent_(),1==this.mouseMode?(this.changeMouseMode(0),this.statusHolder_.mode=1,this.vMouse_.onLockModeChange_()):2==this.mouseMode?(this.changeMouseMode(0),this.statusHolder_.mode=2):this.statusHolder_.mode=0,this.statusHolder_.hotX=this.vMouse_.hotX_,this.statusHolder_.hotY=this.vMouse_.hotY_,this.statusHolder_.cursor=this.vMouse_.vCursorImg_.src,-1!=this.vMouse_.vCursorImg_.src.indexOf(this.vMouse_.nullCursorImg_)?
this.statusHolder_.cursor='none':this.statusHolder_.cursor=this.vMouse_.vCursorImg_.src,this.vMouse_.container_.style.cursor=this.vMouse_.oldCursor_);return!0};KeyMouseController.prototype.resume=function(){this.isRunning&&this.isPaused&&(this.isPaused=!1,this.attachEvent_(),this.vMouse_.setCursor(this.statusHolder_.hotY,this.statusHolder_.hotY,this.statusHolder_.cursor),1==this.statusHolder_.mode?this.changeMouseMode(1):2==this.statusHolder_.mode&&this.changeMouseMode(2));return!0};
KeyMouseController.prototype.enableKeyMouse=function(){return this.start()};KeyMouseController.prototype.disableKeyMouse=function(){return this.stop()};KeyMouseController.prototype.changeMouseMode=function(a){if(!this.vMouse_)return!1;a=parseInt(void 0===a?0:a);return 0<=a&&4>=a?(this.mouseMode=a,this.vMouse_.changeMode(this.mouseMode)):!1};
...
KeyMouseController.prototype.receiveMouseMessage=function(a){if(this.isRunning){if('string'!=typeof a&&a instanceof ArrayBuffer){var b=new DataView(a);if(4<b.byteLength&&163==b.getUint8(0))switch(b.getUint8(1)){case 6:var d=0,c=0,e='none';if(!(32>=b.byteLength)){e=this.MIMEMAP_[b.getUint8(2)];d=b.getUint8(3);c=b.getUint8(4);b=a.slice(5);if(!e)return!1;b=new Blob([b],{type:e});e=URL.createObjectURL(b)}this.isPaused?(this.statusHolder_.hotX=d,this.statusHolder_.hotY=c,this.statusHolder_.cursor=e):this.vMouse_.setCursor(d,
c,e);this.oncallback&&(MouseStyleEvent.img=e,MouseStyleEvent.x=d,MouseStyleEvent.y=c,this.oncallback(MouseStyleEvent));break;case 7:if(6!=b.byteLength)return!1;d=parseInt(b.getUint16(2)/1E4*this.videoContainerTag_.clientWidth);c=parseInt(b.getUint16(4)/1E4*this.videoContainerTag_.clientHeight);this.vMouse_.changePosition(d,c);this.oncallback&&(MousePostionEvent.x=d,MousePostionEvent.y=c,this.oncallback(MousePostionEvent));break;default:return!1}}else return!1;return!0}};
...
KeyMouseController.prototype.myKeyBoardEvent_=function(a){if(0<=a.keyCode&&255>a.keyCode){this.keyBoardTimstamp_=window.performance.now();a.preventDefault&&a.preventDefault();if('keydown'==a.type){if(!this.keyBoardMap2_[a.keyCode]&&(this.keyBoardMap2_[a.keyCode]=1,0==this.workingMode_||2==this.workingMode_))return this.updateKeySingleStatus_(a)}else if(delete this.keyBoardMap2_[a.keyCode],0==this.workingMode_||2==this.workingMode_)return this.updateKeySingleStatus_(a);27==a.keyCode&&('keydown'==a.type?
ESCAPESTATE=1:ESCAPESTATE=0)}return!1};KeyMouseController.prototype.windowBlurEvent_=function(){if(this.keyBoardMap_)for(var a=0;255>a;a++)this.keyBoardMap_[a].pressed&&this.sendKeyMouseStatus('KeyboardEvent',new KeyboardEvent('keyup',{altKey:!0,shiftKey:!0,keyCode:a,code:''}));for(var b in this.keyBoardMap2_)0<=b&&255>b&&(this.sendKeyMouseStatus('KeyboardEvent',new KeyboardEvent('keyup',{altKey:!0,shiftKey:!0,keyCode:b,code:''})),delete this.keyBoardMap2_[b]);this.cleanKeyBoardMap_();return!1};
...
KeyMouseController.prototype.myMouseEvent_=function(a){if('mousedown'==a.type&&1==this.vMouse_.mode&&null==document.pointerLockElement||2==this.vMouse_.mode&&null==document.pointerLockElement&&(this.vMouse_.vCursorImg_.src==this.vMouse_.nullCursorImg_||'none'==this.vMouse_.container_.style.cursor)||'mousemove'==a.type&&0==a.movementX&&0==a.movementY)return!0;var b=window.performance.now();if(this.videoContainerTag_){var d=this.videoContainerTag_.clientWidth;var c=this.videoContainerTag_.clientHeight}else d=
window.screen.width,c=window.screen.height;this.mouseMap_.x=parseInt(a.offsetX/d*1E4);this.mouseMap_.y=parseInt(a.offsetY/c*1E4);this.mouseMap_.originX=a.offsetX;this.mouseMap_.originY=a.offsetY;this.mouseMap_.movementX=0<a.movementX?Math.ceil(a.movementX*this.mouseSpeed_):Math.floor(a.movementX*this.mouseSpeed_);this.mouseMap_.movementY=0<a.movementY?Math.ceil(a.movementY*this.mouseSpeed_):Math.floor(a.movementY*this.mouseSpeed_);127<this.mouseMap_.movementX?this.mouseMap_.movementX=127:-127>this.mouseMap_.movementX&&
...
KeyMouseController.prototype.myTouchEvent=function(a){a.preventDefault();var b=a.changedTouches,d=b[0].identifier,c=a.touches,e=c.length,k=0,m=0,q=0;if(b[0].target){var f=b[0].target.clientWidth;var p=b[0].target.clientHeight;q=b[0].target.getBoundingClientRect();m=q.left;q=q.top}else this.videoTag_?(f=this.videoTag_.clientWidth,p=this.videoTag_.clientHeight,q=this.videoTag_.getBoundingClientRect(),m=q.left,q=q.top):(f=window.screen.width,p=window.screen.height);if('touchstart'==a.type)if(k=5*e+5,
this.touchBufferView_.setUint8(1,k),this.touchBufferView_.setUint8(4,Math.abs(d)%10),0<e&&2>=e)for(this.touchBufferView_.setUint8(5,e),b=0;b<e;b++)a=parseInt((c[b].clientX-m)/f*1E4),d=parseInt((c[b].clientY-q)/p*1E4),this.touchBufferView_.setUint8(6+5*b,Math.abs(c[b].identifier)%10),this.touchBufferView_.setUint16(7+5*b,a),this.touchBufferView_.setUint16(9+5*b,d);else return!1;else if('touchmove'==a.type)if(k=5*e+5,this.touchBufferView_.setUint8(1,k),this.touchBufferView_.setUint8(4,0),0<e&&2>=e)for(this.touchBufferView_.setUint8(5,
64+e),b=0;b<e;b++)a=parseInt((c[b].clientX-m)/f*1E4),d=parseInt((c[b].clientY-q)/p*1E4),this.touchBufferView_.setUint8(6+5*b,Math.abs(c[b].identifier)%10),this.touchBufferView_.setUint16(7+5*b,a),this.touchBufferView_.setUint16(9+5*b,d);else return!1;else if('touchend'==a.type||'touchcancel'==a.type)if(k=5*e+10,this.touchBufferView_.setUint8(1,k),this.touchBufferView_.setUint8(4,Math.abs(d)%10),0<=e&&2>=e)for(this.touchBufferView_.setUint8(5,32+e+1),a=parseInt((b[0].clientX-m)/f*1E4),d=parseInt((b[0].clientY-
q)/p*1E4),this.touchBufferView_.setUint8(6,Math.abs(b[0].identifier)%10),this.touchBufferView_.setUint16(7,a),this.touchBufferView_.setUint16(9,d),b=0;b<e;b++)a=parseInt((c[b].clientX-m)/f*1E4),d=parseInt((c[b].clientY-q)/p*1E4),this.touchBufferView_.setUint8(11+5*b,Math.abs(c[b].identifier)%10),this.touchBufferView_.setUint16(12+5*b,a),this.touchBufferView_.setUint16(14+5*b,d);else return!1;c=this.touchByteBuffer_.slice(0,k+1);if(this.onoperate)this.onoperate(c,c.byteLength);return!0};
KeyMouseController.prototype.mouseWheelEvent_=function(a){var b=window.performance.now(),d=0;a.deltaY?d=-1*a.deltaY:a.wheelDelta?d=a.wheelDelta+a.detail:a.detail&&(d=-1*a.detail);0>d*this.wheelCounter_&&(this.wheelCounter_=0);150<b-this.wheelLastTouch_&&(this.wheelCounter_=0,this.wheelLastTouch_=b);if(-30>d)this.mouseMap_.scroll=-1*this.wheelSpeed_;else if(-30<=d&&0>d){if(0==this.wheelCounter_||-30>this.wheelCounter_)this.mouseMap_.scroll=-1*this.wheelSpeed_,this.wheelCounter_=0;this.wheelCounter_+=
d}else if(0<d&&30>=d){if(0==this.wheelCounter_||30<this.wheelCounter_)this.mouseMap_.scroll=this.wheelSpeed_,this.wheelCounter_=0;this.wheelCounter_+=d}else this.mouseMap_.scroll=30<d?this.wheelSpeed_:0;this.mouseMap_.movementX=0;this.mouseMap_.movementY=0;this.mouseMap_.timestamp=b;a.preventDefault&&a.preventDefault();0!=this.workingMode_&&2!=this.workingMode_||this.updateMouseStatus_();return!0};
...
KeyMouseController.prototype.updateKeySingleStatus_=function(a){if(3<this.processQueue_.length)return!1;this.processQueue_.push(1);var b=this.keyBoardMap2_[a.keyCode]?1:0;this.keyboardBufferView_.setUint8(2,1);this.keyboardBufferView_.setUint16(4,a.keyCode);this.keyboardBufferView_.setUint8(6,b);this.keyboardBufferLength_=7;for(var d in this.keyBoardMap2_)0<d&&255>d&&21>this.keyboardBufferLength_&&(this.keyboardBufferView_.setUint16(this.keyboardBufferLength_,d),this.keyboardBufferLength_+=2,this.keyboardBufferView_.setUint8(this.keyboardBufferLength_,
this.keyBoardMap2_[d]),this.keyboardBufferLength_++);this.keyboardBufferView_.setUint8(this.keyboardBufferLength_++,255);this.keyboardBufferView_.setUint8(1,this.keyboardBufferLength_-1);a=this.keyboardByteBuffer_.slice(0,this.keyboardBufferLength_);if(this.onoperate)this.onoperate(a,a.byteLength);this.lastKeyPollingTime_=window.performance.now();this.processQueue_.pop();return!0};
KeyMouseController.prototype.updateMouseStatus_=function(){if(3<this.processQueue_.length)return!1;this.processQueue_.push(1);var a=document.pointerLockElement||document.mozPointerLockElement;this.mouseBufferView_.setUint8(2,2);this.mouseBufferView_.setUint8(8,this.mouseMap_.movementX);this.mouseBufferView_.setUint8(9,this.mouseMap_.movementY);this.mouseBufferView_.setUint8(10,this.mouseMap_.buttons);this.mouseBufferView_.setUint8(11,this.mouseMap_.scroll);if(a){this.vMouse_&&this.vMouse_.movePosition(this.mouseMap_.movementX,
this.mouseMap_.movementY);a=(this.vMouse_.posX_+this.vMouse_.hotX_)/this.videoContainerTag_.clientWidth;1<a&&(a=1);var b=(this.vMouse_.posY_+this.vMouse_.hotY_)/this.videoContainerTag_.clientHeight;1<b&&(b=1);this.mouseBufferView_.setUint16(4,parseInt(1E4*a));this.mouseBufferView_.setUint16(6,parseInt(1E4*b))}else 3==this.mouseMode?(0<=this.mouseMap_.originX?this.vMouse_&&this.vMouse_.changePosition(this.mouseMap_.originX,this.mouseMap_.originY):this.vMouse_&&this.vMouse_.movePosition(this.mouseMap_.movementX,
this.mouseMap_.movementY),a=(this.vMouse_.posX_+this.vMouse_.hotX_)/this.videoContainerTag_.clientWidth,1<a&&(a=1),b=(this.vMouse_.posY_+this.vMouse_.hotY_)/this.videoContainerTag_.clientHeight,1<b&&(b=1),this.mouseBufferView_.setUint16(4,parseInt(1E4*a)),this.mouseBufferView_.setUint16(6,parseInt(1E4*b))):(this.mouseBufferView_.setUint16(4,this.mouseMap_.x),this.mouseBufferView_.setUint16(6,this.mouseMap_.y));if(this.onoperate)this.onoperate(this.mouseByteBuffer_,this.mouseBufferLength_);this.lastMousePollingTime_=
window.performance.now();this.mouseBufferView_.setUint8(8,0);this.mouseBufferView_.setUint8(9,0);this.mouseBufferView_.setUint8(11,0);this.mouseMap_.scroll=0;this.processQueue_.pop();return!0};KeyMouseController.prototype.onError_=function(a){if(this.onerror)this.onerror(a)};
var VirtualMouse=function(a){this.target_=a;this.container_=this.target_.parentNode;this.container_.style.overflow='hidden';this.parentContainer_=this.container_.parentNode;this.clientWidth_=this.target_.clientWidth;this.clientHeight_=this.target_.clientHeight;this.oldCursor_=this.container_.style.cursor;this.posY_=this.posX_=this.hotY_=this.hotX_=0;this.mode=-1;this.defaultCursorImg_='images/cur.png';this.nullCursorImg_='images/null.png';this.vCursorContainer_=document.createElement('div');this.vCursorContainer_.style.display=
'block';this.vCursorContainer_.style.position='absolute';this.vCursorContainer_.style.left='0';this.vCursorContainer_.style.top='0';this.vCursorImg_=new Image;this.vCursorImg_.src=this.defaultCursorImg_;this.vCursorContainer_.appendChild(this.vCursorImg_);this.pointerLockStatus_=!1;this.onEnterLockMode_=function(){this.pointerLockStatus_||(this.target_.requestPointerLock=this.target_.requestPointerLock||this.target_.mozRequestPointerLock,this.target_.requestPointerLock&&this.target_.requestPointerLock({unadjustedMovement:!0}))}.bind(this);
this.onExitLockMode_=function(){document.exitPointerLock=document.exitPointerLock||document.mozExitPointerLock;document.exitPointerLock&&document.exitPointerLock()}.bind(this);this.onLockModeChange_=function(){document.pointerLockElement===this.target_||document.mozPointerLockElement===this.target_?(this.parentContainer_.appendChild(this.vCursorContainer_),this.pointerLockStatus_=!0):(this.vCursorContainer_.parentNode===this.parentContainer_&&this.parentContainer_.removeChild(this.vCursorContainer_),
this.pointerLockStatus_=!1,this.vCursorImg_.src!=this.nullCursorImg_&&'none'!=this.container_.style.cursor||this.sendESCEvent())}.bind(this);this.showVMouse=function(a){return 0==a&&this.vCursorContainer_.parentNode===this.parentContainer_?(this.parentContainer_.removeChild(this.vCursorContainer_),!0):1==a&&null==this.vCursorContainer_.parentNode?(this.parentContainer_.appendChild(this.vCursorContainer_),!0):!1}.bind(this);this.onTargetClick_=function(a){switch(this.mode){case 1:document.pointerLockElement||
...
VirtualMouse.prototype.clear=function(){this.vCursorContainer_.parentNode===this.parentContainer_&&this.parentContainer_.removeChild(this.vCursorContainer_);this.changeMode(0);document.removeEventListener('pointerlockchange',this.onLockModeChange_);this.target_.removeEventListener('mousedown',this.onTargetClick_,!0);this.container_.style.cursor=this.oldCursor_};
VirtualMouse.prototype.setCursor=function(a,b,d){var c=this.vCursorImg_.src;if('none'==d){if(this.vCursorImg_.src=this.nullCursorImg_,this.container_.style.cursor='none',2==this.mode)this.onEnterLockMode_()}else{if(2==this.mode)this.onExitLockMode_();this.vCursorImg_.src=d;this.posX_=this.posX_+this.hotX_-a;this.posY_=this.posY_+this.hotY_-b;this.vCursorContainer_.style.left=this.posX_+'px';this.vCursorContainer_.style.top=this.posY_+'px';this.container_.style.cursor='url('+d+')'+a+' '+b+' ,default'}this.hotX_=
a;this.hotY_=b;if(c==d)return!0;-1!=c.indexOf('blob')&&URL.revokeObjectURL(c);return!0};VirtualMouse.prototype.changePosition=function(a,b){this.posX_=a-this.hotX_;this.posY_=b-this.hotY_;this.vCursorContainer_.style.left=this.posX_+'px';this.vCursorContainer_.style.top=this.posY_+'px';return!0};
...
!function(a){function b(a,b){var c=(65535&a)+(65535&b);return(a>>16)+(b>>16)+(c>>16)<<16|65535&c}function d(a,c,d,e,f,k){a=b(b(c,a),b(e,k));return b(a<<f|a>>>32-f,d)}function c(a,b,c,e,f,k,m){return d(b&c|~b&e,a,b,f,k,m)}function e(a,b,c,e,f,k,m){return d(b&e|c&~e,a,b,f,k,m)}function k(a,b,c,e,f,k,m){return d(b^c^e,a,b,f,k,m)}function m(a,b,c,e,f,k,m){return d(c^(b|~e),a,b,f,k,m)}function q(a,d){a[d>>5]|=128<<d%32;a[14+(d+64>>>9<<4)]=d;var f=1732584193,g=-271733879,h=-1732584194,l=271733878;for(d=
0;d<a.length;d+=16){var p=f;var q=g;var t=h;var u=l;g=m(g=m(g=m(g=m(g=k(g=k(g=k(g=k(g=e(g=e(g=e(g=e(g=c(g=c(g=c(g=c(g,h=c(h,l=c(l,f=c(f,g,h,l,a[d],7,-680876936),g,h,a[d+1],12,-389564586),f,g,a[d+2],17,606105819),l,f,a[d+3],22,-1044525330),h=c(h,l=c(l,f=c(f,g,h,l,a[d+4],7,-176418897),g,h,a[d+5],12,1200080426),f,g,a[d+6],17,-1473231341),l,f,a[d+7],22,-45705983),h=c(h,l=c(l,f=c(f,g,h,l,a[d+8],7,1770035416),g,h,a[d+9],12,-1958414417),f,g,a[d+10],17,-42063),l,f,a[d+11],22,-1990404162),h=c(h,l=c(l,f=c(f,
g,h,l,a[d+12],7,1804603682),g,h,a[d+13],12,-40341101),f,g,a[d+14],17,-1502002290),l,f,a[d+15],22,1236535329),h=e(h,l=e(l,f=e(f,g,h,l,a[d+1],5,-165796510),g,h,a[d+6],9,-1069501632),f,g,a[d+11],14,643717713),l,f,a[d],20,-373897302),h=e(h,l=e(l,f=e(f,g,h,l,a[d+5],5,-701558691),g,h,a[d+10],9,38016083),f,g,a[d+15],14,-660478335),l,f,a[d+4],20,-405537848),h=e(h,l=e(l,f=e(f,g,h,l,a[d+9],5,568446438),g,h,a[d+14],9,-1019803690),f,g,a[d+3],14,-187363961),l,f,a[d+8],20,1163531501),h=e(h,l=e(l,f=e(f,g,h,l,a[d+
13],5,-1444681467),g,h,a[d+2],9,-51403784),f,g,a[d+7],14,1735328473),l,f,a[d+12],20,-1926607734),h=k(h,l=k(l,f=k(f,g,h,l,a[d+5],4,-378558),g,h,a[d+8],11,-2022574463),f,g,a[d+11],16,1839030562),l,f,a[d+14],23,-35309556),h=k(h,l=k(l,f=k(f,g,h,l,a[d+1],4,-1530992060),g,h,a[d+4],11,1272893353),f,g,a[d+7],16,-155497632),l,f,a[d+10],23,-1094730640),h=k(h,l=k(l,f=k(f,g,h,l,a[d+13],4,681279174),g,h,a[d],11,-358537222),f,g,a[d+3],16,-722521979),l,f,a[d+6],23,76029189),h=k(h,l=k(l,f=k(f,g,h,l,a[d+9],4,-640364487),
g,h,a[d+12],11,-421815835),f,g,a[d+15],16,530742520),l,f,a[d+2],23,-995338651),h=m(h,l=m(l,f=m(f,g,h,l,a[d],6,-198630844),g,h,a[d+7],10,1126891415),f,g,a[d+14],15,-1416354905),l,f,a[d+5],21,-57434055),h=m(h,l=m(l,f=m(f,g,h,l,a[d+12],6,1700485571),g,h,a[d+3],10,-1894986606),f,g,a[d+10],15,-1051523),l,f,a[d+1],21,-2054922799),h=m(h,l=m(l,f=m(f,g,h,l,a[d+8],6,1873313359),g,h,a[d+15],10,-30611744),f,g,a[d+6],15,-1560198380),l,f,a[d+13],21,1309151649),h=m(h,l=m(l,f=m(f,g,h,l,a[d+4],6,-145523070),g,h,a[d+
11],10,-1120210379),f,g,a[d+2],15,718787259),l,f,a[d+9],21,-343485551);f=b(f,p);g=b(g,q);h=b(h,t);l=b(l,u)}return[f,g,h,l]}function f(a){var b,c='',d=32*a.length;for(b=0;b<d;b+=8)c+=String.fromCharCode(a[b>>5]>>>b%32&255);return c}function p(a){var b,c=[];c[(a.length>>2)-1]=void 0;for(b=0;b<c.length;b+=1)c[b]=0;var d=8*a.length;for(b=0;b<d;b+=8)c[b>>5]|=(255&a.charCodeAt(b/8))<<b%32;return c}function t(a){return f(q(p(a),8*a.length))}function v(a,b){var c,d=p(a),e=[],h=[];e[15]=h[15]=void 0;16<d.length&&
(d=q(d,8*a.length));for(a=0;16>a;a+=1)e[a]=909522486^d[a],h[a]=1549556828^d[a];return c=q(e.concat(p(b)),512+8*b.length),f(q(h.concat(c),640))}function u(a){var b,c='';for(b=0;b<a.length;b+=1){var d=a.charCodeAt(b);c+='0123456789abcdef'.charAt(d>>>4&15)+'0123456789abcdef'.charAt(15&d)}return c}function w(a,b,c){b?c?a=v(unescape(encodeURIComponent(b)),unescape(encodeURIComponent(a))):(a=v(unescape(encodeURIComponent(b)),unescape(encodeURIComponent(a))),a=u(a)):a=c?t(unescape(encodeURIComponent(a))):
u(t(unescape(encodeURIComponent(a))));return a}'function'==typeof define&&define.amd?define(function(){return w}):'object'==typeof module&&module.exports?module.exports=w:a.md5=w}(this);'use strict';
...
RunASEvent={code:'54108',body:'RunAS successfully'},UploadSaveEvent={code:'54110',body:'upload save successfully'},MousePostionEvent={code:'54111',x:0,y:0},MouseStyleEvent={code:'54112',img:'http://',x:0,y:0},MsgFromGSEvent={code:'54113',data:''},StartGameFailedEvent={code:'44000',body:'Can not start game.'},GameRunningErrorEvent={code:'44001',body:'Game error.'},GameIllegalSettingEvent={code:'44002',body:'Illegal Setting.'},SessionErrorEvent={code:'44003',body:'Can not find session.'},ChangeLevelFailedEvent=
{code:'44101',body:'Change rate level failed'},ChangeHangUpTimeFailedEvent={code:'44102',body:'Change Hang up Time Failed'},HangUpFailedEvent={code:'44103',body:'Hang up Failed'},SetHandleFailedEvent={code:'44104',body:'Set Handle Failed.'},HandleDeviceChangeFailedEvent={code:'44004',body:'Handle device change failed'},RestartGameFailedEvent={code:'44005',body:'restart game failed'},MonitorNotExistEvent={code:'44106',body:'Cant find this monitor'};MonitorNotExistEvent={code:'44110',body:'upload save failed'};
var RunASFailedEvent={code:'44108',body:'RunAS failed'},OperateEvent={code:'55000',body:'operating event'},GamepadErrorEvent={code:'45000',body:'Gamepad access error.'},NoOperateEvent={code:'45001',body:'No operation for a long time.'},CreateSimpleHandlerFailedEvent={code:'46000',body:'create simplehandler failed.'};'use strict';
var PeerConnectionClient=function(a,b){this.params_=a;this.startTime_=b;this.pc_=new RTCPeerConnection(a.peerConnectionConfig,a.peerConnectionConstraints);this.pc_.onicecandidate=this.onIceCandidate_.bind(this);this.pc_.ontrack=this.onRemoteStreamAdded_.bind(this);this.pc_.onremovestream=this.onRemoveStream_.bind(this);this.pc_.onsignalingstatechange=this.onSignalingStateChanged_.bind(this);this.pc_.oniceconnectionstatechange=this.onIceConnectionStateChanged_.bind(this);this.pc_.onconnectionstatechange=
this.onConnectionStateChanged_.bind(this);this.hasRemoteSdp_=!1;this.messageQueue_=[];this.started_=this.isInitiator_=!1;this.lastFailTime_=b;this.dc_=this.createDataChannel();this.isDataChannelReady=!1;this.ondatachannelstatechange=this.onmessage=this.onsignalingstatechange=this.onsignalingmessage=this.onremovestream=this.onremotestreamadded=this.onremotesdpset=this.onnewicecandidate=this.oniceconnectionstatechange=this.onerror=null};
PeerConnectionClient.prototype.close=function(){this.pc_&&(this.pc_.close(),window.dispatchEvent(new CustomEvent('pcclosed',{detail:{pc:this,time:new Date}})),this.pc_=null)};PeerConnectionClient.prototype.addStream=function(a){this.pc_&&this.pc_.addStream(a)};
...
PeerConnectionClient.prototype.startAsCallee=function(a){if(!this.pc_||this.started_)return!1;this.isInitiator_=!1;this.started_=!0;if(a&&0<a.length){for(var b=0,d=a.length;b<d;b++)this.receiveSignalingMessage(a[b]);return!0}0<this.messageQueue_.length&&this.drainMessageQueue_();return!0};PeerConnectionClient.prototype.addStream=function(a){this.pc_&&this.pc_.addStream(a)};
...
PeerConnectionClient.prototype.drainMessageQueue_=function(){if(this.pc_&&this.started_&&this.hasRemoteSdp_){for(var a=0,b=this.messageQueue_.length;a<b;a++)this.processSignalingMessage_(this.messageQueue_[a]);this.messageQueue_=[]}};
PeerConnectionClient.prototype.processSignalingMessage_=function(a){'offer'!==a.type||this.isInitiator_?'answer'===a.type&&this.isInitiator_?'have-local-offer'===this.pc_.signalingState&&this.setRemoteSdp_(a):'candidate'===a.type&&(a=new RTCIceCandidate({sdpMLineIndex:a.sdp.sdpMLineIndex,candidate:a.sdp.candidate}),this.pc_.addIceCandidate(a).catch(this.onError_.bind(this,'addIceCandidate'))):'stable'===this.pc_.signalingState&&(this.setRemoteSdp_(a),this.doAnswer_())};
PeerConnectionClient.prototype.onSetRemoteDescriptionSuccess_=function(){var a=this.pc_.getRemoteStreams();if(this.onremotesdpset)this.onremotesdpset(0<a.length&&0<a[0].getVideoTracks().length)};PeerConnectionClient.prototype.onDataChannelOpen_=function(a){this.isDataChannelReady=!0;if(this.ondatachannelstatechange)this.ondatachannelstatechange()};PeerConnectionClient.prototype.onDataChannelError_=function(a){warning('DataChannel Error: '+a.error.message)};
...
PeerConnectionClient.prototype.onIceConnectionStateChanged_=function(){if(this.pc_&&('failed'!==this.pc_.iceConnectionState&&'failed'!==this.pc_.connectionState||!this.started_||(now=window.performance.now(),5E3>now-this.lastFailTime_?(this.started_=!1,this.onError_('RTC','closed')):(this.lastFailTime_=now,this.startAsCaller())),this.oniceconnectionstatechange))this.oniceconnectionstatechange(this.pc_.iceConnectionState)};PeerConnectionClient.prototype.onConnectionStateChanged_=function(){};
PeerConnectionClient.prototype.filterIceCandidate_=function(a){a=a.candidate;return-1!==a.indexOf('tcp')||'relay'===this.params_.peerConnectionConfig.iceTransports&&'relay'!==iceCandidateType(a)?!1:!0};PeerConnectionClient.prototype.onError_=function(a,b){if(this.onerror)this.onerror(a+': '+b.toString())};PeerConnectionClient.DEFAULT_SDP_OFFER_OPTIONS_={offerToReceiveAudio:1,offerToReceiveVideo:1,voiceActivityDetection:!1};'use strict';
...
function preferBitRate(a,b,d){var c=a.split('\r\n'),e=findLine(c,'m=',d);if(null===e)return a;d=findLineInRange(c,e+1,-1,'m=');null===d&&(d=c.length);e=findLineInRange(c,e+1,d,'c=');if(null===e)return a;(a=findLineInRange(c,e+1,d,'b=AS'))&&c.splice(a,1);c.splice(e+1,0,'b=AS:'+b);return a=c.join('\r\n')}
function maybeSetVideoSendInitialBitRate(a,b){var d=parseInt(b.videoSendInitialBitrate);if(!d)return a;var c=parseInt(d),e=parseInt(b.videoSendBitrate);e&&(d>e&&(b.videoSendInitialBitrate=e),c=e);d=a.split('\r\n');e=findLine(d,'m=','video');if(null===e)return a;e=d[e].split(/m=video\s\d+\s[A-Z/]+\s/)[1].split(' ')[0];d=d[findLine(d,'a=rtpmap',e)].split('a=rtpmap:'+e)[1].split('/')[0];d=b.videoSendCodec||d;a=setCodecParam(a,d,'x-google-min-bitrate',b.videoSendInitialBitrate.toString());return a=setCodecParam(a,
d,'x-google-max-bitrate',c.toString())}function removePayloadTypeFromMline(a,b){a=a.split(' ');for(var d=0;d<a.length;++d)a[d]===b.toString()&&a.splice(d,1);return a.join(' ')}function removeCodecByName(a,b){var d=findLine(a,'a=rtpmap',b);if(null===d)return a;b=getCodecPayloadTypeFromLine(a[d]);a.splice(d,1);d=findLine(a,'m=','video');if(null===d)return a;a[d]=removePayloadTypeFromMline(a[d],b);return a}
function removeCodecByPayloadType(a,b){var d=findLine(a,'a=rtpmap',b.toString());if(null===d)return a;a.splice(d,1);d=findLine(a,'m=','video');if(null===d)return a;a[d]=removePayloadTypeFromMline(a[d],b);return a}
function maybeRemoveVideoFec(a,b){if('false'!==b.videoFec)return a;b=a.split('\r\n');var d=findLine(b,'a=rtpmap','red');if(null===d)return a;d=getCodecPayloadTypeFromLine(b[d]);b=removeCodecByPayloadType(b,d);b=removeCodecByName(b,'ulpfec');d=findLine(b,'a=fmtp',d.toString());if(null===d)return a;var c=parseFmtpLine(b[d]).pt;if(null===c)return a;b.splice(d,1);b=removeCodecByPayloadType(b,c);return b.join('\r\n')}
...
function maybePreferCodec(a,b,d,c){if(!c)return a;d=a.split('\r\n');b=findLine(d,'m=',b);if(null===b)return a;for(a=d.length-1;0<=a;--a){var e=findLineInRange(d,a,0,'a=rtpmap',c,'desc');if(null!==e)a=e,(e=getCodecPayloadTypeFromLine(d[e]))&&(d[b]=setDefaultCodec(d[b],e));else break}return a=d.join('\r\n')}
function setCodecParam(a,b,d,c){var e=a.split('\r\n'),k=findFmtpLine(e,b),m={};if(null===k){b=findLine(e,'a=rtpmap',b);if(null===b)return a;a=getCodecPayloadTypeFromLine(e[b]);m.pt=a.toString();m.params={};m.params[d]=c;e.splice(b+1,0,writeFmtpLine(m))}else m=parseFmtpLine(e[k]),m.params[d]=c,e[k]=writeFmtpLine(m);return a=e.join('\r\n')}
function removeCodecParam(a,b,d){var c=a.split('\r\n');b=findFmtpLine(c,b);if(null===b)return a;a=parseFmtpLine(c[b]);delete a.params[d];d=writeFmtpLine(a);null===d?c.splice(b,1):c[b]=d;return a=c.join('\r\n')}function parseFmtpLine(a){var b={},d=a.indexOf(' ');d=a.substring(d+1).split(';');if((a=a.match(/a=fmtp:(\d+)/))&&2===a.length)b.pt=a[1];else return null;a={};for(var c=0;c<d.length;++c){var e=d[c].split('=');2===e.length&&(a[e[0]]=e[1])}b.params=a;return b}
function writeFmtpLine(a){if(!a.hasOwnProperty('pt')||!a.hasOwnProperty('params'))return null;var b=a.pt;a=a.params;var d=[],c=0,e;for(e in a)d[c]=e+'='+a[e],++c;return 0===c?null:'a=fmtp:'+b.toString()+' '+d.join(';')}function findFmtpLine(a,b){return(b=getCodecPayloadType(a,b))?findLine(a,'a=fmtp:'+b.toString()):null}function findLine(a,b,d){return findLineInRange(a,0,-1,b,d)}
function findLineInRange(a,b,d,c,e,k){void 0===k&&(k='asc');if('asc'===(k||'asc'))for(d=-1!==d?d:a.length;b<d;++b){if(0===a[b].indexOf(c)&&(!e||-1!==a[b].toLowerCase().indexOf(e.toLowerCase())))return b}else for(b=-1!==b?b:a.length-1;0<=b;--b)if(0===a[b].indexOf(c)&&(!e||-1!==a[b].toLowerCase().indexOf(e.toLowerCase())))return b;return null}function getCodecPayloadType(a,b){return(b=findLine(a,'a=rtpmap',b))?getCodecPayloadTypeFromLine(a[b]):null}
function getCodecPayloadTypeFromLine(a){return(a=a.match(/a=rtpmap:(\d+) [a-zA-Z0-9-]+\/\d+/))&&2===a.length?a[1]:null}function setDefaultCodec(a,b){a=a.split(' ');var d=a.slice(0,3);d.push(b);for(var c=3;c<a.length;c++)a[c]!==b&&d.push(a[c]);return d.join(' ')}'use strict';var SignalingChannel=function(a){this.wssUrl_=a;this.websocket_=null;this.type_='webUA';this.signKey=this.uid_=null;this.registered_=!1;this.onfail=this.onready=this.onmessage=this.onerror=this.onclose=this.keepAlivePingID_=null};
...
SignalingChannel2.prototype.sendTo=function(a,b,d){d=void 0===d?{}:d;if(!this.isAvailable())return!1;a={id:b,from:this.uid_,to:a};a=mergeObject(a,d);d=JSON.stringify(a);this.websocket_.send(d);return!0};SignalingChannel2.prototype.close=function(){this.websocket_&&(this.websocket_.close(),this.websocket_=null);return!0};
...
this.onSignalingChannelError_.bind(this);this.sc_.onclose=this.onSignalingChannelClose_.bind(this);this.sc_.onfail=this.onSignalingChannelFail_.bind(this);Promise.race([this.sc_.open(),promiseTimeout(5E3)]).then(function(){b.scErrorNumber_=0;if(b.sc_.register2(b.sdkUserID_,b.wssToken_))b.timeoutID_=setTimeout(function(){if(!this.websocket_)if(1>this.scErrorNumber_++)this.sc_.register2(this.sdkUserID_,this.wssToken_);else this.onError_(RegisterErrorEvent)}.bind(b),5E3);else b.onError_(RegisterErrorEvent)}).catch(function(d){if(1>
...
bytesReceived:0,bytesSent:0,consentRequestsSent:0,currentRoundTripTime:0,localCandidateId:'',localCandidateType:'',localIp:'',localPort:0,localPriority:0,localProtocol:'',localRelayProtocol:void 0,remoteCandidateId:'',remoteCandidateType:'',remoteIp:'',remotePort:0,remotePriority:0,remoteProtocol:'',requestsReceived:0,requestsSent:0,responsesReceived:0,responsesSent:0,timestamp:0,totalRoundTripTime:0}},e=null,k=null,m=null,q=null;a&&(a.forEach(function(a,p){switch(a.type){case 'track':a.hasOwnProperty('trackIdentifier')&&
(-1!==a.trackIdentifier.indexOf(b.video)&&(c.video.local.frameHeight=a.frameHeight,c.video.local.framesSent=a.framesSent,c.video.local.frameWidth=a.frameWidth,a.id!=b.video&&(k=a.id)),-1!==a.trackIdentifier.indexOf(d.video)&&(c.video.remote.frameHeight=a.frameHeight,c.video.remote.framesDecoded=a.framesDecoded,c.video.remote.framesDropped=a.framesDropped,c.video.remote.framesReceived=a.framesReceived,c.video.remote.frameWidth=a.frameWidth,c.video.remote.jitterBufferDelay=a.jitterBufferDelay,c.video.remote.jitterBufferEmittedCount=
a.jitterBufferEmittedCount,a.id!=d.video&&(e=a.id)),-1!==a.trackIdentifier.indexOf(b.audio)&&(c.audio.local.audioLevel=a.audioLevel,a.id!=b.audio&&(q=a.id)),-1!==a.trackIdentifier.indexOf(d.audio)&&(c.audio.remote.audioLevel=a.audioLevel,c.video.remote.jitterBufferDelay=a.jitterBufferDelay,c.video.remote.jitterBufferEmittedCount=a.jitterBufferEmittedCount,a.id!=d.audio&&(m=a.id)))}}.bind()),a.forEach(function(a,p){switch(a.type){case 'outbound-rtp':if(a.hasOwnProperty('trackId')){if(-1!==a.trackId.indexOf(b.audio)||
-1!==a.trackId.indexOf(q))c.audio.local.bytesSent=a.bytesSent,c.audio.local.codecId=a.codecId,c.audio.local.packetsSent=a.packetsSent,c.audio.local.timestamp=a.timestamp,c.audio.local.trackId=a.trackId,c.audio.local.transportId=a.transportId;if(-1!==a.trackId.indexOf(b.video)||-1!==a.trackId.indexOf(k))c.video.local.bytesSent=a.bytesSent,c.video.local.codecId=a.codecId,c.video.local.firCount=a.firCount,c.video.local.framesEncoded=a.frameEncoded,c.video.local.framesSent=a.framesSent,c.video.local.packetsSent=
a.packetsSent,c.video.local.pliCount=a.pliCount,c.video.local.qpSum=a.qpSum,c.video.local.timestamp=a.timestamp,c.video.local.trackId=a.trackId,c.video.local.transportId=a.transportId}break;case 'inbound-rtp':if(a.hasOwnProperty('trackId')){if(-1!==a.trackId.indexOf(d.audio)||-1!==a.trackId.indexOf(m))c.audio.remote.bytesReceived=a.bytesReceived,c.audio.remote.codecId=a.codecId,c.audio.remote.fractionLost=a.fractionLost,c.audio.remote.jitter=a.jitter,c.audio.remote.packetsLost=a.packetsLost,c.audio.remote.packetsReceived=
a.packetsReceived,c.audio.remote.timestamp=a.timestamp,c.audio.remote.trackId=a.trackId,c.audio.remote.transportId=a.transportId;if(-1!==a.trackId.indexOf(d.video)||-1!==a.trackId.indexOf(e))c.video.remote.bytesReceived=a.bytesReceived,c.video.remote.codecId=a.codecId,c.video.remote.firCount=a.firCount,c.video.remote.fractionLost=a.fractionLost,c.video.remote.nackCount=a.nackCount,c.video.remote.packetsLost=a.packetsLost,c.video.remote.packetsReceived=a.packetsReceived,c.video.remote.pliCount=a.pliCount,
c.video.remote.qpSum=a.qpSum,c.video.remote.timestamp=a.timestamp,c.video.remote.trackId=a.trackId,c.video.remote.transportId=a.transportId,c.video.remote.totalDecodeTime=a.totalDecodeTime}else if(a.hasOwnProperty('trackIdentifier')){if(-1!==a.trackIdentifier.indexOf(d.audio)||-1!==a.trackIdentifier.indexOf(m))c.audio.remote.bytesReceived=a.bytesReceived,c.audio.remote.codecId=a.codecId,c.audio.remote.fractionLost=a.fractionLost,c.audio.remote.jitter=a.jitter,c.audio.remote.packetsLost=a.packetsLost,
c.audio.remote.packetsReceived=a.packetsReceived,c.audio.remote.timestamp=a.timestamp,c.audio.remote.trackId=a.trackId,c.audio.remote.transportId=a.transportId;if(-1!==a.trackIdentifier.indexOf(d.video)||-1!==a.trackIdentifier.indexOf(e))c.video.remote.bytesReceived=a.bytesReceived,c.video.remote.codecId=a.codecId,c.video.remote.firCount=a.firCount,c.video.remote.fractionLost=a.fractionLost,c.video.remote.nackCount=a.nackCount,c.video.remote.packetsLost=a.packetsLost,c.video.remote.packetsReceived=
a.packetsReceived,c.video.remote.pliCount=a.pliCount,c.video.remote.qpSum=a.qpSum,c.video.remote.timestamp=a.timestamp,c.video.remote.trackId=a.trackId,c.video.remote.transportId=a.transportId,c.video.remote.totalDecodeTime=a.totalDecodeTime,c.video.remote.frameHeight=a.frameHeight,c.video.remote.framesDecoded=a.framesDecoded,c.video.remote.framesDropped=a.framesDropped,c.video.remote.framesReceived=a.framesReceived,c.video.remote.frameWidth=a.frameWidth,c.video.remote.jitterBufferDelay=a.jitterBufferDelay,
c.video.remote.jitterBufferEmittedCount=a.jitterBufferEmittedCount}break;case 'candidate-pair':a.hasOwnProperty('availableOutgoingBitrate')&&(c.connection.availableOutgoingBitrate=a.availableOutgoingBitrate,c.connection.consentRequestsSent=a.consentRequestsSent,c.connection.currentRoundTripTime=a.currentRoundTripTime,c.connection.localCandidateId=a.localCandidateId,c.connection.remoteCandidateId=a.remoteCandidateId,c.connection.requestsReceived=a.requestsReceived,c.connection.requestsSent=a.requestsSent,
c.connection.responsesReceived=a.responsesReceived,c.connection.responsesSent=a.responsesSent,c.connection.timestamp=a.timestamp,c.connection.totalRoundTripTime=a.totalRoundTripTime);break;case 'transport':c.connection.bytesReceived=a.bytesReceived,c.connection.bytesSent=a.bytesSent}}.bind()),a.forEach(function(a){switch(a.type){case 'codec':a.hasOwnProperty('id')&&(-1!==a.id.indexOf(c.audio.local.codecId)&&(c.audio.local.clockRate=a.clockRate,c.audio.local.mimeType=a.mimeType,c.audio.local.payloadType=
a.payloadType),-1!==a.id.indexOf(c.audio.remote.codecId)&&(c.audio.remote.clockRate=a.clockRate,c.audio.remote.mimeType=a.mimeType,c.audio.remote.payloadType=a.payloadType),-1!==a.id.indexOf(c.video.local.codecId)&&(c.video.local.clockRate=a.clockRate,c.video.local.mimeType=a.mimeType,c.video.local.payloadType=a.payloadType),-1!==a.id.indexOf(c.video.remote.codecId)&&(c.video.remote.clockRate=a.clockRate,c.video.remote.mimeType=a.mimeType,c.video.remote.payloadType=a.payloadType));break;case 'local-candidate':a.hasOwnProperty('id')&&
-1!==a.id.indexOf(c.connection.localCandidateId)&&(c.connection.localIp=a.ip,c.connection.localPort=a.port,c.connection.localPriority=a.priority,c.connection.localProtocol=a.protocol,c.connection.localType=a.candidateType,c.connection.localRelayProtocol=a.relayProtocol);break;case 'remote-candidate':a.hasOwnProperty('id')&&-1!==a.id.indexOf(c.connection.remoteCandidateId)&&(c.connection.remoteIp=a.ip,c.connection.remotePort=a.port,c.connection.remotePriority=a.priority,c.connection.remoteProtocol=
a.protocol,c.connection.remoteType=a.candidateType)}}.bind()));return c}function computeRate(a,b,d){var c=a[d];d=b?b[d]:null;return null===c||null===d?null:(c-d)/(a.timestamp-b.timestamp)*1E3}function computeBitrate(a,b,d){return 8*computeRate(a,b,d)}function computeE2EDelay(a,b){return a?Date.now()+22089888E5-a-1E3*b:null}'use strict';
function trace(a){if('undefined'==typeof DEBUG||!DEBUG)return!1;'\n'===a[a.length-1]&&(a=a.substring(0,a.length-1));var b=Date.now();console.log(b+': '+a);return!0}function warning(a){if('undefined'==typeof DEBUG||!DEBUG)return!1;'\n'===a[a.length-1]&&(a=a.substring(0,a.length-1));var b=Date.now();console.warn(b+': '+a);return!0}function parseJSON(a){try{return JSON.parse(a)}catch(b){}return null}function mergeObject(a,b){if(!a||!b)return a||b;if(b)for(var d in b)a[d]=b[d];return a}
function promiseHTTPTimeout(a){return new Promise(function(b,d){setTimeout(function(){b(new Response('timeout',{status:504,statusText:'Gateway Timeout'}))},a)})}function promiseTimeout(a){return new Promise(function(b,d){setTimeout(function(){d(Error('timeout'))},a)})}function formatQueryStr(a){var b='',d=[];if(a){for(var c in a)void 0!==a[c]&&d.push(c+'='+a[c]);d.sort();b=d.length?d.join('&'):''}return b}
...
function getHash(){var a=window.performance.now();a=a+navigator.platform+navigator.userAgent;window.clientInformation&&(a+=window.clientInformation.appVersion);if(window.localStorage){var b=window.localStorage;var d=b.getItem('JYSDK-HASH');d||(d=md5(a),b.setItem('JYSDK-HASH',d));return d}return md5(a)}function getNullGamepad(){for(var a={buttons:[],axes:[]},b=0;17>b;b++)a.buttons.push({pressed:!1,value:0});for(b=0;4>b;b++)a.axes.push(0);return a}
function arrayBufferToBase64(a){a=new Uint8Array(a);for(var b=a.byteLength,d='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.split(''),c='',e=0;3<=b-e;e+=3){var k=a[e],m=a[e+1],q=a[e+2];c+=d[k>>>2]+d[(k&3)<<4|m>>>4]+d[(m&15)<<2|q>>>6]+d[q&63]}b-=e;1===b?(b=a[e],c+=d[b>>>2]+d[(b&3)<<4]+'=='):2===b&&(b=a[e],a=a[e+1],c+=d[b>>>2]+d[(b&3)<<4|a>>>4]+d[(a&15)<<2]+'=');return c}function sleep(a){return new Promise(function(b){setTimeout(b,a)})}CURRENTSTAGE='none';ESCAPESTATE=0;
